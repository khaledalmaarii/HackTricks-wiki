...
{% hint style="success" %}
**欢迎来到这个维基，您将在这里找到我从CTFs、真实应用、阅读研究和新闻中学到的每个黑客技巧/技术/等等。**
{% endhint %}

要开始，请查看这个页面，您将找到**在渗透测试一个或多个机器时应该遵循的典型流程**：
...
**即时提供漏洞评估和渗透测试设置**。使用包含从侦察到报告的 20 多种工具和功能从任何地方运行完整的渗透测试。我们不取代渗透测试人员 - 我们开发定制工具、检测和利用模块，让他们有更多时间深入挖掘、弹出 shell 并享受乐趣。
