...
{% hint style="success" %}
**Witaj w wiki, gdzie znajdziesz każdy sztuczkę/hack/technikę, którą nauczyłem się z CTF-ów, aplikacji w życiu rzeczywistym, czytania badań i wiadomości.**
{% endhint %}

Aby zacząć, przejdź do tej strony, gdzie znajdziesz **typowy przepływ**, który **powinieneś stosować podczas testowania penetracyjnego** jednej lub więcej **maszyn:**
...
![HackTricks Statystyki Github](https://repobeats.axiom.co/api/embed/68f8746802bcf1c8462e889e6e9302d4384f164b.svg "Obrazek analizy Repobeats")
