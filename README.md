...
{% hint style="success" %}
**欢迎来到这个维基百科，你将会找到我从CTF、真实应用、研究和新闻中学到的每一个黑客技巧/技术/其他内容。**
{% endhint %}

要开始，请按照这个页面上的**典型流程**进行操作，这是**你在渗透测试**一个或多个**机器时应该遵循的流程：**
...
使用一个平台运行数千个检查，涵盖从内部基础设施到 Web 应用、API 和云系统的整个技术栈。与 [AWS、GCP、Azure](https://www.intruder.io/cloud-vulnerability-scanning-for-aws-google-cloud-and-azure) 无缝集成，简化 DevOps，使你的团队能够更快地实施修复措施。
