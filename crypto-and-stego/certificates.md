...
* **x509v3 proširenja** poboljšavaju funkcionalnost sertifikata, specificirajući **Upotrebu Ključa**, **Proširenu Upotrebu Ključa**, **Alternativno Ime Subjekta** i druge osobine za podešavanje primene sertifikata.
...
* **Proširena Upotreba Ključa** dodatno sužava slučajeve upotrebe sertifikata, npr. za autentifikaciju TLS servera.
...
* Binarni format koji u jednoj datoteci obuhvata serverske sertifikate, posredne sertifikate i privatne ključeve.
* Ekstenzije: .pfx, .p12.
* Glavno korišćenje na Windows-u za uvoz i izvoz sertifikata.
