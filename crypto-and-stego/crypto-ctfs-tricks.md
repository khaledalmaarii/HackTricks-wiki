# Astuces pour les CTFs de cryptographie
...
### Solveur automatique des encodages de base
...
**Multitap** [remplace une lettre](https://www.dcode.fr/word-letter-change) par des chiffres répétés définis par le code de touche correspondant sur un [clavier de téléphone](https://www.dcode.fr/phone-keypad-cipher) mobile (ce mode est utilisé lors de l'écriture de SMS).\
...
Remplacez chaque lettre par 4 A ou B (ou 1 et 0)
```
