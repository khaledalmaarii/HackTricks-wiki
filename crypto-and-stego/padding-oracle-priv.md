...
Możesz użyć [https://github.com/AonCyberLabs/PadBuster](https://github.com/AonCyberLabs/PadBuster), aby wykorzystać ten rodzaj podatności lub po prostu użyj
```
...
Teraz możliwe jest **zmodyfikowanie `E7` aż `C15` będzie `0x01`**, co również będzie poprawnym dopełnieniem. W tym przypadku: `\x01 = I15 ^ E'7`
