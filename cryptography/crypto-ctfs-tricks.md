...
**Multitap** [remplace une lettre](https://www.dcode.fr/word-letter-change) par des chiffres répétés définis par le code clavier correspondant sur un [clavier de téléphone](https://www.dcode.fr/phone-keypad-cipher) mobile (Ce mode est utilisé lors de l'écriture de SMS).\
