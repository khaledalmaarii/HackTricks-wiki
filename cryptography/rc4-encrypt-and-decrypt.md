...
Se você conseguir de alguma forma criptografar um texto simples usando o RC4, você pode descriptografar qualquer conteúdo criptografado por esse RC4 (usando a mesma senha) apenas usando a função de criptografia.

Se você conseguir criptografar um texto simples conhecido, também pode extrair a senha. Mais referências podem ser encontradas na máquina HTB Kryptos:
