...
* [Write-up factory](https://writeup.raw.pm/) - Write-up (TryHackMe, HackTheBox, आदि) खोजने के लिए खोज इंजन
* [CTFtime Write-ups](https://ctftime.org/writeups) - CTF इवेंट्स पर जोड़े गए नवीनतम राइट-अप्स
