...
## Von kompiliertem Binärformat zu .pyc

Von einem **ELF** kompilierten Binärformat können Sie **die .pyc** mit:
```bash
...
```
In einer **python exe-Binärdatei**, die kompiliert wurde, können Sie **die .pyc** erhalten, indem Sie Folgendes ausführen:
```bash
