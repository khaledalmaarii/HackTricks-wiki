...
A ferramenta [https://github.com/countercept/python-exe-unpacker](https://github.com/countercept/python-exe-unpacker) combina várias ferramentas disponíveis para a comunidade que **ajudam pesquisadores a desempacotar e descompilar executáveis** escritos em python (py2exe e pyinstaller).
