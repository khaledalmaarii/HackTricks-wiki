...
**Os números mágicos variam de acordo com a versão do Python**, para obter o número mágico do **Python 3.8**, você precisará **abrir um terminal do Python 3.8** e executar:
```
>> import imp
>> imp.get_magic().hex()
'550d0d0a'
...
Dessa forma, um **cabeçalho mágico .pyc python3.8** corretamente adicionado ficará assim:
```bash
...
A ferramenta [https://github.com/countercept/python-exe-unpacker](https://github.com/countercept/python-exe-unpacker) reúne várias ferramentas disponíveis para a comunidade que ajudam os pesquisadores a desempacotar e descompilar executáveis escritos em python (py2exe e pyinstaller).
...
2. Para o payload (neste caso, vamos chamá-lo de hello.py), use um script como o mostrado na Figura 1. A opção "bundle\_files" com o valor 1 irá agrupar tudo, incluindo o interpretador Python, em um único executável.
