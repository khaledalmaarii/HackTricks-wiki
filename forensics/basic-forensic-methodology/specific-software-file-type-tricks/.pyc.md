...
Controlla la documentazione sugli errori precedenti.
...
```
## Analizzando l'assembly di python
...
2. Per il payload (in questo caso, lo chiameremo hello.py), utilizza uno script simile a quello nella Figura 1. L'opzione “bundle\_files” con il valore di 1 raggrupperà tutto, incluso l'interprete Python, in un unico exe.
...
**Suggerimento per bug bounty**: **iscriviti** a **Intigriti**, una premium **bug bounty platform creata da hacker, per hacker**! Unisciti a noi su [**https://go.intigriti.com/hacktricks**](https://go.intigriti.com/hacktricks) oggi, e inizia a guadagnare bounty fino a **$100,000**!
