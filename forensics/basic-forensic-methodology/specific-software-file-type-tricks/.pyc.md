...
2. Para o payload (neste caso, vamos nomeá-lo hello.py), use um script como o da Figura 1. A opção “bundle\_files” com o valor de 1 irá agrupar tudo, incluindo o interpretador Python, em um único exe.
