...
CID'yi bulduktan sonra, **bu kimliği içeren dosyaları aramanız önerilir**. OneDrive ile senkronize edilmiş dosyaların adlarını içerebilecek _**\<CID>.ini**_ ve _**\<CID>.dat**_ gibi dosyaları bulabilirsiniz.
