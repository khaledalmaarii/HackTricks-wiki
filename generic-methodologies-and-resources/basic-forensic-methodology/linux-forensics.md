...
असामान्य नामों या खातों की जांच करें जो _**/etc/passwd**_, _**/etc/shadow**_ और **सुरक्षा लॉग** में बनाए गए हैं या ज्ञात अनधिकृत घटनाओं के निकट उपयोग किए गए हैं। इसके अलावा, संभावित sudo ब्रूट-फोर्स हमलों की जांच करें।\
