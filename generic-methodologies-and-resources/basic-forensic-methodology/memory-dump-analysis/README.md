...
**पीकैप** के अंदर **मैलवेयर** के लिए **खोज** करना शुरू करें। [**मैलवेयर विश्लेषण**](../malware-analysis.md) में उल्लेखित **उपकरणों** का उपयोग करें।
...
[**यहाँ एक चीटशीट खोजें**](volatility-cheatsheet.md)
