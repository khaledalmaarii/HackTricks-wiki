...
Estrai gli hash SAM, le [credenziali memorizzate nella cache del dominio](../../../windows-hardening/stealing-credentials/credentials-protections.md#cached-credentials) e i [segnreti lsa](../../../windows-hardening/authentication-credentials-uac-and-efs/#lsa-secrets).
...
Questo comando utilizza Volatility per estrarre il testo dal processo Notepad all'interno del dump di memoria "memory\_dump.vmem" utilizzando il profilo "Win7SP1x64".
