...
| --------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0 (0x00)  | 8 bajtova  | Potpis ("EFI PART", 45h 46h 49h 20h 50h 41h 52h 54h ili 0x5452415020494645ULL[ ](https://en.wikipedia.org/wiki/GUID\_Partition\_Table#cite\_note-8)na little-endian mašinama) |
...
| --------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------- |
| Offset                      | Dužina   | Sadržaj                                                                                                          |
| 0 (0x00)                    | 16 bajtova | [GUID tipa particije](https://en.wikipedia.org/wiki/GUID\_Partition\_Table#Partition\_type\_GUIDs) (mešovit endian) |
| 16 (0x10)                   | 16 bajtova | Jedinstveni GUID particije (mešovit endian)                                                                              |
| 32 (0x20)                   | 8 bajtova  | Prvi LBA ([little endian](https://en.wikipedia.org/wiki/Little\_endian))                                         |
