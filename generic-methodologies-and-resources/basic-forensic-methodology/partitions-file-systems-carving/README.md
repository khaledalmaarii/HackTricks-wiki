...
Kifaa cha uhifadhi kama diski ngumu au **diski ya SSD inaweza kuwa na sehemu tofauti** kwa lengo la kugawa data kimwili.\
**Kitengo cha chini** cha diski ni **sektori** (kawaida inajumuisha 512B). Kwa hivyo, kila ukubwa wa sehemu unahitaji kuwa maradufu ya ukubwa huo.

### MBR (Rekodi ya Mwanzo wa Boot)
...
Inaruhusu hadi **sehemu 4** (angalau **moja tu** inaweza kuwa **inayoweza kuanzishwa**). Walakini, ikiwa unahitaji sehemu zaidi unaweza kutumia **sehemu zilizopanuliwa**. **Bayti ya mwisho** ya sektori hii ya kwanza ni saini ya rekodi ya boot **0x55AA**. Sehemu moja tu inaweza kuwa imeandikwa kama inayoweza kuanzishwa.\
...
Kutoka kwa **bayti 440 hadi 443** za MBR unaweza kupata **Sahihi ya Diski ya Windows** (ikiwa Windows inatumika). Barua ya kibodi ya anatokea kwa diski ngumu inategemea Saini ya Diski ya Windows. Kubadilisha saini hii inaweza kuzuia Windows kuanza (zana: [**Mhariri wa Diski ya Aktiviti**](https://www.disk-editor.org/index.html)**)**.
...
| 3 (0x03)  | 1 (0x01)  | Silinda ya Kuanza ya chini ya 8 bits                   |
...
| 7 (0x07)  | 1 (0x01)  | Silinda ya Mwisho ya chini ya 8 bits                   |
...
**Ukarabati wa kibao wa mantiki** (**LBA**) ni mpango wa kawaida unaotumiwa kwa **kutaja mahali pa vitalu** vya data vilivyohifadhiwa kwenye vifaa vya kuhifadhi vya kompyuta, kwa ujumla mifumo ya kuhifadhi ya sekondari kama vile diski ngumu. LBA ni mpango wa kutaja wa moja kwa moja wa linear; **vitalu hupatikana kwa nambari ya kipekee**, na kibao cha kwanza kikiwa LBA 0, kibao cha pili LBA 1, na kadhalika.

### GPT (Mwongozo wa Jedwali la Sehemu)

Mwongozo wa Jedwali la Sehemu, unaojulikana kama GPT, unapendelewa kwa uwezo wake ulioboreshwa ikilinganishwa na MBR (Rekodi ya Kuanza Mwalimu). Kipekee kwa **kitambulisho cha kipekee duniani** kwa sehemu, GPT inaonekana katika njia kadhaa:
...
* **Majina ya Sehemu**: Inatoa uwezo wa kutaja sehemu kwa hadi wahusika 36 wa Unicode.

**Uimara na Uokoaji wa Data**:

* **Udhibitishaji**: Tofauti na MBR, GPT haifungi upangaji wa sehemu na data ya kuanza kwenye sehemu moja. Inaiga data hii kote kwenye diski, ikiboresha uadilifu na uimara wa data.
* **Uchunguzi wa Redundancy wa Mzunguko (CRC)**: GPT inatumia CRC kuhakikisha uadilifu wa data. Inafuatilia kwa uangalifu uharibifu wa data, na ikigunduliwa, GPT inajaribu kurejesha data iliyoharibika kutoka eneo lingine la diski.

**MBR ya Kinga (LBA0)**:

* GPT inaendeleza ufuatano kupitia MBR ya kinga. Kipengele hiki kinaishi katika nafasi ya MBR ya urithi lakini imeundwa kuzuia programu za zamani za MBR kutokana na kusahau kwa makosa kuharibu diski zilizo na GPT, hivyo kulinda uadilifu wa data kwenye diski zilizo na GPT.
...
**MBR Mchanganyiko (LBA 0 + GPT)**

[Kutoka Wikipedia](https://en.wikipedia.org/wiki/GUID\_Partition\_Table)

Katika mifumo ya uendeshaji inayounga mkono **kuanza kwa msingi wa GPT kupitia huduma za BIOS** badala ya EFI, sehemu ya kwanza inaweza kutumika bado kuhifadhi hatua ya kwanza ya **mimba** ya msimbo wa **kuanza**, lakini **imebadilishwa** kutambua **sehemu za GPT**. Msimbo wa kuanza katika MBR usidhani ukubwa wa sehemu ya bytes 512.
...
| 92 (0x5C) | \*       | Imehifadhiwa; lazima iwe sifuri kwa sehemu iliyobaki (bytes 420 kwa ukubwa wa sehemu wa bytes 512; lakini inaweza kuwa zaidi na ukubwa mkubwa wa sehemu)                         |
...
| 48 (0x30)                   | 8 bytes  | Bendera za sifa (k.m. biti 60 inaonyesha kusoma tu)                                                              |
...
**Mfumo wa faili wa FAT (File Allocation Table)** umebuniwa karibu na sehemu yake kuu, jedwali la kugawanya faili, lililowekwa mwanzoni mwa kiasi. Mfumo huu unalinda data kwa kudumisha **nakala mbili** za jedwali, ikihakikisha usalama wa data hata kama moja inaharibika. Jedwali, pamoja na folda ya msingi, lazima iwe katika **eneo lililofungwa**, muhimu kwa mchakato wa kuanza kwa mfumo.

Kitengo msingi cha kuhifadhi cha mfumo wa FAT ni **kluster, kawaida 512B**, kikiwa na sehemu nyingi. FAT imeendelea kupitia toleo:
...
* **FAT32**, ikisonga mbele zaidi na anwani zenye biti 32, kuruhusu kluster 268,435,456 kwa kiasi.
...
Kama ilivyoonekana awali, kuna sehemu kadhaa ambapo faili bado imehifadhiwa baada ya kufutwa. Hii ni kwa sababu kawaida kufuta faili kutoka kwa mfumo wa faili kunaiweka kama imefutwa lakini data haijaguswa. Kisha, inawezekana kukagua usajili wa faili (kama MFT) na kupata faili zilizofutwa.
...
Tafadhali kumbuka kuwa mbinu hii **haitafaulu kurejesha faili zilizovunjika**. Ikiwa faili **haitunzwi katika sehemu za kluster zilizounganishwa**, basi mbinu hii haitaweza kuipata au angalau sehemu yake.
...
### Uchongaji wa **M**ishale ya **D**ata

Uchongaji wa Mishale ya Data ni sawa na Uchongaji wa Faili lakini **badala ya kutafuta faili kamili, inatafuta vipande vya kuvutia** vya habari.\
...
Kwa dhahiri, kuna njia za **kufuta faili kwa usalama na sehemu za magogo kuhusu hizo**. Kwa mfano, inawezekana **kubadilisha maudhui** ya faili na data ya taka mara kadhaa, kisha **iondoe** **magogo** kutoka kwa **$MFT** na **$LOGFILE** kuhusu faili, na **iondoe Nakala za Kivuli za Kiasi**.\
Unaweza kugundua kuwa hata ukifanya hatua hiyo, kunaweza kuwa na **sehemu zingine ambapo uwepo wa faili bado unasajiliwa**, na hiyo ni kweli na sehemu ya kazi ya mtaalamu wa uchunguzi wa kielelezo.
