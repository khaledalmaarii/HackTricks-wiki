...
आप संचार में जो लिखा गया था उसे प्राप्त करने के लिए [**ctf-usb-keyboard-parser**](https://github.com/TeamRocketIst/ctf-usb-keyboard-parser) उपकरण का उपयोग कर सकते हैं:
```bash
