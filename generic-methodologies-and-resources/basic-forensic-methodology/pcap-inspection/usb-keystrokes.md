...
तो आप उपकरण [**ctf-usb-keyboard-parser**](https://github.com/carlospolop-forks/ctf-usb-keyboard-parser) का उपयोग करके संचार में लिखा गया क्या था, प्राप्त कर सकते हैं:
```bash
