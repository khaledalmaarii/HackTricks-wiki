...
'550d0d0a'
```
Nambari ya **mchawi** katika kesi hii kwa python3.8 ni **`0x550d0d0a`**, kisha, ili kurekebisha kosa hili unahitaji **kuongeza** katika **mwanzoni** mwa **.pyc file** byte zifuatazo: `0x0d550a0d000000000000000000000000`
...
2. Kwa payload (katika kesi hii, tutaiita hello.py), tumia script kama ile katika Mchoro 1. Chaguo “bundle\_files” lenye thamani ya 1 litakusanya kila kitu ikiwa ni pamoja na mfasiri wa Python katika exe moja.
