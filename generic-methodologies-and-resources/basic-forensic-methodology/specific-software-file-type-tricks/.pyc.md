# Derlenmiş python ikili dosyalarını (exe, elf) açma - .pyc'den al
...
2. Yük için (bu durumda, ona hello.py adını vereceğiz), Şekil 1'deki gibi bir betik kullanın. "bundle\_files" seçeneği, 1 değeriyle, Python yorumlayıcısını da içeren her şeyi bir exe dosyasına paketleyecektir.
