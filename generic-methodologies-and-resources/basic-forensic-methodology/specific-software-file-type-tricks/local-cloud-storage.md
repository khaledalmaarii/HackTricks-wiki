...
Kwenye Windows, unaweza kupata folda ya OneDrive katika `\Users\<jina la mtumiaji>\AppData\Local\Microsoft\OneDrive`. Na ndani ya `logs\Personal` inawezekana kupata faili `SyncDiagnostics.log` ambayo ina data ya kuvutia kuhusu faili zilizosawazishwa:
...
Marafiki unapopata CID inashauriwa **tafuta faili zinazoleta kitambulisho hiki**. Unaweza kupata faili zenye majina: _**\<CID>.ini**_ na _**\<CID>.dat**_ ambazo zinaweza kuwa na habari ya kuvutia kama majina ya faili zilizosawazishwa na OneDrive.

## Google Drive

Kwenye Windows, unaweza kupata folda kuu ya Google Drive katika `\Users\<jina la mtumiaji>\AppData\Local\Google\Drive\user_default`\
