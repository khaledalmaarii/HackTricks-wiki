...
对于分析，**oletools**和**OfficeDissector**提供了用于检查OLE和OOXML文档的全面工具集。这些工具有助于识别和分析嵌入的宏，这些宏通常用作恶意软件传递的向量，通常下载并执行其他恶意负载。可以使用Libre Office在没有Microsoft Office的情况下分析VBA宏，该软件允许使用断点和监视变量进行调试。
