...
Usakinishaji na matumizi ya **oletools** ni rahisi, na amri zimetolewa kwa kusakinisha kupitia pip na kutoa macros kutoka kwa hati. Utekelezaji wa moja kwa moja wa macros unachochea na kazi kama vile `AutoOpen`, `AutoExec`, au `Document_Open`.
```bash
