...
Uma captura de tela que mostra o conteúdo da tarefa é fornecida: ![](https://2.bp.blogspot.com/-wqYubtuR\_W8/W19bV5S9XyI/AAAAAAAANhU/OHsBDEvjqmg9ayzdNwJ4y2DKZnhCdwSMgCLcBGAs/s1600/xml.png)
...
Em `SAM\Domains\Account\Users` é possível obter o nome de usuário, RID, último login, último login falhado, contador de login, política de senha e quando a conta foi criada. Para obter os **hashes**, você também **precisa** do arquivo/hive **SYSTEM**.
