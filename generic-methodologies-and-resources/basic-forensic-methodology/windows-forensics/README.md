...
L'**heure de création** de toute jumplist indique **la première fois que le fichier a été accédé** et l'**heure de modification la dernière fois**.
...
Les fichiers dans le dossier WPDNSE sont une copie des originaux, donc ne survivront pas à un redémarrage du PC et le GUID est pris à partir d'un shellbag.
...
### Fichiers OST Microsoft Outlook
...
* **Suppression de journal** : Les journaux de sécurité sont effacés, ce qui est souvent un signe révélateur de dissimulation d'activités illicites.
...
Les ID d'événements système utiles pour le suivi des périphériques USB incluent 20001/20003/10000 pour une utilisation initiale, 10100 pour les mises à jour des pilotes, et l'ID d'événement 112 du DeviceSetupManager pour les horodatages d'insertion.
