...
**Google में खोजें** उस तकनीक के डिफ़ॉल्ट क्रेडेंशियल्स के लिए जो इस्तेमाल की जा रही है, या **इन लिंक्स को आजमाएं**:
...
पीड़ित के बारे में आपके ज्ञान (नाम, तारीखें...) के आधार पर पासवर्ड जनरेट करें
```
python3 cupp.py -h
```
### [Wister](https://github.com/cycurity/wister)

एक वर्डलिस्ट जेनरेटर टूल, जो आपको शब्दों का एक सेट प्रदान करने की अनुमति देता है, जिससे आप दिए गए शब्दों से कई विविधताएँ बना सकते हैं, एक अनूठी और आदर्श वर्डलिस्ट बनाने के लिए जो एक विशेष लक्ष्य के संबंध में उपयोग करने के लिए उपयुक्त हो।
```bash
...
सेवा नाम के अनुसार वर्णानुक्रम में ऑर्डर किया गया।
...
MSSQL के लिए ब्रूट फोर्सिंग की तकनीकें अन्य डेटाबेस सिस्टम्स के समान होती हैं। आप `hydra`, `medusa`, `nmap` जैसे टूल्स का उपयोग कर सकते हैं, या फिर आप SQL Server के लिए विशेष रूप से बनाए गए टूल्स जैसे कि `mssql-cli` या `sqsh` का भी उपयोग कर सकते हैं।

ब्रूट फोर्सिंग के दौरान, आपको अक्सर लॉकआउट पॉलिसीज़ का सामना करना पड़ सकता है, जो लगातार विफल लॉगिन प्रयासों के बाद अकाउंट्स को लॉक कर देती हैं। इससे बचने के लिए, आपको धीरे-धीरे और सोच-समझकर प्रयास करने चाहिए।

यदि आपको एक लीक हुए डेटाबेस से पासवर्ड हासिल होते हैं, तो आप उन्हें ब्रूट फोर्सिंग में उपयोग कर सकते हैं, क्योंकि यूजर्स अक्सर एक ही पासवर्ड का उपयोग विभिन्न सेवाओं पर करते हैं।

अंत में, ब्रूट फोर्सिंग के लिए आपको अच्छे वर्डलिस्ट्स की आवश्यकता होगी। इन्हें आप ऑनलाइन खोज सकते हैं या `SecLists`, `John the Ripper`, `CrackStation` जैसे संसाधनों से प्राप्त कर सकते हैं।
```bash
...
```
का प्रयोग करने के लिए **oracle\_login** के साथ **patator** आपको **install** करना होगा:
```bash
...
STOMP टेक्स्ट प्रोटोकॉल ActiveMQ, RabbitMQ, HornetQ और OpenMQ जैसी मैसेज क्यूइंग सेवाओं के साथ इंटरैक्शन की अनुमति देता है।
```bash
...
* [https://www.onlinehashcrack.com/](https://www.onlinehashcrack.com) (हैशेज, WPA2 कैप्चर्स, और MSOffice, ZIP, PDF आर्काइव्स)
...
```
#### प्रसिद्ध प्लेनटेक्स्ट ज़िप अटैक

आपको **प्लेनटेक्स्ट** (या प्लेनटेक्स्ट का कुछ भाग) **जानना आवश्यक है जो एन्क्रिप्टेड ज़िप के अंदर मौजूद फाइल में होता है**। आप एन्क्रिप्टेड ज़िप के अंदर मौजूद **फाइलों के नाम और आकार की जांच कर सकते हैं** इस कमांड को चलाकर: **`7z l encrypted.zip`**\
...
* [**kwprocessor**](https://github.com/hashcat/kwprocessor)**:** उन्नत कीबोर्ड-वॉक जनरेटर जिसमें कॉन्फ़िगरेबल बेस चार्स, कीमैप और रूट्स होते हैं।
```bash
...
**हैशकैट** पहले से ही एक **फोल्डर नियमों के साथ आता है** लेकिन आप [**यहाँ अन्य रोचक नियम पा सकते हैं**](https://github.com/kaonashi-passwords/Kaonashi/tree/master/rules).
```
...
```
क्रैकिंग लिनक्स हैशेज - /etc/shadow फाइल
```
...
\
[**Trickest**](https://trickest.com/?utm\_campaign=hacktrics\&utm\_medium=banner\&utm\_source=hacktricks) का उपयोग करके आसानी से **वर्कफ्लोज़ का निर्माण और स्वचालन** करें जो दुनिया के **सबसे उन्नत** समुदाय टूल्स द्वारा संचालित होते हैं.\
