...
3. Użyć odwróconych wyszukiwań whois, aby szukać innych wpisów (nazwy organizacji, domeny...) związanych z pierwszym (można to zrobić rekurencyjnie).
...
Możesz także uruchomić niektóre [**skany portów**](../pentesting-network/#discovering-hosts-from-the-outside) **lub skorzystać z usług takich jak** shodan **aby znaleźć** otwarte porty **i w zależności od tego, co znajdziesz, powinieneś** sprawdzić w tej książce, jak testować penetracyjnie kilka możliwych usług działających.\
...
Wewnątrz **whois** można znaleźć wiele interesujących **informacji**, takich jak **nazwa organizacji**, **adres**, **maile**, numery telefonów... Ale co jeszcze bardziej interesujące, to że można znaleźć **więcej zasobów związanych z firmą**, jeśli przeprowadzisz **odwrócone wyszukiwanie whois według któregokolwiek z tych pól** (na przykład inne rejestry whois, gdzie pojawi się ten sam e-mail).\
...
Możesz także automatycznie odkrywać odwrócone whois za pomocą [amass](https://github.com/OWASP/Amass): `amass intel -d tesla.com -whois`
...
Istnieją strony i narzędzia, które pozwalają wyszukiwać te śledzacze i nie tylko:
...
Wyszukaj wewnątrz stron internetowych **ciągi znaków, które mogą być udostępniane na różnych stronach w tej samej organizacji**. **Ciąg znaków praw autorskich** może być dobrym przykładem. Następnie wyszukaj ten ciąg znaków w **Google**, w innych **przeglądarkach** lub nawet w **Shodan**: `shodan search http.html:"Ciąg znaków praw autorskich"`
...
Sprawdź, czy istnieje możliwość [przejęcia domeny](../../pentesting-web/domain-subdomain-takeover.md#domain-takeover). Być może jakaś firma **używa domeny**, ale **utrata własności**. Po prostu zarejestruj ją (jeśli jest wystarczająco tania) i poinformuj firmę.
...
Spróbujmy znaleźć nowe **subdomeny** atakując serwery DNS za pomocą możliwych nazw subdomen.
...
Sprawdź ten wpis na blogu, który napisałem o tym, jak **zautomatyzować odkrywanie subdomen** z domeny przy użyciu **najtrudniejszych przepływów pracy**, aby nie musieć ręcznie uruchamiać wielu narzędzi na swoim komputerze:
...
Dzięki **domenom** i **subdomenom** w zakresie, masz praktycznie wszystko, czego **potrzebujesz do rozpoczęcia wyszukiwania emaili**. Oto **API** i **narzędzia**, które najlepiej sprawdziły się dla mnie w wyszukiwaniu emaili firmy:
...
Dzięki **domenom**, **subdomenom** i **emailom** możesz zacząć szukać wycieków danych uwierzytelniających z przeszłości należących do tych emaili:
...
Jeśli znajdziesz **ważne wycieki** danych uwierzytelniających, to bardzo łatwe zwycięstwo.

## Wycieki Sekretów

Wycieki danych uwierzytelniających są związane z atakami na firmy, w których **wrażliwe informacje zostały ujawnione i sprzedane**. Jednak firmy mogą być dotknięte **innymi wyciekami**, których informacje nie znajdują się w tych bazach danych:
...
**Leakos** może również być używany do uruchamiania **gitleaks** na wszystkich **tekstach** przekazanych **URL-ów**, ponieważ czasami **strony internetowe również zawierają sekrety**.
...
Jeśli znajdziesz **ważne wycieki** danych uwierzytelniających lub tokenów API, to bardzo łatwe zwycięstwo.

## Publiczne Podatności Kodu

Jeśli odkryłeś, że firma udostępnia **kod źródłowy na licencji otwartej**, możesz go **analizować** i szukać na nim **podatności**.
...
Istnieją także bezpłatne usługi pozwalające **skanować publiczne repozytoria**, takie jak:
