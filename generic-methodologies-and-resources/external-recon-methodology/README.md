...
एक **एएस** में **आईपी पतों** के **ब्लॉक** होते हैं जिनके लिए बाहरी नेटवर्कों तक पहुंचने के लिए एक स्पष्ट निर्धारित नीति होती है और एक ही संगठन द्वारा प्रबंधित होते हैं लेकिन इसमें कई ऑपरेटर्स हो सकते हैं।

यह दिलचस्प होगा कि क्या **कंपनी ने कोई एएसएन सौंपा है** ताकि इसके **आईपी सीमाएं पता चलें**। स्कोप के सभी **होस्ट** के खिलाफ एक **सुरक्षा जांच** करना और इन आईपी में डोमेन्स खोजना दिलचस्प होगा।\
आप [**https://bgp.he.net/**](https://bgp.he.net) में कंपनी के **नाम**, **आईपी** या **डोमेन** से **खोज** कर सकते हैं।\
**कंपनी क्षेत्र के आधार पर ये लिंक्स अधिक डेटा जुटाने के लिए उपयोगी हो सकते हैं:** [**AFRINIC**](https://www.afrinic.net) **(अफ्रीका),** [**Arin**](https://www.arin.net/about/welcome/region/)**(उत्तर अमेरिका),** [**APNIC**](https://www.apnic.net) **(एशिया),** [**LACNIC**](https://www.lacnic.net) **(लैटिन अमेरिका),** [**RIPE NCC**](https://www.ripe.net) **(यूरोप)। जैसे ही, संभावित सभी** उपयोगी जानकारी **(आईपी सीमाएं और व्हॉइस)** पहले लिंक में ही दिखाई देती है।
```bash
...
इस बिंदु पर हमें **दायरा में सभी संपत्तियों** के बारे में पता है, इसलिए यदि आपको अनुमति है तो आप कुछ **सुरक्षा दोष स्कैनर** (Nessus, OpenVAS) को सभी होस्ट पर लॉन्च कर सकते हैं।\
इसके अलावा, आप कुछ [**पोर्ट स्कैन**](../pentesting-network/#discovering-hosts-from-the-outside) **भी लॉन्च कर सकते हैं या** shodan **जैसी सेवाओं का उपयोग करके** खुले पोर्ट्स **खोज सकते हैं और आपको मिलने वाले आधार पर इस पुस्तक में कैसे पेंटेस्ट करना चाहिए, उसे देखना चाहिए**।\
...
_कृपया ध्यान दें कि निम्नलिखित प्रस्तावित तकनीकों में आप सबडोमेन्स भी खोज सकते हैं और उस जानकारी को कम महत्वपूर्ण नहीं समझना चाहिए।_
...
एक **व्हॉइस** के अंदर आपको कई दिलचस्प **जानकारी** मिल सकती है जैसे **संगठन का नाम**, **पता**, **ईमेल**, फोन नंबर... लेकिन जो और भी दिलचस्प है वह यह है कि आप कंपनी से संबंधित **अधिक संपत्तियाँ खोज सकते हैं** अगर आप **उन क्षेत्रों में से किसी भी के द्वारा पलटें व्हॉइस खोज करते हैं** (उदाहरण के लिए जहां एक ही ईमेल प्रकट होता है, वहां अन्य व्हॉइस रजिस्ट्रीज में)।\
...
क्या आप जानते हैं कि हम लक्ष्य के संबंधित डोमेन और सब डोमेन्स को एक ही फेविकॉन आइकन हैश की खोज करके खोज सकते हैं? यही वह काम है जिसे [@m4ll0k2](https://twitter.com/m4ll0k2) द्वारा बनाए गए [favihash.py](https://github.com/m4ll0k/Bug-Bounty-Toolz/blob/master/favihash.py) उपकरण करता है। यहाँ इसका उपयोग कैसे करें:
```bash
...
[**यह पोस्ट**](https://kmsec.uk/blog/passive-takeover/) इसके बारे में एक कहानी का विवरण देता है और एक स्क्रिप्ट का प्रस्ताव देता है जो **DigitalOcean में एक वीएम को उत्पन्न करता है**, नए मशीन का **IPv4** प्राप्त करता है, और उसे इस पर प्वाइंट करने वाले सबडोमेन रिकॉर्ड्स के लिए Virustotal में खोजता है।
...
[**Assetfinder** ](https://github.com/tomnomnom/assetfinder) एक टूल है जो एक मुख्य डोमेन से संबंधित **डोमेनों** और उनके **सबडोमेन्स** की खोज करता है, बहुत शानदार।

### **विकल्प खोजना**

कुछ [डोमेन टेकओवर](../../pentesting-web/domain-subdomain-takeover.md#domain-takeover) के लिए जांच करें। शायद कोई कंपनी **किसी डोमेन का उपयोग कर रही हो** लेकिन उन्होंने **स्वामित्व खो दिया हो**। बस इसे रजिस्टर करें (यदि सस्ता हो) और कंपनी को सूचित करें।

यदि आपको किसी **डोमेन मिलता है जिसका आईपी पता अलग है** जो आपने पहले ही असेट्स डिस्कवरी में पाए हैं, तो आपको एक **मूलभूत सुरक्षा स्कैन** (Nessus या OpenVAS का उपयोग करके) और कुछ [**पोर्ट स्कैन**](../pentesting-network/#discovering-hosts-from-the-outside) करना चाहिए **nmap/masscan/shodan** के साथ। जिस सेवाएं चल रही हैं, आप उन्हें "हमला" करने के लिए **इस किताब में कुछ ट्रिक्स पा सकते हैं**।\
...
```
* [**goaltdns**](https://github.com/subfinder/goaltdns): डोमेन और सबडोमेन दिए गए परिपरिक्षण उत्पन्न करें।
* आप यहाँ [**वर्डलिस्ट**](https://github.com/subfinder/goaltdns/blob/master/words.txt) में goaltdns परिपरिक्षण परिमाण प्राप्त कर सकते हैं।
```bash
goaltdns -l subdomains.txt -w /tmp/words-permutations.txt -o /tmp/final-words-s3.txt
```
* [**गोटेटर**](https://github.com/Josue87/gotator)**:** डोमेन और सबडोमेन दिए गए परिमुटेशन उत्पन्न करें। अगर परिमुटेशन फ़ाइल निर्दिष्ट नहीं की गई है तो गोटेटर अपनी खुद की एक उपयोग करेगा।
```
gotator -sub subdomains.txt -silent [-perm /tmp/words-permutations.txt]
```
* [**altdns**](https://github.com/infosec-au/altdns): उपसर्ग उपस्थितियों का निर्माण करने के अलावा, यह उन्हें सुलझाने की कोशिश भी कर सकता है (लेकिन पिछले टिप्पणित उपकरणों का उपयोग करना बेहतर है)।
* आप यहाँ [**यहाँ**](https://github.com/infosec-au/altdns/blob/master/words.txt) altdns उपसर्ग **शब्द सूची** प्राप्त कर सकते हैं।
```
altdns -i subdomains.txt -w /tmp/words-permutations.txt -o /tmp/asd3
```
* [**dmut**](https://github.com/bp0lr/dmut): एक औजार जो subdomains की permutations, mutations और alterations को करने के लिए है। यह औजार brute force करेगा परिणाम (यह dns wild card का समर्थन नहीं करता)।
...
```
* [**subzuf**](https://github.com/elceef/subzuf)**:** _subzuf_ एक सबडोमेन ब्रूट-फोर्स फज़र है जिसे एक अत्यधिक सरल लेकिन प्रभावी DNS प्रतिक्रिया-निर्देशित एल्गोरिदम के साथ जोड़ा गया है। यह एक विशेष वर्डलिस्ट या ऐतिहासिक DNS/TLS रिकॉर्ड्स जैसे प्रदत्त इनपुट डेटा का उपयोग करता है, ताकि अधिक संबंधित डोमेन नामों को सार्थक रूप से सिन्थेसाइज़ किया जा सके और DNS स्कैन के दौरान जुटाई गई जानकारी के आधार पर उन्हें और भी अधिक विस्तारित किया जा सके।
```
...
आप कुछ **आईपी में VHosts खोज सकते हैं** [**HostHunter**](https://github.com/SpiderLabs/HostHunter) **या अन्य API का उपयोग करके**।
...
कभी-कभी आप पृष्ठ मिलेंगे जो केवल वापसी शीर्षक _**Access-Control-Allow-Origin**_ वापस करते हैं जब एक मान्य डोमेन/सबडोमेन _**Origin**_ शीर्षक में सेट किया जाता है। इन परिदृश्यों में, आप इस व्यवहार का दुरुपयोग करके **नए सबडोमेन** की **खोज** कर सकते हैं।
```bash
...
आप यह **निगरानी** कर सकते हैं कि क्या किसी डोमेन के **नए सबडोमेन्स** बनाए गए हैं, **सर्टिफिकेट ट्रांसपेरेंसी** लॉग [**sublert** ](https://github.com/yassineaboukir/sublert/blob/master/sublert.py) की मॉनिटरिंग करके।
...
अगर आपको किसी **सबडोमेन** में किसी भी पहले से अलग **आईपी** मिलती है जो आपने पहले ही आस्तित्व की खोज में पाई है, तो आपको एक **बेसिक सुरक्षा स्कैन** (Nessus या OpenVAS का उपयोग करके) और कुछ [**पोर्ट स्कैन**](../pentesting-network/#discovering-hosts-from-the-outside) जैसे **nmap/masscan/shodan** के साथ करना चाहिए। चल रही सेवाओं पर निर्भर करता है कि आप उन्हें "हमला" करने के लिए **इस किताब में कुछ ट्रिक्स** पा सकते हैं।\
_ध्यान दें कि कभी-कभी सबडोमेन उस आईपी के अंदर होस्ट किया जाता है जो ग्राहक द्वारा नियंत्रित नहीं है, इसलिए यह दायरे में नहीं है, सावधान रहें._

## आईपी

प्रारंभिक चरणों में आपने **कुछ आईपी रेंज, डोमेन और सबडोमेन्स** पाए होंगे।\
अब समय है कि आप **उन रेंजों से सभी आईपी एवं डोमेन/सबडोमेन्स को पुनः जुटाएं** (डीएनएस क्वेरीज का उपयोग करके)।
...
फिर, उन शब्दों के साथ आपको **अनुक्रमणिकाएँ** उत्पन्न करनी चाहिए (अधिक जानकारी के लिए [**दूसरे दिन DNS ब्रूट-फोर्स**](./#second-dns-bruteforce-round) की जांच करें)।
...
प्रमाणक और APIs कंपनी के **सार्वजनिक रिपॉजिटरी** या उस गिटहब कंपनी के **उपयोगकर्ताओं** के सार्वजनिक रिपॉजिटरी में लीक हो सकते हैं।\
...
पुराने लेकिन सोने के गूगल डोर्क्स हमेशा **उजागर जानकारी खोजने** के लिए उपयोगी होते हैं। एकमात्र समस्या यह है कि [**google-hacking-database**](https://www.exploit-db.com/google-hacking-database) कई **हजारों** संभावित क्वेरी शामिल करता है जिन्हें आप मैन्युअल रूप से नहीं चला सकते। इसलिए, आप अपने पसंदीदा 10 क्वेरी ले सकते हैं या आप एक **उपकरण जैसे** [**Gorks**](https://github.com/carlospolop/Gorks) **का उपय
...
मैं भी विशेष रूप से ध्यान देना चाहूंगा [**वेब ऑटोमेटेड स्कैनर ओपन सोर्स टूल्स**](../../network-services-pentesting/pentesting-web/#automatic-scanners) विभाग को, क्योंकि, यदि आपको उन्हें आपको बहुत संवेदनशील दोषों को खोजने की उम्मीद नहीं है, तो वे **कुछ प्रारंभिक वेब जानकारी पर लागू करने में मददगार होते हैं।**
...
* **हैकिंग ट्रिक्स साझा करें** द्वारा **पीआर्स** को सबमिट करके [**HackTricks**](https://github.com/carlospolop/hacktricks) और [**HackTricks Cloud**](https://github.com/carlospolop/hacktricks-cloud) github repos.
