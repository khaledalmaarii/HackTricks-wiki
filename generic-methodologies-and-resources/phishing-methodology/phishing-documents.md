...
आम तौर पर, माइक्रोसॉफ्ट वर्ड फ़ाइल मैक्रो का उपयोग करती हैं `.docm` एक्सटेंशन वाली। हालांकि, फ़ाइल का एक्सटेंशन बदलकर भी फ़ाइल को उसके मैक्रो क्रियान्वयन क्षमताओं को बनाए रखना संभव है।\
उदाहरण के लिए, एक RTF फ़ाइल मैक्रो का समर्थन डिज़ाइन के अनुसार नहीं करती है, लेकिन एक DOCM फ़ाइल जिसे RTF में नाम बदल दिया गया होगा, माइक्रोसॉफ्ट वर्ड द्वारा संभाली जाएगी और मैक्रो क्रियान्वयन क्षमता होगी।\
एक ही आंतरिक और तंत्रिका सभी माइक्रोसॉफ्ट ऑफिस स्यूट (एक्सेल, पावरपॉइंट आदि) पर लागू होती है।
...
**फ़ाइल > सूचना > दस्तावेज़ जांचें > दस्तावेज़ जांचें** पर जाएं, जिससे दस्तावेज़ इंस्पेक्टर खुलेगा। **जांचें** पर क्लिक करें और फिर **दस्तावेज़ गुण और व्यक्तिगत जानकारी** के पास **सभी हटाएं** पर क्लिक करें।

#### डॉक एक्सटेंशन

समाप्त होने पर, **सेव एस टाइप** ड्रॉपडाउन का चयन करें, **फॉर्मेट** को **`.docx`** से **वर्ड 97-2003 `.doc`** में बदलें।\
इसे इसलिए करें क्योंकि आप **`.docx`** के अंदर मैक्रो सहेज नहीं सकते हैं और मैक्रो-सक्षम **`.docm`** एक्सटेंशन के आसपास **एक संकेत** है (जैसे कि थंबनेल आइकन में एक विशाल `!` होता है और कुछ वेब/ईमेल गेटवे उन्हें पूरी तरह से ब्लॉक कर देते हैं)। इसलिए, यह **पुरानी `.doc` एक्सटेंशन सबसे अच्छा समझौता है**।
...
एक एचटीए एक विंडोज प्रोग्राम है जो **एचटीए एचटीए एक विंडोज प्रोग्राम है जो HTML और स्क्रिप्टिंग भाषाओं (जैसे कि वीबीस्क्रिप्ट और जेस्क्रिप्ट)** को संयोजित करता है। यह उपयोगकर्ता इंटरफ़ेस उत्पन्न करता है और एक "पूरी तरह से विश्वसनीय" एप्लिकेशन के रूप में कार्यान्वित होता है, ब्राउज़र की सुरक्षा मॉडल की प्रतिबंधों के बिना।
...
**NTLM प्रमाणीकरण "दूरस्थ" करने** के कई तरीके हैं, उदाहरण के लिए, आप ईमेल या HTML में **अदृश्य छवियों** को जोड़ सकते हैं जिन्हें उपयोगकर्ता तक पहुंचेगा (यहाँ तक कि HTTP MitM?). या पीड़ित को ऐसे **फ़ाइलों का पता** भेजें जो **फ़ोल्डर खोलने के लिए केवल प्रमाणीकरण** को **ट्रिगर** करेंगे।
...
याद रखें कि आप न केवल हैश या प्रमाणीकरण चुरा सकते हैं बल्कि **NTLM रिले हमले** भी **कर सकते हैं**:
