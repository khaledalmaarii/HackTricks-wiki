...
## Omseil pickle sandboks met die standaard geïnstalleerde Python-pakkette
...
{% hint style="danger" %}
Kyk ook na die volgende bladsy vir toestelle wat **gevoelige inligting van Python interne voorwerpe kan lees**:
{% endhint %}
