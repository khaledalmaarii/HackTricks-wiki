...
Очевидно, **в Windows немає SUID файлів або привілеїв sudo**, але корисно знати **як** деякі **бінарники** можуть бути (зловжито) використані для виконання деяких неочікуваних дій, таких як **виконання довільного коду.**
...
```
Ви можете завантажити базову C# зворотну оболонку звідси: [https://gist.github.com/BankSecurity/55faad0d0c4259c623147db79b2a83cc](https://gist.github.com/BankSecurity/55faad0d0c4259c623147db79b2a83cc)
...
```
Запустіть веб-сервер, що надає файл _powershell\_attack.txt_, і виконайте його на жертві:
```
