...
```
Možete koristiti ovu tehniku da zaobiđete aplikacijsko beljenje i ograničenja Powershell.exe. Kada se to dogodi, bićete upitani sa PS shell-om.\
...
```
Defender ga ne prepoznaje kao zloćudni kod (još, 3/04/2019).
