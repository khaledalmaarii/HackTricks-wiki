...
Otra posibilidad consiste en usar la implementación de shell de reenvío de `IppSec` [**https://github.com/IppSec/forward-shell**](https://github.com/IppSec/forward-shell).
