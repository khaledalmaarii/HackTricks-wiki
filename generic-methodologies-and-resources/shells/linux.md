...
**यदि आपके पास इन शैल्स में से किसी के बारे में सवाल है तो आप उन्हें चेक कर सकते हैं** [**https://explainshell.com/**](https://explainshell.com)

## पूर्ण TTY

**एक रिवर्स शैल स्वीकार करने के बाद**[ **एक पूर्ण TTY प्राप्त करने के लिए इस पेज को पढ़ें**](full-ttys.md)**.**
...
2. **`>&`**: इस कमांड का यह हिस्सा **मानक आउटपुट** (`stdout`) और **मानक त्रुटि** (`stderr`) को **एक ही गंतव्य** में पुन:निर्देशित करने के लिए एक संक्षेप चिह्न है।
...
* **इस फ़ाइल पर आउटपुट और त्रुटि स्ट्रीम को पुन:निर्देशित करके**, कमांड असल में इंटरैक्टिव शैल सत्र का आउटपुट हमलावर की मशीन पर भेजता है।
4. **`0>&1`**: इस कमांड का यह हिस्सा **मानक इनपुट (`stdin`) को मानक आउटपुट (`stdout`) के समान गंतव्य पर पुन:निर्देशित करता है**।
...
यदि आपको एक लिनक्स-आधारित वेब एप्लिकेशन में **RCE वंश** का सामना करना पड़ता है, तो कई स्थितियों में **आईपीटेबल्स नियमों या अन्य फ़िल्टर्स की मौजूदगी** के कारण **रिवर्स शैल प्राप्त करना कठिन हो सकता है**। इस तरह की स्थितियों में, पाइप का उपयोग करके संदिग्ध सिस्टम में PTY शैल बनाने का विचार करें।

आप [**https://github.com/IppSec/forward-shell**](https://github.com/IppSec/forward-shell) में कोड पा सकते हैं।

आपको केवल इसे संशोधित करना होगा:

* वंशशील होस्ट का URL
* अपने पेयलोड का उपसर्ग और प्रत्यय (यदि कोई हो)
* पेयलोड को भेजने का तरीका (हेडर? डेटा? अतिरिक्त जानकारी?)
...
PHP (Hypertext Preprocessor) एक उच्च स्तरीय स्क्रिप्टिंग भाषा है जो वेब विकास के लिए व्यापक रूप से उपयोग की जाती है। PHP को सर्वर-साइड स्क्रिप्टिंग भाषा के रूप में उपयोग किया जाता है, जिससे वह वेब सर्वर पर सीधे चलाया जा सकता है। PHP को एचटीएमएल पेजों में एम्बेड करने के लिए उपयोग किया जाता है और यह डाटाबेस से डेटा प्राप्त करने और उसे संशोधित करने की क्षमता भी रखता है।
```php
