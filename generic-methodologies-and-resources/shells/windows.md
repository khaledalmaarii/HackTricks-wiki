...
Carga escrita no disco: **NÃO** (_pelo menos em nenhum lugar que eu pudesse encontrar usando o procmon!_)
```bash
...
Carga escrita no disco: **cache local do IE**
```
...
```
Baixe um B64exe, decodifique e execute.
```bash
