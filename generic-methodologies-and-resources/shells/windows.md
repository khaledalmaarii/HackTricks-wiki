...
Obviamente, **no hay archivos SUID ni privilegios sudo en Windows**, pero es útil saber **cómo** algunos **binarios** pueden ser (mal)usados para realizar algún tipo de acciones inesperadas como **ejecutar código arbitrario.**
...
```
Defender no lo detecta como código malicioso (aún, 04/03/2019).
...
```
Defender no lo detecta como código malicioso (aún, 03/04/2019).
