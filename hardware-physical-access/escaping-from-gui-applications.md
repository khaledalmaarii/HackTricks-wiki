...
Είναι μια εργαλειοθήκη που εμφανίζεται στην επάνω αριστερή γωνία της εικόνας όταν κάνετε κλικ. Θα μπορείτε να Αποθηκεύσετε, Εκτυπώσετε, Στείλετε μέσω Mailto, Ανοίξετε "Οι Εικόνες Μου" στο Explorer. Το Kiosk πρέπει να χρησιμοποιεί τον Internet Explorer.
