...
**Gängige Dialogfelder** sind Optionen zum **Speichern einer Datei**, **Öffnen einer Datei**, Auswahl einer Schriftart, einer Farbe... Die meisten von ihnen werden eine vollständige Explorer-Funktionalität **anbieten**. Dies bedeutet, dass Sie auf Explorer-Funktionalitäten zugreifen können, wenn Sie auf diese Optionen zugreifen können:
...
* Wischen Sie von oben am Rand, um die Titelleiste für eine App im Vollbildmodus sichtbar zu machen;
...
* Wischen Sie mit einem Finger von unten am Bildschirmrand nur 1-2 Zoll (langsam): Das Dock wird angezeigt
* Wischen Sie mit einem Finger von oben am Bildschirm nach unten: Um Ihre Benachrichtigungen anzuzeigen
* Wischen Sie mit einem Finger von oben rechts am Bildschirm nach unten: Um das Kontrollzentrum des iPad Pro anzuzeigen
* Wischen Sie mit einem Finger von links am Bildschirm 1-2 Zoll: Um die Ansicht "Heute" anzuzeigen
...
* Drücken Sie die Ein/**Aus**-/Standby-Taste in der oberen rechten Ecke des **iPad und die Home-Taste schnell**: Um einen Screenshot aufzunehmen, der unten links auf dem Bildschirm angezeigt wird. Drücken Sie beide Tasten gleichzeitig sehr kurz, als ob Sie sie einige Sekunden lang gedrückt halten würden, um ein erzwungenes Ausschalten durchzuführen.
...
| ⌘⇥ (Befehl-Tabulatortaste)                                   | Liste der zehn zuletzt verwendeten Apps                                 |
