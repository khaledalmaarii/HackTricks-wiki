...
- Vérifiez si des fonctionnalités de débogage telles que le journalisation détaillée, le chargement de noyaux arbitraires ou le démarrage à partir de sources non fiables sont activées.
