...
3. La charge utile peut être transférée sur l'appareil compromis et s'assurer qu'elle a les permissions d'exécution.
4. Metasploit peut être préparé à gérer les demandes entrantes en démarrant msfconsole et en configurant les paramètres selon la charge utile.
