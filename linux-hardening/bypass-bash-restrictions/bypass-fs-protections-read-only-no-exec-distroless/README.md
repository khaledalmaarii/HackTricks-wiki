...
Jeśli interesuje Cię **kariera hakerska** i hakowanie niemożliwych do zhakowania rzeczy - **rekrutujemy!** (_biegła znajomość języka polskiego w mowie i piśmie wymagana_).
...
O podobnym celu do DDexec, technika [**memdlopen**](https://github.com/arget13/memdlopen) umożliwia **łatwiejsze ładowanie plików binarnych** do pamięci, aby później je uruchomić. Może nawet umożliwić ładowanie plików binarnych z zależnościami.
...
Jeśli interesuje Cię **kariera w hakerstwie** i hakowanie niemożliwych do zhakowania - **rekrutujemy!** (_wymagana biegła znajomość języka polskiego w mowie i piśmie_).
