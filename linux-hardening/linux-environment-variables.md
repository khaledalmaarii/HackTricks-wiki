...
Verander die **waarde van hierdie veranderlike na 0**, sodat wanneer jy **jou sessie beëindig** enige opdrag by die **geskiedenis lêer** (\~/.bash\_history) nie bygevoeg sal word nie.
```bash
export HISTSIZE=0
```
