...
* **MANPATH** – die lys van gids om vir handleidings te soek.
...
Die prosesse sal die **proxy** wat hier gedefinieer is, gebruik om met die internet te verbind deur **http of https**.
```bash
