...
* _**/etc/bash.bashrc**_: यह फ़ाइल हर बार पढ़ी जाती है जब एक इंटरैक्टिव शैल शुरू होता है (सामान्य टर्मिनल) और यहां दिए गए सभी कमांड निष्पादित किए जाते हैं।
* _**/etc/profile और /etc/profile.d/\***_**:** यह फ़ाइल हर बार पढ़ी जाती है जब एक उपयोगकर्ता लॉग इन करता है। इसलिए यहां निष्पादित सभी कमांड केवल एक बार उपयोगकर्ता लॉग इन करने के समय निष्पादित होंगे।
*   \*\*उदाहरण: \*\*
...
* **PATH** – उन सभी निर्देशिकाओं का पथ संग्रहित करता है जिनमें बाइनरी फ़ाइलें हैं जिन्हें आप नाम द्वारा स्पष्ट करने या सम्बंधित या पूर्ण पथ द्वारा नहीं निष्पादित करना चाहते हैं।
* **PWD** – वर्तमान काम कर रही निर्देशिका।
...
इस चर के मान को 0 परिवर्तित करें, ताकि जब आप अपनी सत्र समाप्त करें, कोई भी कमांड **इतिहास फ़ाइल** (\~/.bash\_history) में जोड़ा न जाए।
```bash
export HISTSIZE=0
```
