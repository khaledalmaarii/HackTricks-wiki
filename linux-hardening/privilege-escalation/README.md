...
1. **Listar Imagens do Docker:** Obter a lista de imagens disponíveis.

```bash
curl -XGET --unix-socket /var/run/docker.sock http://localhost/images/json
```

2. **Criar um Contêiner:** Enviar uma solicitação para criar um contêiner que monta o diretório raiz do sistema host.
...
Para **ler logs do grupo** [**adm**](https://github.com/carlospolop/hacktricks/blob/pt/linux-hardening/privilege-escalation/grupos-interessantes-linux-pe/README.md#grupo-adm) será realmente útil.
