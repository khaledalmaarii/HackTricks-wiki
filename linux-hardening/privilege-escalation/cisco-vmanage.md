...
थोड़ी खोज के बाद कुछ [दस्तावेज़ीकरण](http://66.218.245.39/doc/html/rn03re18.html) से जुड़ा, `confd` और विभिन्न बाइनरी (सिस्को वेबसाइट पर खाता होने पर पहुंचने योग्य) के बारे में हमने पाया कि IPC सॉकेट को प्रमाणित करने के लिए, यह `/etc/confd/confd_ipc_secret` में स्थित एक गुप्त उपयोग करता है:
```
vmanage:~$ ls -al /etc/confd/confd_ipc_secret

-rw-r----- 1 vmanage vmanage 42 Mar 12 15:47 /etc/confd/confd_ipc_secret
```
आपको हमारे Neo4j इंस्टेंस का याद है? यह `vmanage` उपयोगकर्ता की अनुमतियों के तहत चल रहा है, जिससे हमें पिछली कमजोरी का उपयोग करके फ़ाइल प्राप्त करने की अनुमति है:
```
...
साइनैक्टिव टीम द्वारा लिखित ब्लॉग¹ में एक शानदार तरीका वर्णित किया गया था जिससे रूट शैल मिल सकता है, लेकिन एक सावधानी है कि यह `/usr/bin/confd_cli_user` की प्रतिलिपि प्राप्त करना आवश्यक है जो केवल रूट द्वारा पढ़ा जा सकता है। मैंने इस तरह से रूट तक उन्नति करने का एक और तरीका खोजा।
...
Synacktiv के ब्लॉग (अंतिम उदाहरण में) में उल्लिखित है कि `confd_cli` कार्यक्रम कमांड लाइन तर्क का समर्थन नहीं करता है, लेकिन मैं इसे डीबगर के साथ प्रभावित कर सकता हूँ और भाग्य से GDB सिस्टम पर शामिल है।

मैंने एक GDB स्क्रिप्ट बनाया जहाँ मैंने API `getuid` और `getgid` को 0 लौटाने के लिए बाध्य किया। क्योंकि मेरे पास पहले से ही "vmanage" विशेषाधिकार हैं जिसके माध्यम से अद्यावधिकीकरण RCE के माध्यम से मुझे `/etc/confd/confd_ipc_secret` को सीधे पढ़ने की अनुमति है।
