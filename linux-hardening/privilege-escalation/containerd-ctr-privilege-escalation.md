# Povećanje privilegija Containerd (ctr)
...
```
I zatim **pokrenite jednu od tih slika montirajući glavni root folder na nju**:
```bash
...
```
Zatim možete koristiti neke od tehnika navedenih na sledećoj stranici da **pobegnete iz nje zloupotrebom privilegovanih sposobnosti**:
