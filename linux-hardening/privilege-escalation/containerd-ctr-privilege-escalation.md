# Εκμετάλλευση Προνομίων στο Containerd (ctr)
...
Εκτέλεση ενός προνομιούχου container και διαφυγή από αυτόν.\
Μπορείτε να εκτελέσετε ένα προνομιούχο container ως εξής:
```bash
