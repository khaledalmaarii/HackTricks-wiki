# Εκμετάλλευση Προνομίων Containerd (ctr)
...
Εκτελέστε ένα container με δικαιώματα και δραπετεύστε από αυτό.\
Μπορείτε να εκτελέσετε ένα container με δικαιώματα ως:
```bash
