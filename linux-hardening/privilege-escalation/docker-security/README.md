...
\
Użyj [**Trickest**](https://trickest.com/?utm_source=hacktricks&utm_medium=text&utm_campaign=ppc&utm_content=docker-security), aby łatwo budować i **automatyzować przepływy pracy** z wykorzystaniem najbardziej zaawansowanych narzędzi społeczności na świecie.\
Zdobądź Dostęp Dziś:
...
* [**Docker Trusted Registry**](https://www.docker.com/docker-trusted-registry): Komercyjny rejestr od Dockera, oferujący uwierzytelnianie użytkowników oparte na rolach oraz integrację z usługami katalogowymi LDAP.
...
* [**Użyj opcji bezpieczeństwa "no-new-privileges"**](https://raesene.github.io/blog/2019/06/01/docker-capabilities-and-no-new-privs/) **aby zapobiec procesom zdobywaniu większych uprawnień, na przykład poprzez binarne suid.**
