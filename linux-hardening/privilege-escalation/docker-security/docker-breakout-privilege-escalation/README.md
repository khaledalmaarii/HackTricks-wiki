...
{% hint style="info" %}
Konteynerin savunmasız olabileceği diğer CVE'ler bulunabilir, bir liste [burada](https://0xn3va.gitbook.io/cheat-sheets/container/escaping/cve-list) bulunabilir.
{% endhint %}
