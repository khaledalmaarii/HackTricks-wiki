...
* Obaveštenja se omogućavaju za podgrupu "x" upisivanjem broja 1 u njen fajl notify\_on\_release.
```shell
echo 1 > /tmp/cgrp/x/notify_on_release
```
3. **Konfigurišite Release Agent:**
* Putanja kontejnera na domaćinu se dobija iz fajla /etc/mtab.
* Zatim se konfiguriše release\_agent fajl cgroup-a da izvrši skriptu nazvanu /cmd smeštenu na dobijenoj putanji domaćina.
```shell
