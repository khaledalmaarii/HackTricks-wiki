...
कर्नेल फ़ाइल सिस्टम एक प्रक्रिया के लिए कर्नेल के व्यवहार को संशोधित करने के लिए एक तंत्र प्रदान करते हैं। हालांकि, जब यह कंटेनर प्रक्रियाएँ होती हैं, तो हम चाहते हैं कि उन्हें कर्नेल में कोई भी परिवर्तन न करने दिया जाए। इसलिए, हम कर्नेल फ़ाइल सिस्टम को कंटेनर के भीतर **केवल पढ़ने योग्य** रूप में माउंट करते हैं, यह सुनिश्चित करते हैं कि कंटेनर प्रक्रियाएँ कर्नेल को संशोधित नहीं कर सकतीं।
```bash
# docker run --rm -it alpine sh
mount | grep '(ro'
...
mount  | grep '(ro'
```
### कर्नेल फ़ाइल सिस्टम को मास्किंग करना
...
कंटेनर इंजन डिफ़ॉल्ट रूप से कंटेनर के अंदर क्या हो रहा है को नियंत्रित करने के लिए **कुछ सीमित संख्या** की **क्षमताएँ** के साथ कंटेनर को लॉन्च करते हैं। **विशेषाधिकृत** वाले में **सभी** **क्षमताएँ** एक्सेस करने योग्य होती हैं। क्षमताओं के बारे में जानने के लिए पढ़ें:
...
**Seccomp** कंटेनर द्वारा कॉल किए जा सकने वाले **syscalls** को **सीमित** करने के लिए उपयोगी है। डॉकर कंटेनर चलाते समय एक डिफ़ॉल्ट सेकॉम्प प्रोफ़ाइल सक्षम होता है, लेकिन विशेषाधिकारित मोड में यह अक्षम हो जाता है। Seccomp के बारे में अधिक जानकारी के लिए यहाँ देखें:
...
**AppArmor** एक कर्नेल एन्हांसमेंट है जो **कंटेनर** को **सीमित संसाधनों** के **लिमिटेड सेट** के साथ **पर-प्रोग्राम प्रोफ़ाइल** में सीमित करने के लिए है। जब आप `--privileged` फ़्लैग के साथ चलाते हैं, तो यह सुरक्षा अक्षम हो जाती है।
...
नेमस्पेस को `--privileged` फ्लैग से **प्रभावित नहीं** किया जाता है। यहाँ तक कि जब उनके सुरक्षा प्रतिबंध सक्षम नहीं होते हैं, तो **वे सिस्टम पर सभी प्रक्रियाएँ या मुख्य नेटवर्क को नहीं देखते हैं, उदाहरण के लिए**। उपयोगकर्ता **`--pid=host`, `--net=host`, `--ipc=host`, `--uts=host`** कंटेनर इंजन फ्लैग का उपयोग करके व्यक्तिगत नेमस्पेस को अक्षम कर सकते हैं।
...
**डिफ़ॉल्ट रूप से, कंटेनर इंजन यूजर नेमस्पेस का उपयोग नहीं करते हैं, केवल रूटलेस कंटेनर के लिए**, जिन्हें फ़ाइल सिस्टम माउंटिंग और एक से अधिक यूआईडी का उपयोग करने के लिए इसकी आवश्यकता होती है। यूजर नेमस्पेस, जो रूटलेस कंटेनर के लिए अनिवार्य हैं, को अक्षम नहीं किया जा सकता और विशेष रूप से सुरक्षा को बढ़ावा देते हैं द्वारा विशेषाधिकारों की प्रतिबंधित करके सुरक्षा को महत्वपूर्ण बनाते हैं।
...
* क्या आप **साइबर सुरक्षा कंपनी** में काम करते हैं? क्या आप चाहते हैं कि आपकी **कंपनी को हैकट्रिक्स में विज्ञापित** किया जाए? या क्या आप **नवीनतम संस्करण का पीएएसएस देखना चाहते हैं या हैकट्रिक्स को पीडीएफ़ में डाउनलोड करना चाहते हैं**? [**सब्सक्रिप्शन प्लान्स**](https://github.com/sponsors/carlospolop) की जाँच करें!
* अपने [**The PEASS Family**](https://opensea.io/collection/the-peass-family) की खोज करें, हमारा विशेष [**एनएफटीएस**](https://opensea.io/collection/the-peass-family) संग्रह।
