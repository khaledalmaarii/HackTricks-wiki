...
{% hint style="warning" %}
Étant donné que le **débogueur a un accès complet à l'environnement d'exécution de Node.js**, un acteur malveillant capable de se connecter à ce port pourrait être en mesure d'exécuter du code arbitraire au nom du processus Node.js (**élévation potentielle des privilèges**).
{% endhint %}
