...
आप अपनी मशीन में इस डिस्ट्रो बिल्डर को इंस्टॉल कर सकते हैं: [https://github.com/lxc/distrobuilder ](https://github.com/lxc/distrobuilder)(github के निर्देशों का पालन करें):
```bash
sudo su
...
```
फ़ाइलें **lxd.tar.xz** और **rootfs.squashfs** अपलोड करें, छवि को रेपो में जोड़ें और एक कंटेनर बनाएँ:
```bash
...
अंततः आप कंटेनर को निष्पादित कर सकते हैं और रूट प्राप्त कर सकते हैं:
```bash
lxc start privesc
...
एक Alpine छवि बनाएं और उसे ध्वज `security.privileged=true` का उपयोग करके शुरू करें, जिससे कंटेनर को मजबूर किया जाए कि यह मूल फ़ाइल सिस्टम के रूप में रूट के रूप में व्यवहार करे।
```bash
