...
Перевіримо тут можливості `tcpdump` після надання достатньо можливостей виконуваному файлу (cap\_net\_admin та cap\_net\_raw) для перехоплення мережі (tcpdump працює у процесі 9562):
...
Як ви можете побачити, надані можливості відповідають результатам 2 способів отримання можливостей бінарного файлу. Інструмент _getpcaps_ використовує системний виклик **capget()** для запиту доступних можливостей для певного потоку. Цей системний виклик потрібно лише надати PID, щоб отримати більше інформації.
...
* **S\_IFCHR**: Спеціальні файли символьних пристроїв, які є пристроями, наприклад, терміналами.
* **S\_IFBLK**: Спеціальні файли блочних пристроїв, які є пристроями, наприклад, дисками.
