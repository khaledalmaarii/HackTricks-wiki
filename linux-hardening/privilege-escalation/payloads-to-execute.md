...
* _/run/docker.sock_ या _/var/run/docker.sock_ में डॉकर सॉकेट के माध्यम से दुरुपयोग करें
...
तो, इस पुस्तकालय द्वारा उपयोग किए जाने वाले **`su`** बाइनरी के फ़ंक्शन की जांच करें:
```bash
...
```
चिह्न `audit_open`, `audit_log_acct_message`, `audit_log_acct_message` और `audit_fd` संभावतः libaudit.so.1 पुस्तकालय से हैं। libaudit.so.1 को दुर्भाग्यपूर्ण साझा पुस्तकालय द्वारा अधिलिखित किया जाएगा, इन चिह्नों को नए साझा पुस्तकालय में मौजूद होना चाहिए, अन्यथा कार्यक्रम चिह्न को नहीं ढूंढ पाएगा और बाहर निकल जाएगा।
```c
#include<stdio.h>
#include<stdlib.h>
#include<unistd.h>
...
```
अब, बस **`/bin/su`** को कॉल करके आप रूट के रूप में एक शैल प्राप्त करेंगे।
