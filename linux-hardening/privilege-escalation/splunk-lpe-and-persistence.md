...
**Les informations suivantes ont été** [**https://eapolsniper.github.io/2020/08/14/Abusing-Splunk-Forwarders-For-RCE-And-Persistence/**](https://eapolsniper.github.io/2020/08/14/Abusing-Splunk-Forwarders-For-RCE-And-Persistence/)
...
1- Demander le fichier /etc/passwd via PySplunkWhisper2

![1](https://eapolsniper.github.io/assets/2020AUG14/1\_RequestingPasswd.png)

2- Recevoir le fichier /etc/passwd sur le système de l'attaquant via Netcat

![2](https://eapolsniper.github.io/assets/2020AUG14/2\_ReceivingPasswd.png)

3- Demander le fichier /etc/shadow via PySplunkWhisper2

![3](https://eapolsniper.github.io/assets/2020AUG14/3\_RequestingShadow.png)

4- Recevoir le fichier /etc/shadow sur le système de l'attaquant via Netcat

![4](https://eapolsniper.github.io/assets/2020AUG14/4\_ReceivingShadow.png)

5- Ajouter l'utilisateur attacker007 au fichier /etc/passwd

![5](https://eapolsniper.github.io/assets/2020AUG14/5\_AddingUserToPasswd.png)

6- Ajouter l'utilisateur attacker007 au fichier /etc/shadow

![6](https://eapolsniper.github.io/assets/2020AUG14/6\_AddingUserToShadow.png)

7- Recevoir le nouveau fichier /etc/shadow montrant que attacker007 a été ajouté avec succès

![7](https://eapolsniper.github.io/assets/2020AUG14/7\_ReceivingShadowFileAfterAdd.png)

8- Confirmer l'accès SSH à la victime en utilisant le compte attacker007

![8](https://eapolsniper.github.io/assets/2020AUG14/8\_SSHAccessUsingAttacker007.png)

9- Ajouter un compte root de porte dérobée avec le nom d'utilisateur root007, avec l'uid/gid défini à 0

![9](https://eapolsniper.github.io/assets/2020AUG14/9\_AddingBackdoorRootAccount.png)

10- Confirmer l'accès SSH en utilisant attacker007, puis s'élever à root en utilisant root007
...
Scripter PySplunkWhisperer2 est très simple et efficace.
...
Agent Victime du Forwarder Splunk : 192.168.42.98\
...
2. Activer l'authentification mutuelle TLS entre les clients et le serveur, en utilisant des clés individuelles pour chaque client. Cela fournirait une sécurité bidirectionnelle très élevée entre tous les services Splunk. L'authentification mutuelle TLS est largement mise en œuvre dans les agents et les dispositifs IoT, c'est l'avenir de la communication de confiance client-serveur pour les dispositifs de confiance.
3. Envoyer tout le code, fichier d'une seule ligne ou script, dans un fichier compressé qui est chiffré et signé par le serveur Splunk. Cela ne protège pas les données de l'agent envoyées via l'API, mais protège contre l'exécution de code à distance malveillante par un tiers.
...
1. Assurez-vous qu'un mot de passe très fort est défini pour les agents Splunk. Je recommande un mot de passe aléatoire d'au moins 15 caractères, mais comme ces mots de passe ne sont jamais tapés, cela pourrait être défini sur un mot de passe très long, comme 50 caractères.
