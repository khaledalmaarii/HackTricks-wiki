# लिनक्स प्रतिबंधों को दरकिनार करना

<details>

<summary><strong>शून्य से लेकर नायक तक AWS हैकिंग सीखें</strong> <a href="https://training.hacktricks.xyz/courses/arte"><strong>htARTE (HackTricks AWS रेड टीम विशेषज्ञ)</strong></a><strong> के साथ!</strong></summary>
...
## सामान्य प्रतिबंधों को दरकिनार करने के तरीके
...
exec >&0
```
### पथों और निषिद्ध शब्दों को बायपास करना
```bash
...
```
### निषिद्ध स्थानों को बायपास करना
```bash
# {form}
...
```
### पाइप्स को बायपास करना
```bash
bash<<<$(base64 -d<<<Y2F0IC9ldGMvcGFzc3dkIHwgZ3JlcCAzMw==)
```
### हेक्स एन्कोडिंग के साथ बाईपास
```bash
...
यदि आप बाहरी फंक्शन्स को एक्जीक्यूट नहीं कर सकते हैं और केवल **सीमित सेट ऑफ बिल्टिन्स तक पहुंच है ताकि RCE प्राप्त कर सकें**, तो कुछ उपयोगी तरकीबें हैं जिन्हें आप कर सकते हैं। आमतौर पर आप **सभी बिल्टिन्स का उपयोग नहीं कर पाएंगे**, इसलिए आपको **अपने सभी विकल्पों को जानना चाहिए** ताकि जेल को बायपास करने की कोशिश कर सकें। विचार [**devploit**](https://twitter.com/devploit) से आया है।\
सबसे पहले सभी [**शेल बिल्टिन्स**](https://www.gnu.org/software/bash/manual/html\_node/Shell-Builtin-Commands.html) की जांच करें। फिर यहां आपके लिए कुछ **सिफारिशें** हैं:
```bash
...
यदि आप **read-only और noexec सुरक्षा** वाली फाइल सिस्टम में हैं या यहां तक कि एक distroless कंटेनर में हैं, तब भी आप **मनमाने बाइनरीज को निष्पादित कर सकते हैं, यहां तक कि एक शेल भी!:**

{% content-ref url="../bypass-bash-restrictions/bypass-fs-protections-read-only-no-exec-distroless/" %}
[bypass-fs-protections-read-only-no-exec-distroless](../bypass-bash-restrictions/bypass-fs-protections-read-only-no-exec-distroless/)
{% endcontent-ref %}

## Chroot & अन्य Jails Bypass
