...
* Root-Berechtigung für direkten Schreibzugriff erforderlich. Keine Root-Berechtigung erforderlich, wenn Sie `crontab <Datei>` ausführen können
...
```
Du kannst den Befehl zum Ausführen festlegen mit:
