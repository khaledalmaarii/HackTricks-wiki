...
```
{% hint style="warning" %}
In diesem Fall könnte der **Implementierungscode der legitimen** Methode, wenn er den **Methodennamen** **überprüft**, dieses Swizzling **erkennen** und dessen Ausführung **verhindern**.
