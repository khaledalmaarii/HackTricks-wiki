...
* [**The PEASS Family**](https://opensea.io/collection/the-peass-family) की खास संग्रहित [**NFTs**](https://opensea.io/collection/the-peass-family) का खुलासा करें
* [**PEASS और HackTricks की आधिकारिक स्वैग**](https://peass.creator-spring.com) प्राप्त करें
* **डिस्कॉर्ड** [**💬**](https://emojipedia.org/speech-balloon/) **समूह में शामिल हों** या [**टेलीग्राम समूह**](https://t.me/peass) में शामिल हों या **मुझे** **Twitter** **🐦**[**@carlospolopm**](https://twitter.com/hacktricks\_live) **का पालन करें**.
* **हैकिंग ट्रिक्स को** [**हैकट्रिक्स रेपो**](https://github.com/carlospolop/hacktricks) **और** [**हैकट्रिक्स-क्लाउड रेपो**](https://github.com/carlospolop/hacktricks-cloud) **में पीआर भेजकर अपने हैकिंग ट्रिक्स साझा करें।**
...
```
अंत तक सूचीबद्ध ड्राइवर **पता 0 में लोड** होते हैं। इसका मतलब है कि वे वास्तविक ड्राइवर नहीं हैं बल्कि **कर्नेल का हिस्सा हैं और उन्हें अनलोड नहीं किया जा सकता**।
...
```
कर्नेल एक्सटेंशन्स को लोड और अनलोड करने के लिए करें:
```bash
...
**IORegistry** मैकओएस और आईओएस के IOKit framework का एक महत्वपूर्ण हिस्सा है जो सिस्टम की हार्डवेयर कॉन्फ़िगरेशन और स्थिति को प्रतिनिधित्व करने के लिए एक डेटाबेस के रूप में काम करता है। यह एक **पुंजीय संग्रह है जो सिस्टम पर लोड की गई सभी हार्डवेयर और ड्राइवर्स** को प्रतिनिधित्व करने वाले ऑब्जेक्ट्स का एक संगठित संग्रह है, और उनके आपसी संबंधों को।

आप **`ioreg`** का उपयोग करके IORegistry को प्राप्त कर सकते हैं ताकि आप इसे कंसोल से जांच सकें (विशेष रूप से आईओएस के लिए उपयुक्त)।
```bash
ioreg -l #List all
...
वास्तव में, आप असली परिभाषा यहाँ पा सकते हैं [https://github.com/apple-oss-distributions/xnu/blob/1031c584a5e37aff177559b9f69dbd3c8c3fd30a/iokit/Kernel/IOUserClient.cpp#L6388](https://github.com/apple-oss-distributions/xnu/blob/1031c584a5e37aff177559b9f69dbd3c8c3fd30a/iokit/Kernel/IOUserClient.cpp#L6388):
```cpp
...
{% hint style="success" %}
अगर आप याद करते हैं, तो **उपयोगकर्ता स्थान से निर्यात किए गए** किसी **कार्य** को **बुलाने** के लिए हमें किसी कार्य का नाम नहीं बुलाने की आवश्यकता नहीं होती है, बल्कि **सेलेक्टर नंबर**। यहाँ आप देख सकते हैं कि सेलेक्टर **0** कार्य **`initializeDecoder`** है, सेलेक्टर **1** है **`startDecoder`**, सेलेक्टर **2** **`initializeEncoder`**...
{% endhint %}
