...
tccutil reset All
```
Pour **plus d'informations** sur ce contournement et les contournements associés, consultez la présentation [#OBTS v5.0 : "Le talon d'Achille de la sécurité des terminaux" - Fitzl Csaba](https://www.youtube.com/watch?v=lQO7tvNCoTI)

À la fin, cela a été corrigé en donnant la nouvelle autorisation **`kTCCServiceEndpointSecurityClient`** à l'application de sécurité gérée par **`tccd`** afin que `tccutil` ne supprime pas ses autorisations, l'empêchant de s'exécuter.

## Références

* [**OBTS v3.0 : "Sécurité et insécurité des terminaux" - Scott Knight**](https://www.youtube.com/watch?v=jaVkpM1UqOs)
