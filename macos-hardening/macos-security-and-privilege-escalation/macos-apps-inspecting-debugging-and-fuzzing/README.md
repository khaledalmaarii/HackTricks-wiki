...
यह टूल **codesign**, **otool**, और **objdump** के लिए एक **प्रतिस्थापन** के रूप में उपयोग किया जा सकता है, और कुछ अतिरिक्त सुविधाएं प्रदान करता है। [**यहाँ से डाउनलोड करें**](http://www.newosxbook.com/tools/jtool.html) या `brew` के साथ इंस्टॉल करें।
```bash
# Install
...
[**SuspiciousPackage**](https://mothersruin.com/software/SuspiciousPackage/get.html) एक उपकरण है जो **.pkg** फ़ाइलें (इंस्टॉलर) की जांच करने के लिए उपयोगी है और इंस्टॉल करने से पहले देखने की सुविधा प्रदान करता है।\
इन इंस्टॉलर में `preinstall` और `postinstall` बैश स्क्रिप्ट होते हैं जिन्हें मैलवेयर लेखक सामान्यत: दुरुपयोग करते हैं **the** **malware**.

### hdiutil

यह उपकरण एप्पल डिस्क इमेज (**.dmg**) फ़ाइलों को **माउंट** करने की अनुमति देता है ताकि इन्हें कुछ चलाने से पहले जांच सकें:
```bash
...
{% hint style="danger" %}
ध्यान दें कि Objective-C में लिखे गए कार्यक्रम [Mach-O binaries](../macos-files-folders-and-binaries/universal-binaries-and-mach-o-format.md) में कंपाइल किए जाने पर अपनी क्लास घोषणाएं बनाए रखते हैं। ऐसी क्लास घोषणाएं निम्नलिखित का नाम और प्रकार शामिल होते हैं:
{% endhint %}
...
* पहला पैरामीटर (**self**) "एक पॉइंटर है जो **संदेश प्राप्त करने वाली कक्षा के उदाहरण को पॉइंट करता है**"। या और सरल शब्दों में कहें, यह वस्तु है जिस पर विधि को आमंत्रित किया जा रहा है। यदि विधि एक कक्षा विधि है, तो यह कक्षा वस्तु का उदाहरण होगा (सम्ग्र), जबकि एक उदाहरण विधि के लिए, self कक्षा के एक उदाहरण को वस्तु के रूप में पॉइंट करेगा।
* दूसरा पैरामीटर, (**op**), "संदेश का संभालने वाली विधि का सेलेक्टर" है। फिर भी, और सरल शब्दों में कहें, यह बस **विधि का नाम** है।
* शेष पैरामीटर वह कोई **मान हैं जो विधि के द्वारा आवश्यक हैं** (op)।

| **विवाद**         | **रजिस्टर**                                                    | **(के लिए) objc\_msgSend**                                |
| ----------------- | --------------------------------------------------------------- | ------------------------------------------------------ |
| **1वां विवाद**  | **rdi**                                                         | **self: वस्तु जिस पर विधि को आमंत्रित किया जा रहा है** |
| **2वां विवाद**  | **rsi**                                                         | **op: विधि का नाम**                             |
| **3वां विवाद**  | **rdx**                                                         | **विधि के लिए 1वां विवाद**                         |
| **4वां विवाद**  | **rcx**                                                         | **विधि के लिए 2वां विवाद**                         |
| **5वां विवाद**  | **r8**                                                          | **विधि के लिए 3वां विवाद**                         |
| **6वां विवाद**  | **r9**                                                          | **विधि के लिए 4वां विवाद**                         |
| **7वां+ विवाद** | <p><strong>rsp+</strong><br><strong>(स्टैक पर)</strong></p> | **विधि के लिए 5वां+ विवाद**                        |
...
[...]
```
आप इस विभाग में संग्रहित जानकारी के बारे में अधिक जानकारी [**इस ब्लॉग पोस्ट में**](https://knight.sc/reverse%20engineering/2019/07/17/swift-metadata.html) पा सकते हैं।

इसके अतिरिक्त, **स्विफ्ट बाइनरी में प्रतीक हो सकते हैं** (उदाहरण के लिए पुस्तकालयों को प्रतीक संग्रहित करने की आवश्यकता होती है ताकि उनके कार्य को बुलाया जा सके)। **प्रतीकों में सामान्यत: फ़ंक्शन के नाम और विशेषता की जानकारी होती है** और यह एक बेहद अविगत तरीके में होती है, इसलिए वे बहुत उपयोगी होते हैं और वहाँ "**डीमैंगलर्स"** होते हैं जो मूल नाम प्राप्त कर सकते हैं:
```bash
# Ghidra plugin
...
{% hint style="warning" %}
ध्यान दें कि **सिस्टम बाइनरी** (जैसे `cloudconfigurationd`) को **इंस्ट्रुमेंट** करने के लिए macOS पर, **SIP को अक्षम किया जाना चाहिए** (सिग्नेचर को बस हटाना काम नहीं करेगा)।
{% endhint %}
...
इसके अतिरिक्त, कुछ लॉग होंगे जिनमें `<private>` टैग होगा ताकि कुछ **उपयोगकर्ता** या **कंप्यूटर संदर्भीय** **पहचाननीय** जानकारी **छुपी** रहे। हालांकि, इस जानकारी को खोलने के लिए **एक प्रमाणपत्र स्थापित करना संभव है**। [**यहां**](https://superuser.com/questions/1532031/how-to-show-private-data-in-macos-unified-log) से विवरणों का पालन करें।

### हॉपर

#### बाएं पैनल

हॉपर के बाएं पैनल में आप बाइनरी के प्रतीक (**लेबल**), प्रक्रियाएँ और कार्य (**प्रोसेड्यूर्स**) की सूची और स्ट्रिंग्स (**स्ट्रिंग्स**) देख सकते हैं। ये सभी स्ट्रिंग्स नहीं हैं लेकिन वे मैक-ओ फ़ाइल के कई हिस्सों में परिभाषित हैं (जैसे _cstring या_ `objc_methname` की तरह)।
...
DTrace को प्रोब्स को सक्रिय करने और जब वे फायर होते हैं तो क्या क्रियाएँ करनी हैं, इसे कॉन्फ़िगर करने के लिए हमें डी भाषा का उपयोग करना होगा।
...
आपको अपने मैक को एक ऐसे आदेश के साथ मॉनिटर करने की आवश्यकता है जैसे **`sudo eslogger fork exec rename create > cap.json`** (इसे लॉन्च करने के लिए टर्मिनल में FDA की आवश्यकता है)। और फिर आप इस उपकरण में json लोड कर सकते हैं ताकि आप सभी संबंध देख सकें:
...
[**Crescendo**](https://github.com/SuprHackerSteve/Crescendo) एक GUI उपकरण है जिसका लुक और फ़ील Windows उपयोगकर्ता जान सकते हैं Microsoft Sysinternal’s _Procmon_ से। यह उपकरण विभिन्न घटना प्रकारों को शुरू और बंद करने की अनुमति देता है, इन घटनाओं को फ़ाइल, प्रक्रिया, नेटवर्क आदि जैसे श्रेणियों द्वारा फ़िल्टर करने की अनुमति देता है, और जिसमें इन घटनाओं को json प्रारूप में सहेजने की क्षमता प्रदान करता है।
...
[**Taskexplorer**](https://objective-see.com/products/taskexplorer.html) किसी बाइनरी द्वारा उपयोग की जा रही **लाइब्रेरी**, उसके द्वारा उपयोग की जा रही **फ़ाइलें** और **नेटवर्क** कनेक्शन देखने के लिए उपयोगी है।\
यह बाइनरी प्रक्रियाओं की **वायरसटोटल** के खिलाफ जाँच करता है और बाइनरी के बारे में जानकारी दिखाता है।

## PT\_DENY\_ATTACH <a href="#page-title" id="page-title"></a>

[**इस ब्लॉग पोस्ट**](https://knight.sc/debugging/2019/06/03/debugging-apple-binaries-that-use-pt-deny-attach.html) में आप एक उदाहरण पा सकते हैं कि कैसे **`PT_DENY_ATTACH`** का उपयोग करके डीमन को डीबग करें जो SIP अक्षम करने के बावजूद भी डीबगिंग को रोकता है।
...
* **`hw.logicalcpu`** और **`hw.physicalcpu`** के मानों के साथ खेलने से कुछ मैलवेयर्स यह जांचने की कोशिश करते हैं कि यह एक वीएम है या नहीं।
...
ReportCrash **क्रैश होने वाली प्रक्रियाओं का विश्लेषण करता है और डिस्क पर एक क्रैश रिपोर्ट सहेजता है**। एक क्रैश रिपोर्ट में जानकारी होती है जो एक क्रैश के कारण का निदान करने में मदद कर सकती है।\
एप्लिकेशन और अन्य प्रक्रियाएं **प्रति-उपयोगकर्ता लॉन्चडी संदर्भ में चल रही** हों, ReportCrash एक लॉन्चएजेंट के रूप में चलता है और क्रैश रिपोर्ट को उपयोगकर्ता के `~/Library/Logs/DiagnosticReports/` में सहेजता है।\
डेमन्स, अन्य प्रक्रियाएं **सिस्टम लॉन्चडी संदर्भ में चल रही** हों और अन्य विशेषाधिकारी प्रक्रियाएं, ReportCrash एक लॉन्चडेमन के रूप में चलता है और क्रैश रिपोर्ट को सिस्टम के `/Library/Logs/DiagnosticReports` में सहेजता है।

यदि आप क्रैश रिपोर्टों के **एप्पल को भेजने** की चिंता कर रहे हैं तो आप उन्हें अक्षम कर सकते हैं। अगर नहीं, क्रैश र
```bash
...
**निम्नलिखित पृष्ठ की जाँच करें** ताकि आप पता लगा सकें कि **निर्दिष्ट स्कीम या प्रोटोकॉल का हैंडलिंग करने वाला ऐप कौन है:**
...
यह दिलचस्प है कि नेटवर्क डेटा का प्रबंधन कर रही प्रक्रियाएं पता लगाना:
```bash
