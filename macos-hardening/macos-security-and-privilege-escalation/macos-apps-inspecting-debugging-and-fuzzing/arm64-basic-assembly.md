...
* Le drapeau de **largeur de registre actuel (`nRW`)** : Si le drapeau a la valeur 0, le programme fonctionnera dans l'état d'exécution AArch64 une fois repris.
...
* **`r12`** : Registre d'appel intraprocedurel
