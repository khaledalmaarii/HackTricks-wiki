...
2. **`rbx`** - अक्सर मेमोरी ऑपरेशनों के लिए **बेस रजिस्टर** के रूप में उपयोग किया जाता है।
3. **`rcx`** - सामान्यतः **लूप काउंटर** के लिए उपयोग किया जाता है।
4. **`rdx`** - विभिन्न भूमिकाओं में उपयोग किया जाता है जिसमें विस्तारित अंकगणितीय संचालन शामिल हैं।
