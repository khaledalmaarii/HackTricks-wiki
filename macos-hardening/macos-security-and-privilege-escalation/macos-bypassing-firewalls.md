...
* Por exemplo, chamando o malware com nomes de processos macOS conhecidos como **`launchd`**&#x20;
...
### Domínios Apple conhecidos

O firewall pode estar permitindo conexões com domínios Apple conhecidos, como **`apple.com`** ou **`icloud.com`**. E o iCloud pode ser usado como um C2.
...
Saber o tráfego permitido ajudará a identificar domínios potencialmente em lista branca ou quais aplicativos têm permissão para acessá-los
```bash
