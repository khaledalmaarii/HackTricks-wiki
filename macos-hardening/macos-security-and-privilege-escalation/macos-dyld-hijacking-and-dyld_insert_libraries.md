...
Mit den vorherigen Informationen wissen wir, dass **die Signatur der geladenen Bibliotheken nicht überprüft wird** und dass **versucht wird, eine Bibliothek von**:

* `/Applications/VulnDyld.app/Contents/Resources/lib/lib.dylib`
* `/Applications/VulnDyld.app/Contents/Resources/lib2/lib.dylib`

geladen werden. Die erste existiert jedoch nicht:
```bash
pwd
...
```
So, es ist möglich, es zu hijacken! Erstellen Sie eine Bibliothek, die **beliebigen Code ausführt und die gleichen Funktionen wie die legitime Bibliothek durch Reexportierung bereitstellt**. Und denken Sie daran, sie mit den erwarteten Versionen zu kompilieren:
