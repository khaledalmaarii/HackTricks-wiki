# Applications de fichiers d'extension macOS
...
### Applications d'extensions de fichiers

La ligne suivante peut être utile pour trouver les applications qui peuvent ouvrir des fichiers en fonction de leur extension :
```
