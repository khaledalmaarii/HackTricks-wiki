# Gestionnaires d'applications de schéma d'URL et d'extension de fichier macOS
...
Les lignes suivantes peuvent être utiles pour trouver les applications qui peuvent ouvrir des fichiers en fonction de leur extension :
```
