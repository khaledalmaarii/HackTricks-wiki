# macOS फ़ाइल एक्सटेंशन और URL स्कीम एप्लिकेशन हैंडलर्स
...
निम्नलिखित पंक्ति एप्लिकेशन्स को खोलने में मददगार हो सकती है जो एक्सटेंशन के आधार पर फ़ाइलें खोल सकते हैं:
```bash
