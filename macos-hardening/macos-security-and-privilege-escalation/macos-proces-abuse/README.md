...
Kuingiza Maktaba ni mbinu ambapo mshambuliaji **anailazimisha mchakato kusoma maktaba ya uovu**. Mara ilipoingizwa, maktaba hiyo inaendesha katika muktadha wa mchakato lengwa, ikimpa mshambuliaji idhini na ufikiaji sawa na mchakato.
...
Mawasiliano kati ya Mchakato (IPC) inahusu njia tofauti ambazo mchakato tofauti **hushiriki na kubadilishana data**. Ingawa IPC ni muhimu kwa programu nyingi halali, inaweza pia kutumiwa vibaya kuvunja upimaji wa mchakato, kuvuja taarifa nyeti, au kufanya vitendo visivyoruhusiwa.
...
Inawezekana kutumia bendera `--load-extension` na `--use-fake-ui-for-media-stream` kufanya **mashambulizi ya mtu katika kivinjari** kuruhusu kuiba kubonyeza, trafiki, vidakuzi, kuingiza skripti kwenye kurasa...:
...
Faili za NIB **hufafanua vipengele vya interface ya mtumiaji (UI)** na mwingiliano wao ndani ya programu. Walakini, wanaweza **kutekeleza amri za kupindukia** na **Gatekeeper haiwezi kuzuia** programu iliyotekelezwa tayari isitekelezwe ikiwa faili ya **NIB imebadilishwa**. Kwa hivyo, zinaweza kutumika kufanya programu za kupindukia zitekeleze amri za kupindukia:
...
Inawezekana kuingiza nambari kwenye programu za .Net kwa **kutumia vibaya kazi ya kufuatilia ya .Net** (isiohifadhiwa na ulinzi wa macOS kama uimarishaji wa wakati wa utekelezaji).
...
Angalia chaguo tofauti za kufanya skripti ya Perl itekeleze nambari ya kupindukia katika:
...
Katika [**chapisho hili la blogi**](https://knight.sc/reverse%20engineering/2019/04/15/detecting-task-modifications.html) unaweza kupata jinsi inavyowezekana kutumia kazi ya **`task_name_for_pid`** kupata habari kuhusu **michakato inayoingiza nambari katika mchakato** na kisha kupata habari kuhusu mchakato mwingine.

Tafadhali kumbuka kwamba ili kuita kazi hiyo unahitaji kuwa **uid sawa** na yule anayekimbia mchakato au **root** (na inarudi habari kuhusu mchakato, sio njia ya kuingiza nambari).
