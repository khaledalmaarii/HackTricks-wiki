...
- Adicione um Objeto à interface, configurando sua classe para `NSAppleScript`.
...
- Modifique o AppleScript para acessar e extrair dados do usuário, como fotos, sem consentimento do usuário.
