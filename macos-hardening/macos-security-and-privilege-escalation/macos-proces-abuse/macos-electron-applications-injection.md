...
print(ws.recv()
```
No [**este post de blog**](https://hackerone.com/reports/1274695), esse debugging é abusado para fazer um headless chrome **baixar arquivos arbitrários em locais arbitrários**.
