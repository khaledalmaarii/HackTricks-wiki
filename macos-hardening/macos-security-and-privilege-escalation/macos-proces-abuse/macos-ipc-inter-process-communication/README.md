...
इस फ़ाइल में एप्लिकेशन के लिए निर्धारित अधिकारों की सूची होती है।
...
\`\`\`bash gcc -framework Foundation -framework Appkit dylib\_injector.m -o dylib\_injector ./inject \`\`\` ### धागा हाइजैकिंग के माध्यम से टास्क पोर्ट के माध्यम से
