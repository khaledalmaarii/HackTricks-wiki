...
निम्नलिखित में एक सरल **सर्वर** और **क्लाइंट** बनाने के लिए कोड है जहां क्लाइंट सर्वर से Subtract फंक्शन को कॉल कर सकता है:
...
var_10 = arg0;
var_18 = arg1;
// प्रारंभिक निर्देश सही फ़ंक्शन पॉइंटर्स को खोजने के लिए
...
// यदि - अन्यथा, यदि गलत लौटाता है, जबकि अन्यथा सही फ़ंक्शन को कॉल करता है और सच लौटाता है
<strong>            if (rax == 0x0) {
...
यह वही फ़ंक्शन है जिसे Hopper के मुफ्त संस्करण में अलग तरीके से डिकंपाइल किया गया है:
