...
एक उदाहरण [EvenBetterAuthorizationSample](https://github.com/brenwell/EvenBetterAuthorizationSample) में पाया जा सकता है। `App/AppDelegate.m` में यह **HelperTool** से **कनेक्ट** करने की कोशिश करता है। और `HelperTool/HelperTool.m` में फंक्शन **`shouldAcceptNewConnection`** पहले बताई गई किसी भी आवश्यकता की **जाँच नहीं करेगा**। यह हमेशा YES लौटाएगा:
```objectivec
...
* अगर इसे `true` पर सेट किया जाता है, तो सत्र का मालिक (वर्तमान में लॉग-इन किया गया उपयोगकर्ता) स्वचालित रूप से इस अधिकार को प्राप्त कर लेगा। यह अतिरिक्त प्रमाणीकरण को दरकिनार कर सकता है अगर उपयोगकर्ता पहले से ही लॉग-इन है।
4. **'shared': 'true'**
