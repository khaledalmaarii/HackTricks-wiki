...
<table><thead><tr><th width="284.3333333333333">नाम</th><th width="165">मान</th><th>विवरण</th></tr></thead><tbody><tr><td>kAuthorizationRuleClassAllow</td><td>allow</td><td>कोई भी</td></tr><tr><td>kAuthorizationRuleClassDeny</td><td>deny</td><td>कोई नहीं</td></tr><tr><td>kAuthorizationRuleIsAdmin</td><td>is-admin</td><td>वर्तमान उपयोगकर्ता को एडमिन होना चाहिए (एडमिन समूह के अंदर)</td></tr><tr><td>kAuthorizationRuleAuthenticateAsSessionUser</td><td>authenticate-session-owner</td><td>उपयोगकर्ता से प्रमाणित करें।</td></tr><tr><td>kAuthorizationRuleAuthenticateAsAdmin</td><td>authenticate-admin</td><td>उपयोगकर्ता से प्रमाणित करें। उसे एडमिन होना चाहिए (एडमिन समूह के अंदर)</td></tr><tr><td>kAuthorizationRightRule</td><td>rule</td><td>नियम निर्दिष्ट करें</td></tr><tr><td>kAuthorizationComment</td><td>comment</td><td>अधिक टिप्पणियाँ निर्दिष्ट करें</td></tr></tbody></table>
...
```
फिर, आप यह पढ़ सकते हैं कि कौन अधिकार का उपयोग कर सकता है:
```bash
...
इसके बाद, यदि यह फ़ंक्शन `AuthorizationCreateFromExternalForm`, `authorizationRightForCommand`, `AuthorizationCopyRights`, `AuhtorizationFree` जैसे फ़ंक्शन को बुलाता है, तो यह [**EvenBetterAuthorizationSample**](https://github.com/brenwell/EvenBetterAuthorizationSample/blob/e1052a1855d3a5e56db71df5f04e790bfd4389c4/HelperTool/HelperTool.m#L101-L154) का उपयोग कर रहा है।
...
इस मामले में, हमारे पास EvenBetterAuthorizationSample में जैसा ही है, [**इस लाइन की जाँच करें**](https://github.com/brenwell/EvenBetterAuthorizationSample/blob/e1052a1855d3a5e56db71df5f04e790bfd4389c4/HelperTool/HelperTool.m#L94)।
...
[...]
```
आखिरकार, हमें केवल **उजागर मैक सेवा का नाम** पता होना चाहिए ताकि हम इसके साथ संचार स्थापित कर सकें। इसे खोजने के कई तरीके हैं:

* **`[HelperTool init()]`** में जहां आप देख सकते हैं कि कौन सी Mach सेवा का उपयोग किया जा रहा है:
...
* किसी कार्य को कॉल करना अगर कनेक्शन सफल रहा हो
```objectivec
