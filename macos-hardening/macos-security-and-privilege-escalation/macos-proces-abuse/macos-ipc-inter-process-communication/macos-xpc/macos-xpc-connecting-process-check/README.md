...
**NSXPCConnection** jenay' vItlhutlh **private** property **`auditToken`** (ghaH **ghaH** 'e' vItlhutlh) 'ej **public** property **`processIdentifier`** (ghaH **ghaH** 'e' vItlhutlh).

connecting process vItlhutlhbe'chugh:
