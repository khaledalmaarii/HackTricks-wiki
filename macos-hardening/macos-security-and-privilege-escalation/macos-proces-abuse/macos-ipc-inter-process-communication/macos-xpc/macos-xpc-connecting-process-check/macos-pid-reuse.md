...
{% tab title="fork" %}
Ten przykład używa surowego **`fork`**, aby uruchomić **dzieci, które wykorzystają warunek wyścigu PID** i następnie wykorzystają **inny warunek wyścigu za pomocą twardego linku:**
```objectivec
