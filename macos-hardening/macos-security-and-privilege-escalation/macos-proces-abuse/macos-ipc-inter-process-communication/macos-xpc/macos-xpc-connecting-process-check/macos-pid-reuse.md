...
{% tabs %}
{% tab title="NSTasks" %}
**`NSTasks`**-laH je 'oH vaj **argument**-lI'pu' 'ej RC exploit vItlhutlh.
```objectivec
...
```
{% tab title="fork" %}
**`fork`** **ghItlh** **exploit PID race condition** **children** **launch** **raw** **example** **uses** **another race condition** **exploit** **Hard link** **via** **a** **`fork`** **to** **launch** **children that will exploit the PID race condition** **and then exploit** **another race condition via a Hard link:**
```objectivec
