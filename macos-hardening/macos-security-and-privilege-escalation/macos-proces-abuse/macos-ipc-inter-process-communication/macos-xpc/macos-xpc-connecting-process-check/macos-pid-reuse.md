...
यदि आप फ़ंक्शन **`shouldAcceptNewConnection`** या इसे कॉल करने वाले फ़ंक्शन को पाते हैं जो **`processIdentifier`** को कॉल करता है और **`auditToken`** को कॉल नहीं करता है। यह अत्यधिक संभावित है कि यह **प्रक्रिया PID** की जांच कर रहा है और ऑडिट टोकन की नहीं।\
...
{% tab title="fork" %}
यह उदाहरण एक कच्चे **`fork`** का उपयोग करता है **बच्चों को लॉन्च करने के लिए जो PID दौड़ की स्थिति का लाभ उठाएंगे** और फिर **एक हार्ड लिंक के माध्यम से एक और दौड़ की स्थिति का लाभ उठाएंगे:**
```objectivec
