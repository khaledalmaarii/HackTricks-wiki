...
**Για περισσότερες πληροφορίες, ελέγξτε την αρχική ανάρτηση:** [**https://sector7.computest.nl/post/2023-10-xpc-audit-token-spoofing/**](https://sector7.computest.nl/post/2023-10-xpc-audit-token-spoofing/). Αυτό είναι μια περίληψη:
...
![Εικόνα που απεικονίζει τη διαδικασία εκμετάλλευσης](https://sector7.computest.nl/post/2023-10-xpc-audit-token-spoofing/exploit.png)
