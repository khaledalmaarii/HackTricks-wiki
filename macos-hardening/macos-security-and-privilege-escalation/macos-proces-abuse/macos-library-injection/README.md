...
{% hint style="info" %}
2012 से **Apple ने DYLD\_INSERT\_LIBRARIES** की **शक्ति को बहुत कम कर दिया है**।
...
ध्यान दें कि यदि किसी भी बाइनरी के साइन फ्लैग \*\*\`0x0(none)\`\*\* के साथ हों, तो जब उन्हें निष्पादित किया जाता है तो वे डायनामिक रूप से \*\*\`CS\_RESTRICT\`\*\* फ्लैग प्राप्त कर सकते हैं और इसलिए यह तकनीक उनमें काम नहीं करेगी।
