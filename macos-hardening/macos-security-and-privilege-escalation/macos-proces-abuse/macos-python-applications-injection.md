...
Είναι δυνατόν να τροποποιηθούν και οι δύο μεταβλητές περιβάλλοντος για να εκτελεστεί αυθαίρετος κώδικας κάθε φορά που καλείται το python, για παράδειγμα:
