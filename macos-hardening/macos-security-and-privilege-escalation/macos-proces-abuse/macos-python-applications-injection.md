...
## `PYTHONWARNINGS` ve `BROWSER` çevresel değişkenleri aracılığıyla

Her iki çevresel değişkeni de değiştirerek, örneğin python çağrıldığında keyfi kodu yürütmek mümkündür:
