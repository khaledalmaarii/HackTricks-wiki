# macOS Python-Anwendungen Injektion
...
Es ist möglich, sowohl die Umgebungsvariablen zu ändern, um beliebigen Code auszuführen, wenn Python aufgerufen wird, zum Beispiel:
