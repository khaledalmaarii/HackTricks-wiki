# macOS Autorisations dangereuses et autorisations TCC
...
Ces autorisations permettent d'**installer des logiciels sans demander la permission** de l'utilisateur, ce qui peut être utile pour une **élévation de privilèges**.
...
Fournit des autorisations d'**Accès complet au disque**, l'une des autorisations les plus élevées de TCC que vous pouvez avoir.
...
Cette autorisation permet de **modifier des sections de ses propres fichiers exécutables** sur le disque pour sortir de force. Consultez [**ceci pour plus d'informations**](https://developer.apple.com/documentation/bundleresources/entitlements/com\_apple\_security\_cs\_disable-executable-page-protection).
