...
Tatsächlich kann ein Prozess "Quarantäne-Flags für die von ihm erstellten Dateien setzen" (ich habe versucht, das Flag USER\_APPROVED auf eine erstellte Datei anzuwenden, aber es wird nicht angewendet):
