...
Aslında bir işlem, oluşturduğu dosyalara karantina bayrakları ayarlayabilir (USER\_APPROVED bayrağını oluşturulan bir dosyaya uygulamayı denedim ancak uygulanmadı):
