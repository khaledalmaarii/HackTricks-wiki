# macOS गेटकीपर / क्वारंटाइन / XProtect
...
XProtect एक बिल्ट-इन **एंटी-मैलवेयर** सुविधा है macOS में। XProtect **जाने माने मैलवेयर और असुरक्षित फ़ाइल प्रकारों के डेटाबेस के खिलाफ किसी भी एप्लिकेशन की जांच करता है जब यह पहली बार लॉन्च किया जाता है या संशोधित किया जाता है**। जब आप किसी फ़ाइल को कुछ ऐप्स के माध्यम से डाउनलोड करते हैं, जैसे Safari, Mail, या Messages, XProtect स्वचालित रूप से फ़ाइल की जांच करता है। अगर यह अपने डेटाबेस में किसी भी जाने माने मैलवेयर से मेल खाता है, तो XProtect फ़ाइल को चलाने से **रोक देगा** और आपको खतरे के बारे में सूचित करेगा।

XProtect डेटाबेस को Apple नियमित रूप से **नए मैलवेयर परिभाषाओं** के साथ अपडेट किया जाता है, और ये अपडेट आपके Mac पर स्वचालित रूप से डाउनलोड और स्थापित किए जाते हैं। इससे यह सुनिश्चित होता है कि XProtect हमेशा नवीनतम जाने माने खतरों के साथ अप-टू-डेट है।
