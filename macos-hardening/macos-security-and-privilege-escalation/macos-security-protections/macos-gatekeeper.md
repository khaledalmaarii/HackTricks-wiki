...
W rzeczywistości proces "może ustawić flagi kwarantanny dla plików, które tworzy" (próbowałem zastosować flagę USER\_APPROVED w utworzonym pliku, ale nie została ona zastosowana):
