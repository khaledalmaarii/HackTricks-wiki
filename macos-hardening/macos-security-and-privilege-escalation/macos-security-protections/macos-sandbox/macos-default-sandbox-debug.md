...
इस पेज में आपको यह देखने को मिलेगा कि कैसे डिफ़ॉल्ट macOS सैंडबॉक्स के अंदर से विभिन्न कमांड चलाने के लिए एक ऐप बनाएं:

1. ऐप्लिकेशन को कंपाइल करें:
...
इसे कंपाइल करने के लिए निम्नलिखित को चलाएं: `clang -framework Foundation -o SandboxedShellApp main.m`
...
4. ऐप को साइन करें (आपको कीचेन में प्रमाणपत्र बनाना होगा)
```bash
