...
Zauważ, że **nawet shellcode** w ARM64 musi być powiązany z `libSystem.dylib`:
```bash
...
```
{% hint style="warning" %}
**Nawet po ominięciu Sandbox TCC** zapyta użytkownika, czy chce zezwolić procesowi na odczyt plików z pulpitu
{% endhint %}
