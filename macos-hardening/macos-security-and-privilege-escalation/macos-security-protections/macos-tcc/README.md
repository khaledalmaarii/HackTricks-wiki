...
उदाहरण के लिए, **Telegram** के पास `com.apple.security.device.camera` अधिकार है जिसका उपयोग **कैमरे तक पहुंच के लिए** करने के लिए किया जाता है। इसके पास यह अधिकार नहीं होने वाले ऐप्स कैमरे तक पहुंच नहीं पा सकेंगे (और उपयोगकर्ता से अनुमतियों के लिए पूछा नहीं जाएगा)।
...
एप्पल के ऐप्स प्रश्नित नहीं करेंगे। उनमें उनकी अधिकार सूची में पूर्व-दिए गए अधिकार होते हैं, जिसका मतलब है कि वे कभी भी पॉपअप नहीं उत्पन्न करेंगे, और वे किसी भी TCC डेटाबेस में दिखाई नहीं देंगे। उदाहरण के लिए:
```bash
...
**उपयोगकर्ता TCC** डेटाबेस पर **लेखन अनुमति** प्राप्त करके आप खुद को **`FDA`** अनुमतियाँ नहीं दे सकते हैं, केवल जो सिस्टम डेटाबेस में रहता है वह दे सकता है।
