...
**TCC (पारदर्शिता, सहमति, और नियंत्रण)** macOS में एक तंत्र है जो **कुछ विशेषताओं तक एप्लिकेशन की पहुँच को सीमित और नियंत्रित करता है**, आमतौर पर गोपनीयता के दृष्टिकोण से। इसमें स्थान सेवाएं, संपर्क, फोटो, माइक्रोफोन, कैमरा, पहुँच, पूर्ण डिस्क पहुँच, और बहुत कुछ शामिल हो सकता है।

उपयोगकर्ता के दृष्टिकोण से, वे TCC को तब कार्य में देखते हैं **जब कोई एप्लिकेशन TCC द्वारा संरक्षित किसी विशेषता तक पहुँच चाहता है**। जब ऐसा होता है तो **उपयोगकर्ता को एक संवाद बॉक्स प्रदर्शित होता है** जो उनसे पूछता है कि क्या वे पहुँच की अनुमति देना चाहते हैं या नहीं।

यह भी संभव है कि **एप्लिकेशन को फाइलों तक पहुँच प्रदान की जाए** उपयोगकर्ताओं द्वारा **स्पष्ट इरादों** से उदाहरण के लिए जब एक उपयोगकर्ता **एक प्रोग्राम में फाइल खींचकर छोड़ता है** (स्पष्ट रूप से प्रोग्राम को इसकी पहुँच होनी चाहिए)।

![TCC प्रॉम्प्ट का एक उदाहरण](https://rainforest.engineering/images/posts/macos-tcc/tcc-prompt.png?1620047855)

**TCC** `/System/Library/PrivateFrameworks/TCC.framework/Support/tccd` में स्थित **daemon** द्वारा संभाला जाता है और `/System/Library/LaunchDaemons/com.apple.tccd.system.plist` में कॉन्फ़िगर किया गया है (mach सेवा `com.apple.tccd.system` को रजिस्टर करते हुए)।

एक **user-mode tccd** होता है जो प्रत्येक लॉग इन किए गए उपयोगकर्ता के लिए `/System/Library/LaunchAgents/com.apple.tccd.plist` में परिभाषित होता है, जो mach सेवाओं `com.apple.tccd` और `com.apple.usernotifications.delegate.com.apple.tccd` को रजिस्टर करता है।

यहाँ आप सिस्टम और उपयोगकर्ता के रूप में चल रहे tccd को देख सकते हैं:
```bash
ps -ef | grep tcc
0   374     1   0 Thu07PM ??         2:01.66 /System/Library/PrivateFrameworks/TCC.framework/Support/tccd system
501 63079     1   0  6:59PM ??         0:01.95 /System/Library/PrivateFrameworks/TCC.framework/Support/tccd
```
अनुमतियाँ **मूल एप्लिकेशन से विरासत में मिलती हैं** और **अनुमतियाँ** **ट्रैक की जाती हैं** **बंडल आईडी** और **डेवलपर आईडी** के आधार पर।
...
{% hint style="warning" %}
पिछले डेटाबेस भी **पढ़ने के लिए TCC संरक्षित हैं**। इसलिए आप अपने नियमित उपयोगकर्ता TCC डेटाबेस को नहीं पढ़ पाएंगे जब तक कि यह एक TCC विशेषाधिकार वाली प्रक्रिया से न हो।
...
* SIP संरक्षित फ़ाइल **`/Users/carlospolop/Downloads/REG.db`** (TCC के साथ पढ़ने के लिए भी संरक्षित), सभी **वैध TCC डेटाबेसों** के **स्थान** को संग्रहीत करती है।
...
TCC **डेटाबेस** एप्लिकेशन के **Bundle ID** को संग्रहीत करता है, परंतु यह **जानकारी** भी **संग्रहीत** करता है कि **हस्ताक्षर** के बारे में यह **सुनिश्चित** करने के लिए कि अनुमति का उपयोग करने के लिए पूछने वाला ऐप सही है।
...
{% hint style="warning" %}
इसलिए, एक ही नाम और बंडल ID वाले अन्य एप्लिकेशन्स दूसरे एप्स को दिए गए अनुमतियों का उपयोग नहीं कर पाएंगे।
{% endhint %}

### Entitlements & TCC अनुमतियाँ

एप्लिकेशन्स को **केवल अनुरोध करने और अनुमति प्राप्त करने की जरूरत नहीं होती**, उन्हें संबंधित **entitlements** भी होनी चाहिए।\
उदाहरण के लिए **Telegram** के पास `com.apple.security.device.camera` entitlement है जिससे वह **कैमरा तक पहुँच का अनुरोध कर सकता है**। एक **एप्लिकेशन** जिसके पास यह **entitlement नहीं है** वह कैमरा तक पहुँच **नहीं सकेगा** (और उपयोगकर्ता से अनुमतियों के लिए पूछा भी नहीं जाएगा)।
...
Apple के एप्लिकेशन्स **संकेत उत्पन्न नहीं करेंगे**। उनमें **पहले से अनुमत अधिकार** होते हैं उनकी **entitlements** सूची में, जिसका मतलब है कि वे **कभी भी पॉपअप उत्पन्न नहीं करेंगे**, **न ही** वे किसी भी **TCC डेटाबेस में दिखाई देंगे।** उदाहरण के लिए:
```bash
...
{% hint style="success" %}
कुछ आधिकारिक दस्तावेज़ों के अलावा, entitlements के बारे में अनौपचारिक **रोचक जानकारी** भी [**https://newosxbook.com/ent.jl**](https://newosxbook.com/ent.jl) पर मिल सकती है।
{% endhint %}
...
पहले उल्लेखित के अनुसार, यह संभव है कि **एक फाइल को उस पर ड्रैग एंड ड्रॉप करके एक ऐप को उस तक पहुँच प्रदान की जा सकती है**। यह पहुँच TCC डेटाबेस में निर्दिष्ट नहीं होगी लेकिन एक **विस्तारित** **फाइल के गुण के रूप में**। यह गुण **अनुमति प्राप्त ऐप का UUID स्टोर करेगा**।
```bash
...
TCC का Automation अनुमति का नाम है: **`kTCCServiceAppleEvents`**\
यह विशेष TCC अनुमति यह भी दर्शाती है कि **कौन सा एप्लिकेशन प्रबंधित किया जा सकता है** TCC डेटाबेस के अंदर (इसलिए अनुमतियां सिर्फ सब कुछ प्रबंधित करने की अनुमति नहीं देती हैं).

**Finder** एक ऐसा एप्लिकेशन है जिसके पास **हमेशा FDA होता है** (भले ही यह UI में न दिखाई दे), इसलिए अगर आपके पास इस पर **Automation** विशेषाधिकार हैं, तो आप इसके विशेषाधिकारों का दुरुपयोग करके **कुछ क्रियाएं करवा सकते हैं**.\
...
उपयोगकर्ता TCC डेटाबेस पर **लिखने की अनुमति** प्राप्त करके आप **`FDA`** अनुमतियां खुद को नहीं दे सकते, केवल वही जो सिस्टम डेटाबेस में रहता है वह यह अनुमति दे सकता है।
...
मुझे नहीं लगता कि यह एक वास्तविक privesc है, लेकिन यदि आपको यह उपयोगी लगे: यदि आप FDA के साथ एक प्रोग्राम को नियंत्रित करते हैं तो आप **उपयोगकर्ता के TCC डेटाबेस को संशोधित कर सकते हैं और खुद को कोई भी पहुंच दे सकते हैं**। यह एक पर्सिस्टेंस तकनीक के रूप में उपयोगी हो सकता है यदि आप अपनी FDA अनुमतियां खो सकते हैं।

### **SIP Bypass से TCC Bypass तक**

सिस्टम **TCC डेटाबेस** **SIP** द्वारा संरक्षित है, इसलिए केवल उन प्रक्रियाओं के साथ **इंडिकेटेड एंटाइटलमेंट्स होने पर ही इसे संशोधित करने में सक्षम होंगे**। इसलिए, यदि एक हमलावर को **SIP bypass** किसी **फाइल** पर मिलता है (SIP द्वारा प्रतिबंधित एक फाइल को संशोधित करने में सक्षम हो), तो वह सक्षम होगा:
...
हालांकि, TCC को बायपास करने के लिए इस **SIP bypass का दुरुपयोग करने का एक और विकल्प है**, फाइल `/Library/Apple/Library/Bundles/TCC_Compatibility.bundle/Contents/Resources/AllowApplicationsList.plist` एक अनुमति सूची है जिसमें ऐसे एप्लिकेशन होते हैं जिन्हें TCC अपवाद की आवश्यकता होती है। इसलिए, यदि एक हमलावर इस फाइल से **SIP सुरक्षा को हटा सकता है** और अपना **खुद का एप्लिकेशन जोड़ सकता है** तो एप्लिकेशन TCC को बायपास करने में सक्षम होगा।\
