...
यदि **`SQLITE_SQLLOG_DIR="पथ/फ़ोल्डर"`** है, तो इसका अर्थ है कि **किसी भी खुली डेटाबेस को उस पथ पर कॉपी किया जाता है**। इस CVE में इस नियंत्रण का दुरुपयोग किया गया था ताकि एक प्रक्रिया जिसमें TCC डेटाबेस हो, उसके अंदर लिखा जा सके, और फिर **`SQLITE_SQLLOG_DIR`** का उपयोग एक **फ़ाइलनाम में सिंबलिंक** के साथ किया जा सके ताकि जब वह डेटाबेस **खोला जाता है**, उपयोगकर्ता का **TCC.db अधिलेखित** हो जाता है।\
