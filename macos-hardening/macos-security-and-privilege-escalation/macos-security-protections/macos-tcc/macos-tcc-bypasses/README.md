...
{% hint style="danger" %}
ध्यान दें कि अब SSH को सक्षम करने के लिए आपको **फ़ुल डिस्क एक्सेस** की आवश्यकता होती है
{% endhint %}
...
इसलिए, एक उपयोगकर्ता **एक ख़तरनाक ऐप्लिकेशन को रजिस्टर** कर सकता है जो सभी एक्सटेंशन का हैंडल करेगा और लॉन्च सेवाओं को कॉल करेगा ताकि किसी भी फ़ाइल को **खोलें** (इसलिए ख़तरनाक फ़ाइल को उसे पढ़ने की अनुमति मिलेगी)।
...
"लाइब्रेरी" पर क्वारंटाइन एट्रिब्यूट जोड़ना संभव था, **`com.apple.security.translocation`** XPC सेवा को कॉल करना संभव था और फिर यह "लाइब्रेरी" को **`$TMPDIR/AppTranslocation/d/d/Library`** से मैप कर देता था जहां लाइब्रेरी के सभी दस्तावेज़ों तक पहुंच संभव थी।
...
यदि कोई हमलावर **`configd`** को **`-t`** विकल्प के साथ चलाए, तो एक हमलावर एक **कस्टम Bundle** लोड कर सकता है। इसलिए, यह एक्सप्लॉइट **`dsexport`** और **`dsimport`** विधि को उपयोगकर्ता के होम डायरेक्टरी को बदलने के लिए **`configd` कोड इंजेक्शन** के साथ बदल देता है।
