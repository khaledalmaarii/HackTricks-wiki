...
Ako treba da **dekompajlirate**, **izmenite** i **ponovo kompajlirate** možete koristiti [**dnSpy**](https://github.com/dnSpy/dnSpy/releases) ili aktivno održanu verziju, [**dnSpyEx**](https://github.com/dnSpyEx/dnSpy/releases). (**Desni klik -> Izmeni metod** da promenite nešto unutar funkcije).

### DNSpy Logging

Da biste omogućili **DNSpy-u da beleži neke informacije u datoteci**, možete koristiti ovaj isecak koda:
```cs
using System.IO;
