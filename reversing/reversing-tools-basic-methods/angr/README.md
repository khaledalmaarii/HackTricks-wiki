...
```
# लोड किया गया और मुख्य ऑब्जेक्ट की जानकारी
...
* आप `args` के माध्यम से आर्ग्युमेंट्स की एक सूची और `env` के माध्यम से पर्यावरण वेरिएबल्स की एक डिक्शनरी `entry_state` और `full_init_state` में पास कर सकते हैं। इन संरचनाओं में मान स्ट्रिंग्स या बिटवेक्टर्स हो सकते हैं, और वे सिमुलेटेड एक्जीक्यूशन के आर्ग्युमेंट्स और पर्यावरण के रूप में स्टेट में सीरियलाइज़ किए जाएंगे। डिफ़ॉल्ट `args` एक खाली सूची है, इसलिए यदि आप जिस प्रोग्राम का विश्लेषण कर रहे हैं वह कम से कम एक `argv[0]` पाने की उम्मीद करता है, तो आपको हमेशा वह प्रदान करनी चाहिए!
* यदि आप चाहते हैं कि `argc` प्रतीकात्मक हो, तो आप `entry_state` और `full_init_state` कंस्ट्रक्टर्स को `argc` के रूप में एक प्रतीकात्मक बिटवेक्टर पास कर सकते हैं। हालांकि, सावधान रहें: यदि आप ऐसा करते हैं, तो आपको यह भी एक प्रतिबंध जोड़ना चाहिए कि आपके द्वारा दिया गया argc मान `args` में पास किए गए आर्ग्युमेंट्स की संख्या से अधिक नहीं हो सकता।
* कॉल स्टेट का उपयोग करने के लिए, आपको इसे `.call_state(addr, arg1, arg2, ...)` के साथ कॉल करना चाहिए, जहाँ `addr` वह एड्रेस है जिस फ़ंक्शन को आप कॉल करना चाहते हैं और `argN` उस फ़ंक्शन का Nth आर्ग्युमेंट है, या तो पायथन इंटीजर, स्ट्रिंग, या ऐरे के रूप में, या एक बिटवेक्टर के रूप में। यदि आप चाहते हैं कि मेमोरी आवंटित की जाए और वास्तव में किसी ऑब्जेक्ट के लिए एक पॉइंटर पास किया जाए, तो आपको इसे एक PointerWrapper में लपेटना चाहिए, अर्थात् `angr.PointerWrapper("point to me!")`। इस API के परिणाम थोड़े अप्रत्याशित हो सकते हैं, लेकिन हम इस पर काम कर रहे हैं।
...
```
## प्रतीकात्मक BitVectors और बाधाएँ
```python
...
```
```
इसके अलावा, आप `proj.hook_symbol(name, hook)` का उपयोग कर सकते हैं, पहले तर्क के रूप में एक सिंबल का नाम प्रदान करके, जहां सिंबल रहता है उस पते को हुक करने के लिए
