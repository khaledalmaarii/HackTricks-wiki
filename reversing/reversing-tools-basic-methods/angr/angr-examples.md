...
{% hint style="info" %}
अगर प्रोग्राम **`scanf`** का उपयोग कर रहा है **stdin से एक साथ कई मान प्राप्त करने के लिए** तो आपको एक स्थिति उत्पन्न करनी होगी जो **`scanf`** के बाद शुरू होती है।
{% endhint %}

### पता पहुंचने के लिए इनपुट (पता दिखाते हुए)
```python
import angr
import sys
...
{% hint style="info" %}
कभी-कभी साधारण मानव क्रियाएं जैसे किसी लंबाई 16 के 2 शब्दों की तुलना **वर्ण से वर्ण** (लूप), **angr** को बहुत कीमत पड़ती है क्योंकि यह शाखाएं **गणना करता है गणितीय रूप से** क्योंकि यह 1 शाखा प्रकट करता है प्रति यदि: `2^16`\
इसलिए, यह अधिक सरल है कि **angr से पिछले बिंदु तक पहुंचें** (जहां वास्तविक कठिन हिस्सा पहले से ही किया गया था) और **उन विवशताओं को मैन्युअल रूप से सेट करें**।
{% endhint %}
```python
...
```
{% hint style="danger" %}
कुछ स्थितियों में आप **veritesting** को सक्रिय कर सकते हैं, जो समान स्थितियों को मिलाएगा, जिससे अनावश्यक शाखाएं बचाई जा सकें और समाधान प्राप्त किया जा सके: `simulation = project.factory.simgr(initial_state, veritesting=True)`
{% endhint %}

{% hint style="info" %}
इन स्थितियों में एक और चीज जो आप कर सकते हैं, वह है **angr को कुछ ऐसा प्रदान करना जिसे यह आसानी से समझ सके**।
{% endhint %}
