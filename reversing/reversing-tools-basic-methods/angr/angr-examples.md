...
{% hint style="info" %}
यदि प्रोग्राम `scanf` का उपयोग करके **stdin से एक साथ कई मान प्राप्त कर रहा है** तो आपको एक ऐसा राज्य उत्पन्न करने की आवश्यकता है जो **`scanf`** के बाद शुरू होता है।
{% endhint %}
...
```
{% hint style="info" %}
ध्यान दें कि प्रतीकात्मक फ़ाइल में प्रतीकात्मक डेटा के साथ मिश्रित स्थिरांक डेटा भी हो सकता है:
```python
...
{% hint style="info" %}
कभी-कभी सरल मानव संचालन जैसे 16 लंबाई के 2 शब्दों की तुलना करना **char by char** (लूप), **angr** के लिए बहुत महंगा होता है क्योंकि इसे शाखाएँ **exponentially** उत्पन्न करनी होती हैं क्योंकि यह प्रत्येक if पर 1 शाखा उत्पन्न करता है: `2^16`\
इसलिए, **angr से पिछले बिंदु पर जाने के लिए कहना** (जहाँ असली कठिन हिस्सा पहले ही किया जा चुका था) और **उन constrains को मैन्युअल रूप से सेट करना** आसान होता है।
{% endhint %}
```python
...
```
{% hint style="danger" %}
कुछ परिदृश्यों में आप **veritesting** सक्रिय कर सकते हैं, जो समान स्थिति को मिलाएगा, ताकि बेकार शाखाओं को बचाया जा सके और समाधान पाया जा सके: `simulation = project.factory.simgr(initial_state, veritesting=True)`
{% endhint %}

{% hint style="info" %}
इन परिदृश्यों में आप जो एक और चीज कर सकते हैं वह है **फंक्शन को हुक करना, जिससे angr को कुछ ऐसा दिया जा सके जिसे वह अधिक आसानी से समझ सके**।
{% endhint %}
...
main(sys.argv)
```
### एक फ़ंक्शन को हुक करना / सिमप्रोसीजर
```python
