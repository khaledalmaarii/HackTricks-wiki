...
{% hint style="info" %}
अगर प्रोग्राम **`scanf`** का उपयोग कर रहा है ताकि **stdin से एक साथ कई मान प्राप्त** कर सके, तो आपको एक स्थिति उत्पन्न करनी होगी जो **`scanf`** के बाद शुरू होती है।
{% endhint %}

कोड [https://github.com/jakespringer/angr_ctf](https://github.com/jakespringer/angr_ctf) से लिया गया है

### पता पहुंचने के लिए इनपुट (पता देने वाला पता दिखाता है)
```python
import angr
import sys
...
main(sys.argv)
```
इस स्थिति में, इनपुट `scanf("%u %u")` के साथ लिया गया था और मान `"1 1"` दिया गया था, इसलिए स्टैक के मान **`0x00000001`** उपयोगकर्ता इनपुट से आते हैं। आप देख सकते हैं कि ये मान `$ebp - 8` में शुरू होते हैं। इसलिए, कोड में हमने **`$esp` से 8 बाइट कम किए (उस समय `$ebp` और `$esp` का समान मान था)** और फिर हमने BVS को पुश किया।
...
{% hint style="info" %}
कभी-कभी साधारण मानव क्रियाएं जैसे कि लंबाई 16 की 2 शब्दों की तुलना **अक्षर से अक्षर** (लूप) करना, **angr** को बहुत कुछ **लागत** पहुंचा सकता है क्योंकि यह शाखाएं **गणनात्मक रूप से** उत्पन्न करता है क्योंकि यह 1 शाखा प्रति if उत्पन्न करता है: `2^16`\
इसलिए, यह अधिक सरल है कि **angr से पिछले बिंदु तक पहुंचें** (जहां वास्तविक कठिनाई का हिस्सा पहले से ही किया गया था) और **उन बाधाएं मैन्युअल रूप से सेट करें**।
{% endhint %}
```python
...
```
{% hint style="danger" %}
कुछ परिदृश्यों में आप **veritesting** को सक्रिय कर सकते हैं, जो समान स्थितियों को मिलाएगा, जिससे अनावश्यक शाखाएं बचाई जा सकें और समाधान प्राप्त किया जा सके: `simulation = project.factory.simgr(initial_state, veritesting=True)`
{% endhint %}

{% hint style="info" %}
इन परिदृश्यों में एक और चीज जो आप कर सकते हैं, वह है **angr को कुछ ऐसा प्रदान करना जिसे यह समझ सके**।
{% endhint %}

### प्रस्तावना प्रबंधक

कुछ प्रस्तावना प्रबंधक अन्यों से अधिक उपयोगी हो सकते हैं। पिछले उदाहरण में एक समस्या थी क्योंकि कई उपयोगी शाखाएं बनाई गई थीं। यहाँ, **veritesting** तकनीक उन्हें मिलाएगी और समाधान प्राप्त करेगी।\
इस प्रस्तावना प्रबंधक को भी सक्रिय किया जा सकता है: `simulation = project.factory.simgr(initial_state, veritesting=True)`
```python
import angr
import claripy
import sys
...
* क्या आप **साइबर सुरक्षा कंपनी** में काम करते हैं? क्या आप अपनी **कंपनी का हैकट्रिक्स में विज्ञापित होना चाहते हैं**? या क्या आप **PEASS के नवीनतम संस्करण देखना चाहते हैं या HackTricks को PDF में डाउनलोड करना चाहते हैं**? [**SUBSCRIPTION PLANS**](https://github.com/sponsors/carlospolop) की जाँच करें!
* [**The PEASS Family**](https://opensea.io/collection/the-peass-family) की खोज करें, हमारा विशेष [**NFTs**](https://opensea.io/collection/the-peass-family) संग्रह
