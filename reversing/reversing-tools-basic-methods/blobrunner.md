...
Jedyną zmodyfikowaną linią z [oryginalnego kodu](https://github.com/OALabs/BlobRunner) jest linia 10. 
Aby skompilować, po prostu **stwórz projekt C/C++ w Visual Studio Code, skopiuj i wklej kod oraz zbuduj go**.
```c
#include <stdio.h>
#include <windows.h>
#include <stdlib.h>
