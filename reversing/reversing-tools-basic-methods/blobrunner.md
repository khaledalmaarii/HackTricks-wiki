...
唯一修改过的代码行是[原始代码](https://github.com/OALabs/BlobRunner)中的第10行。
为了编译它，只需**在Visual Studio Code中创建一个C/C++项目，复制并粘贴代码然后构建它**。
```c
#include <stdio.h>
#include <windows.h>
#include <stdlib.h>
...
<summary><strong>从零开始学习AWS黑客攻击直至成为高手</strong> <a href="https://training.hacktricks.xyz/courses/arte"><strong>htARTE (HackTricks AWS Red Team Expert)</strong></a><strong>！</strong></summary>
