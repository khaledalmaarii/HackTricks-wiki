...
यहां [मूल कोड](https://github.com/OALabs/BlobRunner) से केवल पंक्ति 10 में संशोधन किया गया है। इसे कंपाइल करने के लिए **Visual Studio Code में एक C/C++ परियोजना बनाएं, कोड कॉपी और पेस्ट करें और इसे बिल्ड करें**।
```c
#include <stdio.h>
#include <windows.h>
#include <stdlib.h>
