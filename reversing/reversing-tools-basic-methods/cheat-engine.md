...
**보통 숫자**는 **4바이트** 형식으로 저장되지만, **double** 또는 **float** 형식으로도 찾을 수 있으며, **숫자와 다른 것**을 찾고 싶을 수도 있습니다. 그런 이유로 **검색할 항목**을 **선택**해야 합니다:
...
**디스어셈블 코드**를 얻기 위해 "디스어셈블러 표시"를 클릭합니다.\
그런 다음 **CTRL+a**를 클릭하여 자동 조립 창을 호출하고 _**템플릿 --> 코드 주입**_을 선택합니다:
