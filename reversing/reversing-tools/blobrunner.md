...
Sadece [orijinal kod](https://github.com/OALabs/BlobRunner)'dan değiştirilen satır 10'dur.
Derlemek için sadece **Visual Studio Code'da bir C/C++ projesi oluşturun, kodu kopyalayıp yapıştırın ve derleyin**.
```c
#include <stdio.h>
#include <windows.h>
#include <stdlib.h>
