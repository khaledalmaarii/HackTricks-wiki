...
Bus Pirate के काम करने की जांच करने के लिए, +5V को VPU से और 3.3V को ADC से जोड़ें और बस पायरेट तक पहुंचें (उदाहरण के लिए Tera Term का उपयोग करके) और कमांड `~` का उपयोग करें:
```bash
# Use command
HiZ>~
...
Found 0 errors.
```
जैसा कि आप पिछले कमांड लाइन में देख सकते हैं, इसमें कहा गया था कि इसे 0 त्रुटियाँ मिलीं। यह जानना बहुत उपयोगी है कि यह काम कर रहा है, इसे खरीदने के बाद या फर्मवेयर फ्लैश करने के बाद।
...
बस पायरेट से बात करने के लिए मैंने Tera Term का उपयोग किया, जो पायरेट बस COM पोर्ट से कनेक्टेड है, सेटअप --> सीरियल पोर्ट --> 115200 की गति के साथ।\
निम्नलिखित संचार में आप देख सकते हैं कि बस पायरेट को I2C से बात करने के लिए कैसे तैयार किया जाए और मेमोरी से कैसे लिखें और पढ़ें (टिप्पणियाँ "#" का उपयोग करके दिखाई देती हैं, संचार में उस भाग की अपेक्षा न करें):
```bash
