...
[**JTAGenum** ](https://github.com/cyphunk/JTAGenum)je alat koji se može koristiti sa Raspberry PI ili Arduino uređajem kako bi pronašao JTAG pinove na nepoznatom čipu.\
...
Na Arduino-u, nakon što povežete kablove (pinovi 2 do 11 sa JTAG pinovima i Arduino GND sa osnovnom GND), **učitajte JTAGenum program na Arduino** i u Serial Monitor-u pošaljite **`h`** (komanda za pomoć) i trebalo bi da vidite pomoć:
