...
请注意，即使Pirate Bus的PINOUT指示了用于连接SPI的**MOSI**和**MISO**引脚，但有些SPI可能会将引脚标记为DI和DO。 **MOSI -> DI, MISO -> DO**

![](<../../.gitbook/assets/image (648) (1) (1).png>)

在Windows或Linux中，您可以使用[**`flashrom`**](https://www.flashrom.org/Flashrom)程序来转储flash内存的内容，运行类似于：
```bash
