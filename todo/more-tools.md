...
* [https://www.nmmapper.com/sys/tools/subdomainfinder/](https://www.nmmapper.com/sys/tools/subdomainfinder/) : 8 εργαλεία ανεύρεσης υποτομέων, sublist3r, amass και άλλα
...
* [https://github.com/tomnomnom/httprobe](https://github.com/tomnomnom/httprobe): Ελέγξτε αν οι διακομιστές ιστού σε έναν τομέα είναι προσβάσιμοι
...
* [https://github.com/fransr/postMessage-tracker](https://github.com/fransr/postMessage-tracker) : Επέκταση Chrome για την παρακολούθηση των λειτουργιών post-messages
* [https://github.com/Quitten/Autorize](https://github.com/Quitten/Autorize) : Αυτόματες δοκιμές αυθεντικοποίησης (αφαιρέστε τα cookies και προσπαθήστε να στείλετε το αίτημα)
* [https://github.com/pikpikcu/xrcross](https://github.com/pikpikcu/xrcross): XRCross είναι μια Ανακατασκευή, Σαρωτής και εργαλείο για δοκιμές διείσδυσης / BugBounty. Αυτό το εργαλείο κατασκευάστηκε για να δοκιμάσει (XSS|SSRF|CORS|SSTI|IDOR|RCE|LFI|SQLI) ευπάθειες
...
Πώς να εξάγετε firmware αν δεν το βρούμε online: [https://www.youtube.com/watch?v=Kxvpbu9STU4](https://www.youtube.com/watch?v=Kxvpbu9STU4)
...
Εξομοίωση firmware: FIRMADYNE (https://github.com/firmadyne/firmadyne/) είναι μια πλατφόρμα για την αυτοματοποίηση της εξομοίωσης και της δυναμικής ανάλυσης του Linux-based firmware.
...
* [https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/](https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/) : Πόροι για αρχάριους κυνηγούς BugBounty
