...
* **हैकिंग ट्रिक्स साझा करें द्वारा PRs सबमिट करके** [**हैकट्रिक्स रेपो**](https://github.com/carlospolop/hacktricks) **और** [**हैकट्रिक्स-क्लाउड रेपो**](https://github.com/carlospolop/hacktricks-cloud)।

</details>

[**फ्लिपर जीरो**](https://flipperzero.one/) के साथ आप:

* **रेडियो तांत्रिकताएँ सुनें/कैप्चर करें/रीप्ले करें:** [**सब-जीएचजी**](fz-sub-ghz.md)
* **NFC कार्ड पढ़ें/कैप्चर करें/इम्युलेट करें:** [**NFC**](fz-nfc.md)
* **125kHz टैग पढ़ें/कैप्चर करें/इम्युलेट करें:** [**125kHz आरआईडीएफ**](fz-125khz-rfid.md)
* **इन्फ्रारेड सिग्नल पढ़ें/कैप्चर करें/भेजें:** [**इन्फ्रारेड**](fz-infrared.md)
* **iButtons पढ़ें/कैप्चर करें/इम्युलेट करें:** [**iButton**](../ibutton.md)
* **इसे बैड USB के रूप में उपयोग करें**
* **सुरक्षा कुंजी (U2F) के रूप में उपयोग करें**
* **स्नेक खेलें**

[**https://github.com/djsime1/awesome-flipperzer**](https://github.com/djsime1/awesome-flipperzero) में अन्य फ्लिपर जीरो संसाधनों को जानें।
