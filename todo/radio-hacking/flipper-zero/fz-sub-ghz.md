...
在使用读取时，可以按下**左侧按钮**并**进行配置**。\
此时有**4种调制**（AM270、AM650、FM328和FM476），以及**存储的几个相关频率**：

<figure><img src="../../../.gitbook/assets/image (947).png" alt=""><figcaption></figcaption></figure>

您可以设置**您感兴趣的任何频率**，但是，如果您**不确定遥控器使用的是哪个频率**，请将跳频设置为ON（默认为关闭），然后按下按钮多次，直到Flipper捕获它并为您提供所需设置频率的信息。
...
默认情况下，**读取原始数据也是在433.92的AM650中**，但是如果使用读取选项找到您感兴趣的信号在**不同的频率/调制**上，您也可以通过按左键（在读取原始数据选项内）进行修改。
...
请查看[https://docs.flipperzero.one/sub-ghz/supported-vendors](https://docs.flipperzero.one/sub-ghz/supported-vendors)

### 各地区支持的频率

请查看[https://docs.flipperzero.one/sub-ghz/frequencies](https://docs.flipperzero.one/sub-ghz/frequencies)
