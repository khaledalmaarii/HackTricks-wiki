...
Sie können **jede interessante Frequenz festlegen**, aber wenn Sie **nicht sicher sind, welche Frequenz** von der Fernbedienung verwendet wird, **schalten Sie das Hopping auf EIN** (standardmäßig aus) und drücken Sie die Taste mehrmals, bis Flipper sie erfasst und Ihnen die benötigten Informationen zur Einstellung der Frequenz gibt.

{% hint style="danger" %}
Das Wechseln zwischen Frequenzen dauert einige Zeit, daher können Signale, die während des Wechsels übertragen werden, verpasst werden. Für eine bessere Signalrezeption legen Sie eine feste Frequenz fest, die durch den Frequenzanalysator bestimmt wird.
{% endhint %}
