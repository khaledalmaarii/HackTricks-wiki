...
Flipper Zero posiada wbudowany moduł sub-1 GHz oparty na [﻿](https://www.st.com/en/nfc/st25r3916.html#overview)﻿[układzie CC1101](https://www.ti.com/lit/ds/symlink/cc1101.pdf) i antenie radiowej (maksymalny zasięg to 50 metrów). Zarówno układ CC1101, jak i antena są zaprojektowane do pracy w częstotliwościach z pasm 300-348 MHz, 387-464 MHz i 779-928 MHz.
...
{% hint style="info" %}
Jak znaleźć, jaką częstotliwość używa pilot zdalnego sterowania
{% endhint %}
...
1. Umieść pilot zdalnego sterowania bardzo blisko lewej strony Flipper Zero.
2. Przejdź do **Menu Głównego** **→ Sub-GHz**.
3. Wybierz **Analizator Częstotliwości**, następnie przytrzymaj przycisk na pilocie zdalnego sterowania, który chcesz przeanalizować.
4. Sprawdź wartość częstotliwości na ekranie.

### Odczyt

{% hint style="info" %}
Znajdź informacje o używanej częstotliwości (również inny sposób na znalezienie używanej częstotliwości)
{% endhint %}
...
Możesz ustawić **dowolną, która Cię interesuje**, jednak jeśli **nie jesteś pewien, która częstotliwość** może być używana przez pilot zdalnego sterowania, **ustaw Hopping na ON** (domyślnie Off) i naciśnij przycisk kilka razy, aż Flipper ją przechwyci i poda Ci potrzebne informacje do ustawienia częstotliwości.
