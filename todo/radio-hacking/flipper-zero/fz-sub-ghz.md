...
Ενώ η Ανάγνωση είναι σε χρήση, είναι δυνατή η πίεση του **αριστερού κουμπιού** και η **ρύθμισή του**.\
