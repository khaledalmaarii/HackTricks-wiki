...
## Proxmark3 के साथ RFID सिस्टमों पर हमला

पहली चीज जो आपको करनी होगी, वह है [**Proxmark3**](https://proxmark.com) और [**सॉफ़्टवेयर इंस्टॉल करना और इसकी डिपेंडेंसी**](https://github.com/Proxmark/proxmark3/wiki/Kali-Linux)[**s**](https://github.com/Proxmark/proxmark3/wiki/Kali-Linux)।
...
प्रत्येक सेक्टर तक पहुंचने के लिए आपको **2 कुंजियाँ** (**A** और **B**) चाहिए होती हैं जो **प्रत्येक सेक्टर के ब्लॉक 3 में** संग्रहीत होती हैं (सेक्टर ट्रेलर)। सेक्टर ट्रेलर में ही **एक्सेस बिट्स** भी होते हैं जो 2 कुंजियों का उपयोग करके **प्रत्येक ब्लॉक पर पढ़ने और लिखने** की अनुमतियाँ देते हैं।\
2 कुंजियाँ उपयोगी होती हैं जब पहली कुंजी को जानने पर पढ़ने की अनुमति देनी हो और दूसरी कुंजी को जानने पर लिखने की। (उदाहरण के लिए)।
...
```
Proxmark3 अन्य क्रियाएँ करने की अनुमति देता है जैसे **इव्सड्रॉपिंग** एक **टैग से रीडर संचार** को छनने के लिए संवेदनशील डेटा खोजने की कोशिश करना। इस कार्ड में आप संचार को स्निफ कर सकते हैं और इस्तेमाल की गई कुंजी की गणना कर सकते हैं क्योंकि **क्रिप्टोग्राफिक ऑपरेशन जो किए जाते हैं वे कमजोर होते हैं** और सादा और साइफर पाठ को जानकर आप इसे गणना कर सकते हैं (`mfkey64` उपकरण)।

### कच्चे कमांड

आईओटी सिस्टम कभी-कभी **गैर-ब्रांडेड या गैर-वाणिज्यिक टैग** का उपयोग करते हैं। इस मामले में, आप Proxmark3 का उपयोग करके टैग्स को भेजने के लिए **कस्टम कच्चे कमांड** भेज सकते हैं।
```bash
