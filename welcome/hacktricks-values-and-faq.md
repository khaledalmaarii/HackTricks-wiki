...
**Pedimos desculpas. Isso não deveria ter acontecido**. Por favor, nos avise via problemas do Github, Twitter, Discord... o link da página do HackTricks com o conteúdo e o link do seu blog e **iremos verificar e adicionar o mais rápido possível**.
...
* O **HackTricks incentiva** as pessoas a **verificarem sua página** (várias pessoas nos mencionaram que, desde que alguma página delas está no HackTricks, elas recebem mais visitas)

No entanto, se você ainda quiser que o conteúdo do seu blog seja removido do HackTricks, nos avise e **iremos remover todos os links para seu blog**, e qualquer conteúdo baseado nele.

{% hint style="danger" %}
* **O que devo fazer se encontrar conteúdo copiado no HackTricks?**
{% endhint %}

Sempre **damos todos os créditos aos autores originais**. Se você encontrar uma página com conteúdo copiado sem a fonte original referenciada, nos avise e iremos **removê-lo**, **adicionar o link antes do texto**, ou **reescrevê-lo adicionando o link**.
...
Os autores e editores não serão, em caso algum, responsáveis por qualquer perda ou dano, incluindo, sem limitação, perda ou dano indireto ou consequente, ou qualquer perda ou dano que resulte da perda de dados ou lucros decorrentes de, ou em conexão com, o uso deste livro.
