...
[**Fuata kiungo hiki ili kujifunza juu ya zana unazoweza kutumia.**](../../network-services-pentesting/pentesting-smb/#domain-shared-folders-search)
...
[**Soma ukurasa huu kuhusu njia tofauti za kupata hash.**](https://github.com/carlospolop/hacktricks/blob/sw/windows-hardening/active-directory-methodology/broken-reference/README.md)
...
[**Maelezo zaidi kuhusu jinsi ya kuiba NTDS.dit yanaweza kupatikana hapa**](https://github.com/carlospolop/hacktricks/blob/sw/windows-hardening/active-directory-methodology/broken-reference/README.md)
...
3. katika kesi hii, kerberoast inaweza kuwa chaguo lingine.
4. **Dhoofisha** akaunti ambazo zinaweza **kupitia** kupitia vikoa.
