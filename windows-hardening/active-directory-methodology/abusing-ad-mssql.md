...
MSSQL में **कमांड्स को निष्पादित** करना भी संभव हो सकता है
```powershell
...
लिंक के माध्यम से क्वेरी चलाएं (उदाहरण: नए पहुंचने वाले इंस्टेंस में अधिक लिंक खोजें):
```sql
