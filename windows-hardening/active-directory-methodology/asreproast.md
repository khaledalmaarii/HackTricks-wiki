...
एक हमलावर एक मैन-इन-द-मिडिल स्थिति का उपयोग कर सकता है ताकि AS-REP पैकेट को जाल से गुजरते हुए पकड़ सके <ins>के बिना करबेरोस पूर्व-प्रमाणीकरण पर निर्भरता करने की आवश्यकता न हो।</ins> इसलिए यह सभी उपयोगकर्ताओं के लिए VLAN पर काम करता है।<br>
[ASRepCatcher](https://github.com/Yaxxine7/ASRepCatcher) हमें इसे करने की अनुमति देता है। इसके अतिरिक्त, यह उपकरण <ins>करबेरोस बातचीत को बदलकर क्लाइंट वर्कस्टेशन को RC4 का उपयोग करने के लिए मजबूर करता है।</ins>
```bash
