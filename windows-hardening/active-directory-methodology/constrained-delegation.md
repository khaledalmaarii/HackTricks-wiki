...
{% hint style="warning" %}
**QaQ** **TGT ticket** **RC4** **AES256** **SYSTEM** **Printer Bug** **unconstrain delegation** **NTLM relaying** **Active Directory Certificate Service abuse**

**QaQ TGT ticket (or hashed) vItlhutlh** **attack** **QaQ** **computer.**
{% endhint %}
