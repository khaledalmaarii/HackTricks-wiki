...
{% hint style="warning" %}
Існують **інші способи отримати квиток TGT** або **RC4** чи **AES256** без того, щоб бути SYSTEM на комп'ютері, такі як Printer Bug і неконтрольована делегація, NTLM релеювання та зловживання службою сертифікатів Active Directory.

**Просто маючи цей квиток TGT (або його хеш), ви можете виконати цю атаку, не компрометуючи весь комп'ютер.**
{% endhint %}
