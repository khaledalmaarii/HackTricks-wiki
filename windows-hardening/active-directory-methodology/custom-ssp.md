...
[यहाँ जानें कि SSP (सुरक्षा समर्थन प्रदाता) क्या है।](../authentication-credentials-uac-and-efs.md#security-support-provider-interface-sspi)\
आप अपना **खुद का SSP** बना सकते हैं ताकि मशीन तक पहुंचने के लिए उपयोग किए गए **क्रेडेंशियल्स** को **स्पष्ट पाठ** में **कैप्चर** किया जा सके।

### Mimilib

आप Mimikatz द्वारा प्रदान की गई `mimilib.dll` बाइनरी का उपयोग कर सकते हैं। **यह सभी क्रेडेंशियल्स को स्पष्ट पाठ में एक फ़ाइल में लॉग करेगा।**\
...
```
और एक बार पुनरारंभ के बाद सभी प्रमाण पुस्तक में स्पष्ट पाठ में `C:\Windows\System32\kiwissp.log` में पाए जा सकते हैं।
...
घटना आईडी 4657 - `HKLM:\System\CurrentControlSet\Control\Lsa\SecurityPackages` के निर्माण/परिवर्तन की निगरानी
