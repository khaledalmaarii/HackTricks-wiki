...
**DCSync** अनुमति खुद डोमेन पर इन अनुमतियों को होने का संकेत देती है: **DS-Replication-Get-Changes**, **Replicating Directory Changes All** और **Replicating Directory Changes In Filtered Set**।
...
`powerview` का उपयोग करके जांचें कि कौन इन अनुमतियों को रखता है:
```powershell
...
* NTDS से साफ पाठ के पासवर्ड के साथ एक जो किसी भी खातों के लिए है जिन्होंने [**पुनरावृत्ति एन्क्रिप्शन**](https://docs.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/store-passwords-using-reversible-encryption) सक्षम किया है। आप पुनरावृत्ति एन्क्रिप्शन के साथ उपयोगकर्ताओं को प्राप्त कर सकते हैं
...
```
फिर, आप **यह जांच सकते हैं कि उपयोगकर्ता को सही ढंग से असाइन किया गया था** 3 विशेषाधिकारों की खोज करके (आपको "ObjectType" फील्ड के अंदर विशेषाधिकारों के नाम देखने में सक्षम होना चाहिए):
```powershell
...
* AD ACL स्कैनर - ACLs के निर्माण और तुलना की रिपोर्टें बनाएं। [https://github.com/canix1/ADACLScanner](https://github.com/canix1/ADACLScanner)
...
\
[**Trickest**](https://trickest.com/?utm\_campaign=hacktrics\&utm\_medium=banner\&utm\_source=hacktricks) का उपयोग करें और आसानी से **और्जात कार्यप्रणालियाँ** बनाएं जो दुनिया के **सबसे उन्नत** समुदाय उपकरणों द्वारा संचालित हैं।\
