...
* **DCSync हमला एक डोमेन कंट्रोलर के व्यवहार का अनुकरण करता है और अन्य डोमेन कंट्रोलर से जानकारी की प्रतिलिपि** मांगता है डायरेक्टरी रिप्लिकेशन सेवा रिमोट प्रोटोकॉल (MS-DRSR) का उपयोग करके। क्योंकि MS-DRSR एक मान्य और आवश्यक Active Directory कार्य है, इसे बंद या अक्षम किया नहीं जा सकता।
* डिफ़ॉल्ट रूप से केवल **डोमेन एडमिन्स, एंटरप्राइज एडमिन्स, व्यवस्थापक और डोमेन कंट्रोलर्स** समूहों के पास आवश्यक विशेषाधिकार होते हैं।
...
* NTDS से साफ पाठ के साथ एक जिन खातों के लिए एक जिनमें [**पलटाव एन्क्रिप्शन**](https://docs.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/store-passwords-using-reversible-encryption) सक्षम है। आप पलटाव एन्क्रिप्शन के साथ उपयोगकर्ताओं को प्राप्त कर सकते हैं
...
```
तो, फिर आप **यह जांच सकते हैं कि उपयोगकर्ता को सही ढंग से असाइन किया गया था** 3 विशेषाधिकार, उन्हें खोजकर (आपको "ObjectType" फील्ड के अंदर विशेषाधिकारों के नाम देखने में सक्षम होना चाहिए):
```powershell
