...
Es gibt ein **lokales Administratorkonto** in jedem **DC**. Mit Administratorrechten auf diesem Computer können Sie Mimikatz verwenden, um den **Hash des lokalen Administrators** zu **dumpen**. Dann müssen Sie die Registrierung ändern, um dieses Passwort zu **aktivieren**, damit Sie remote auf diesen lokalen Administratorbenutzer zugreifen können.\
