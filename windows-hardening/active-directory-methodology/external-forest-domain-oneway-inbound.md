...
इस स्थिति में एक बाहरी डोमेन आप पर भरोसा कर रहा है (या दोनों एक-दूसरे पर भरोसा कर रहे हैं), इसलिए आपको इस पर किसी प्रकार का पहुंच हो सकता है।

## गणना

सबसे पहले, आपको **भरोसा** की **गणना** करनी होगी:
```powershell
Get-DomainTrust
...
यदि आपको अपने उपयोगकर्ता का किसी अन्य डोमेन में कोई **विशेष** पहुंच नहीं मिली, तो आप फिर से AD Methodology पर जा सकते हैं और **अनगुणा उपयोगकर्ता से प्राइविलेज वृद्धि** का प्रयास कर सकते हैं (उदाहरण के लिए kerberoasting जैसी चीजें):

आप **Powerview functions** का उपयोग करके **अन्य डोमेन** की **जाँच** कर सकते हैं जैसे कि `-Domain` पैरामीटर का उपयोग करके:
```powershell
...
एक नियमित तरीके का उपयोग करके उन उपयोगकर्ताओं के परिचय के साथ जिनके पास बाहरी डोमेन तक पहुंच है, आपको पहुंचना चाहिए:
```powershell
Enter-PSSession -ComputerName dc.external_domain.local -Credential domain\administrator
```
### SID इतिहास दुरुपयोग

आप एक वन फॉरेस्ट से दूसरे फॉरेस्ट में **एक उपयोगकर्ता को स्थानांतरित** करते हैं और **SID फ़िल्टरिंग सक्षम नहीं है**, तो यह संभव हो जाता है कि **दूसरे फॉरेस्ट से एक SID जोड़ा जा सकता है**, और यह **SID** **उपयोगकर्ता के टोकन** में **जोड़ दिया जाएगा** जब **विश्वास** के समय **प्रमाणीकरण** किया जाता है।

{% hint style="warning" %}
एक संकेत के साथ चिन्हित कर सकते हैं।
```powershell
