...
* यदि आप अपनी कंपनी का **HackTricks में विज्ञापित करना चाहते हैं** या **HackTricks को PDF में डाउनलोड करना चाहते हैं** तो [**सब्सक्रिप्शन प्लान**](https://github.com/sponsors/carlospolop) देखें!
...
Kerberoasting **TGS tickets** की प्राप्ति पर ध्यान केंद्रित है, विशेष रूप से उनके सेवाओं के तहत जो **Active Directory (AD)** में **उपयोगकर्ता खातों** के तौर पर कार्य कर रहे हैं, **कंप्यूटर खातों** को छोड़कर। इन टिकटों का एन्क्रिप्शन **उपयोगकर्ता पासवर्ड** से उत्पन्न कुंजियों का उपयोग करता है, जिससे **ऑफ़लाइन प्रमाण पट्टी क्रैकिंग** की संभावना होती है। सेवा के रूप में एक उपयोगकर्ता खाता का उपयोग एक गैर-खाली **"ServicePrincipalName"** संपत्ति द्वारा सूचित किया जाता है।

**Kerberoasting** को निष्पादित करने के लिए, **TGS tickets** का अनुरोध करने की क्षमता वाला डोमेन खाता आवश्यक है; हालांकि, यह प्रक्रिया **विशेष विशेषाधिकार** की मांग नहीं करती, जिससे इसे किसी भी व्यक्ति के लिए **वैध डोमेन क्रेडेंशियल** के साथ पहुंचने योग्य बनाता है।

### मुख्य बिंदु:
- **Kerberoasting** **AD** के भीतर **उपयोगकर्ता खात सेवाओं** के लिए **TGS tickets** को लक्ष्य बनाता है।
- **उपयोगकर्ता पासवर्ड** से एन्क्रिप्शन किए गए टिकटों को **ऑफ़लाइन** क्रैक किया जा सकता है।
- एक सेवा को एक गैर-खाली **ServicePrincipalName** द्वारा पहचाना जाता है।
- **कोई विशेष विशेषाधिकार** की आवश्यकता नहीं है, केवल **वैध डोमेन क्रेडेंशियल** चाहिए।

### **हमला**

{% hint style="warning" %}
**Kerberoasting उपकरण** सामान्यत: **हमला करते समय** **`RC4 एन्क्रिप्शन`** का अनुरोध करते हैं और TGS-REQ अनुरोधों की प्रारंभिकता करते हैं। इसलिए **RC4** [**कमजोर**](https://www.stigviewer.com/stig/windows\_10/2017-04-28/finding/V-63795) है और इसे अन्य एन्क्रिप्शन एल्गोरिथमों जैसे AES-128 और AES-256 की तुलना में ऑफ़लाइन में क्रैक करना आसान है।\
...
```
### कर्बेरोस्ट करने योग्य उपयोगकर्ताओं का डंप जैसे कई फीचर वाले उपकरण:
```bash
...
* `ntpdate <DC का IP>` - Ubuntu 16.04 के रूप में विचारात्मक
* `rdate -n <DC का IP>`

### संरोधन

करबेरोस्टिंग एक उच्च स्तर पर गुप्तता के साथ की जा सकती है यदि यह शोषणीय है। इस गतिविधि का पता लगाने के लिए, ध्यान दिया जाना चाहिए **सुरक्षा घटना आईडी 4769** पर, जो इसका संकेत देता है कि एक करबेरोस टिकट का अनुरोध किया गया है। हालांकि, इस घटना की उच्च आवृत्ति के कारण, संदिग्ध गतिविधियों को अलग करने के लिए विशेष फिल्टर लागू किए जाने चाहिए:
...
- मशीनों से अनुरोधों को फ़िल्टर किया जाना चाहिए जिसमें खाता नाम का प्रारूप हो **machine@domain** के रूप में।
...
**सितंबर 2022** में, एक नए तरीके से एक सिस्टम का शोध करने का तरीका एक शोधकर्ता नामक चार्ली क्लार्क ने प्रकाश में लाया, जिसे उन्होंने अपने प्लेटफ़ॉर्म [exploit.ph](https://exploit.ph/) के माध्यम से साझा किया। इस विधि की मदद से **सेवा टिकट्स (ST)** की प्राप्ति संभव होती है एक **KRB_AS_REQ** अनुरोध के माध्यम से, जिसके लिए किसी भी सक्रिय निर्देशिका खाते पर नियंत्रण की आवश्यकता नहीं है। मूल रूप से, यदि एक प्रमुख इस प्रकार से सेट किया गया है कि इसे पूर्व-प्रमाणीकरण की आवश्यकता नहीं है - एक स्थिति जो साइबर सुरक्षा विश्व में एक **AS-REP Roasting हमला** के रूप में जाना जाता है - तो इस विशेषता का उपयोग अनुरोध प्रक्रिया को मोड़ने के लिए किया जा सकता है। विशेष रूप से, अनुरोध के शरीर में **sname** विशेषता को बदलकर, सिस्टम को एक **ST** जारी करने के लिए धोखा दिया जाता है बजाय मानक एन्क्रिप्टेड टिकट ग्रांटिंग टिकट (TGT)।
...
\
[**Trickest**](https://trickest.com/?utm_campaign=hacktrics&utm_medium=banner&utm_source=hacktricks) का उपयोग करें और दुनिया के **सबसे उन्नत समुदाय उपकरणों** द्वारा संचालित **ऑटोमेटेड वर्कफ़्लो** आसानी से बनाएं।\
आज ही पहुंचें:
