...
```
{% hint style="warning" %}
Пароль все ще буде скинуто, якщо **адміністратор** використовує командлет **`Reset-AdmPwdPassword`**; або якщо в LAPS GPO увімкнено **Не дозволяти термін закінчення пароля довше, ніж вимагає політика**.
{% endhint %}
