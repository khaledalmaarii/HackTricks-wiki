# Übergeben Sie den Hash/Schlüssel
...
```
Für Szenarien, die AES256 erfordern, kann die Option `-aesKey [AES-Schlüssel]` verwendet werden. Darüber hinaus kann das erworbene Ticket mit verschiedenen Tools wie smbexec.py oder wmiexec.py verwendet werden, um den Angriffsbereich zu erweitern.

Aufgetretene Probleme wie _PyAsn1Error_ oder _KDC cannot find the name_ werden in der Regel durch Aktualisieren der Impacket-Bibliothek oder Verwenden des Hostnamens anstelle der IP-Adresse gelöst, um die Kompatibilität mit dem Kerberos KDC sicherzustellen.
