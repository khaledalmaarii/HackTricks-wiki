...
**Bilet Geçirme (PTT)** saldırı yönteminde, saldırganlar bir kullanıcının kimlik doğrulama bileti**ni çalarlar** ve şifre veya hash değerlerini değil. Bu çalınan bilet daha sonra kullanılarak kullanıcıyı **taklit ederler**, ağ içindeki kaynaklara ve hizmetlere izinsiz erişim elde ederler.
