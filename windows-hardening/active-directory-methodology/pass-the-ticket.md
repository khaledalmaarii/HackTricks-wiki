...
L'outil [**ticket_converter**](https://github.com/Zer1t0/ticket\_converter) convertit les formats de ticket en utilisant simplement le ticket lui-même et un fichier de sortie.
```bash
