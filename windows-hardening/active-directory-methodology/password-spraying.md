...
ध्यान दें कि यदि आप कई गलत पासवर्ड की कोशिश करते हैं तो आप **कुछ खातों को लॉकआउट कर सकते हैं** (डिफ़ॉल्ट रूप से 10 से अधिक).

### पासवर्ड नीति प्राप्त करें

यदि आपके पास कुछ उपयोगकर्ता क्रेडेंशियल्स या डोमेन उपयोगकर्ता के रूप में शैली होती है, तो आप **पासवर्ड नीति प्राप्त कर सकते हैं**:
```bash
# From Linux
...
```
* [**kerbrute**](https://github.com/ropnop/kerbrute) का उपयोग करें (Go)
```bash
# Password Spraying
...
आउटलुक के लिए पासवर्ड स्प्रेइंग के लिए कई टूल हैं।
...
इन टूल्स में से किसी का उपयोग करने के लिए, आपको एक उपयोगकर्ता सूची और एक पासवर्ड / स्प्रे करने के लिए एक छोटी सी पासवर्ड सूची की आवश्यकता है।
```bash
