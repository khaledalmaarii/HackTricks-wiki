...
Permitir acesso à **console winrm PS para um usuário** [**usando este**](https://github.com/samratashok/nishang/blob/master/Backdoors/Set-RemoteWMI.ps1)**:**
```bash
