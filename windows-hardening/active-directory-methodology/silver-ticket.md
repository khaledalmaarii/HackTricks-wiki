...
[**Plus d'informations sur les Silver Tickets dans ired.team**](https://ired.team/offensive-security-experiments/active-directory-kerberos-abuse/kerberos-silver-tickets)
...
| Outils d'administration de serveur distant Windows | <p>RPCSS</p><p>LDAP</p><p>CIFS</p>                                         |
...
Si vous êtes intéressé par une **carrière de hacking** et souhaitez hacker l'impénétrable - **nous recrutons!** (_maîtrise du polonais à l'écrit et à l'oral requise_).
