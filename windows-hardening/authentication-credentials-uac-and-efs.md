...
Vérifiez si un **utilisateur** a **utilisé** ce **service** en vérifiant si ce chemin existe : `C:\utilisateurs\<nom_utilisateur>\appdata\roaming\Microsoft\Protect`
...
Consultez également cette [page web](https://cube0x0.github.io/Relaying-for-gMSA/) sur comment effectuer une attaque de relais **NTLM** pour **lire** le **mot de passe** de **gMSA**.
