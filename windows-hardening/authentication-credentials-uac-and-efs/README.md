...
Dosyaya kimin **erişimi** olduğunu kontrol etmek için `cipher /c \<dosya>` komutunu kullanabilirsiniz. Ayrıca tüm dosyaları **şifrelemek** ve **şifre çözmek** için bir klasör içinde `cipher /e` ve `cipher /d` komutlarını da kullanabilirsiniz.
