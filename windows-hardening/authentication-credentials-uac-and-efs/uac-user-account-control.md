...
यदि आप **UACME** की ओर देखते हैं तो आप देखेंगे कि **अधिकांश UAC बाइपास एक Dll हाइजैकिंग सुरक्षा दोष** का दुरुपयोग करते हैं (मुख्य रूप से दुर्भाग्यपूर्ण dll को _C:\Windows\System32_ पर लिखना)। [एक Dll हाइजैकिंग सुरक्षा दोष कैसे खोजें इसे सीखने के लिए यह पढ़ें](../windows-local-privilege-escalation/dll-hijacking/)।
...
4. **wusa.exe**: Windows 7,8 और 8.1। यह संरक्षित पथों में एक CAB फ़ाइल की सामग्री निकालने की अनुमति देता है (क्योंकि यह उच्च सत्यापन स्तर से निष्पादित होता है)।
5. **IFileOperation**: Windows 10।
6. संरक्षित पथ में अपनी DLL की प्रतिलिपि बनाने और संरक्षित पथ में अपनी DLL को कॉपी करने और विकल्पित और स्वत: उच्चतम स्तर के बाइनरी को निष्पादित करने के लिए एक **स्क्रिप्ट** तैयार करें।
