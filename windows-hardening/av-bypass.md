...
यदि आप अपने खुद के उपकरण विकसित करते हैं, तो कोई भी ज्ञात बुरे हस्ताक्षर नहीं होंगे, लेकिन इसमें बहुत समय और प्रयास लगेगा।
...
* **मशीन के संसाधनों की जांच** सामान्यत: सैंडबॉक्स के पास काम करने के लिए बहुत ही कम संसाधन होते हैं (जैसे < 2GB रैम), अन्यथा वे उपयोगकर्ता की मशीन को धीमा कर सकते हैं। आप यहां बहुत रचनात्मक हो सकते हैं, उदाहरण के लिए CPU का तापमान या फिर फैन की गति की जांच करके, सैंडबॉक्स में सभी चीजें लागू नहीं होंगी।
...
[@mgeeky](https://twitter.com/mariuszbit) से कुछ अन्य बहुत अच्छे टिप्स
...
जैसा कि हमने इस पोस्ट में पहले कहा है, **सार्वजनिक उपकरण** अंततः **खोजा जाएगा**, इसलिए, आपको खुद को कुछ पूछना चाहिए:
...
यह कमांड "C:\Program Files\\" के अंदर DLL हाइजैकिंग के लिए संवेदनशील कार्यक्रमों की सूची और वे DLL फ़ाइलें उत्पन्न करेगा।
...
ये वह कदम हैं जिन्हें मैंने अपनाए:
```
...
आखिरी कमांड हमें 2 फ़ाइलें देगी: एक DLL स्रोत कोड टेम्पलेट, और मूल नाम बदल दी गई DLL।
...
`Freeze एक पेडलोड टूलकिट है जो EDRs को सस्पेंडेड प्रोसेसेस, डायरेक्ट सिसकॉल्स, और वैकल्पिक निष्पादन विधियों का उपयोग करके उन्हें छलाने के लिए है`

आप Freeze का उपयोग करके अपने शेलकोड को एक छलानेवाले तरीके में लोड और निष्पादित कर सकते हैं।
```
...
यह एंटीवायरस समाधानों को स्क्रिप्ट व्यवहार की जांच करने की अनुमति देता है जिसे एक ऐसे रूप में उजागर किया गया है जो अनक्रिप्टेड और अनओब्फस्केटेड है।
...
ध्यान दें कि यह `amsi:` को पहले जोड़ता है और फिर एक्जीक्यूटेबल का पथ जो स्क्रिप्ट चलाया गया, इस मामले में, powershell.exe
...
* [**inceptor**](https://github.com/klezVirus/inceptor)**:** Inceptor मौजूदा EXE/DLL को शैलकोड में परिवर्तित करने और फिर उन्हें लोड करने में सक्षम है

## स्मार्टस्क्रीन और MoTW

आपने शायद इस स्क्रीन को देखा होगा जब इंटरनेट से कुछ एक्जीक्यूटेबल डाउनलोड करके उन्हें चलाते समय।
...
<figure><img src="../.gitbook/assets/image (13) (3).png" alt=""><figcaption><p>इंटरनेट से डाउनलोड की गई फ़ाइल के लिए Zone.Identifier ADS की जाँच।</p></figcaption></figure>

{% hint style="info" %}
यह महत्वपूर्ण है कि **विश्वसनीय** हस्ताक्षर सर्टिफिकेट के साथ साइन की गई एक्जीक्यूटेबल्स **स्मार्टस्क्रीन को ट्रिगर नहीं करेंगे**।
{% endhint %}
...
पेलोड सीधे मेमोरी में लोड हो जाएगा बिना डिस्क को छूते, इसलिए हमें केवल AMSI को पूरे प्रक्रिया के लिए पैच करने की चिंता करनी होगी।
...
इंटरप्रीटर बाइनरीज़ और SMB साझा परिवेश का पहुंच देने द्वारा आप आक्रमित मशीन की मेमोरी में इन भाषाओं में विचारहीन कोड को **निष्पादित** कर सकते हैं।
...
मैं आपको उन्नत टालन तकनीकों के बारे में अधिक जानकारी प्राप्त करने के लिए इस टॉक को देखने की ऊर्जा देता हूं [@ATTL4S](https://twitter.com/DaniLJ94),।

{% embed url="https://vimeo.com/502507556?embedded=true&owner=32913914&source=vimeo_logo" %}

यह एक और शानदार टॉक है [@mariuszbit](https://twitter.com/mariuszbit) के बारे में टालने के बारे में।
...
```
अब **लिस्टनर** को `msfconsole -r file.rc` के साथ **शुरू** करें और **xml पेलोड** को निम्नलिखित के साथ **क्रियान्वित** करें:
```
