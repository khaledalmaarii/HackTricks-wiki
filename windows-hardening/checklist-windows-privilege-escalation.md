...
* [ ] Herhangi bir [**AV**](https://github.com/carlospolop/hacktricks/blob/master/windows-hardening/windows-av-bypass/README.md) var mı kontrol edin
...
* [ ] [Herhangi bir **belirsiz hizmet** ikili **yolundan faydalanabilir misiniz**?](windows-local-privilege-escalation/#unquoted-service-paths)
...
* Yerel ağ hizmetlerine (127.0.0.1) özel bir göz atın
...
* [ ] [**Tarayıcı verileri içinde**](windows-local-privilege-escalation/#browsers-history) (veritabanları, geçmiş, yer imleri, ...)?
...
### [Borulama İstemcisi Taklit Etme](windows-local-privilege-escalation/#named-pipe-client-impersonation)
