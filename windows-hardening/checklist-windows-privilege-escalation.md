...
### [Rede](windows-local-privilege-escalation/#rede)
...
### [Credenciais do Windows](windows-local-privilege-escalation/#credenciais-do-windows)

* [ ] [**Winlogon** ](windows-local-privilege-escalation/#winlogon-credentials)credenciais
...
### [Arquivos e Registro (Credenciais)](windows-local-privilege-escalation/#arquivos-e-registro-credenciais)
