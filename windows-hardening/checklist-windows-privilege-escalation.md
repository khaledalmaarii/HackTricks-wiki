...
* [ ] [**环境变量**](windows-local-privilege-escalation/#environment)中有有趣的信息吗？
* [ ] [**PowerShell历史记录**](windows-local-privilege-escalation/#powershell-history)中有密码吗？
* [ ] [**Internet设置**](windows-local-privilege-escalation/#internet-settings)中有有趣的信息吗？
...
* 安装应用程序的[**写入权限**](windows-local-privilege-escalation/#write-permissions)
...
* [**Windows Vault**](windows-local-privilege-escalation/#credentials-manager-windows-vault)中您可以使用的凭据？
* 有趣的[**DPAPI凭据**](windows-local-privilege-escalation/#dpapi)？
* 已保存的[**Wifi网络**](windows-local-privilege-escalation/#wifi)密码？
* 已保存的[**RDP连接**](windows-local-privilege-escalation/#saved-rdp-connections)中有有趣的信息吗？
* 最近运行命令中的密码[**密码**](windows-local-privilege-escalation/#recently-run-commands)？
* [**远程桌面凭据管理器**](windows-local-privilege-escalation/#remote-desktop-credential-manager)密码？
* [**AppCmd.exe**存在](windows-local-privilege-escalation/#appcmd-exe)？凭据？
...
* 未经人工干预的文件中的密码[**密码**](windows-local-privilege-escalation/#unattended-files)？
...
* [**Web日志**](windows-local-privilege-escalation/#logs)中有有趣的信息吗？
* 您想向用户[**请求凭据**](windows-local-privilege-escalation/#ask-for-credentials)吗？
...
* 浏览器数据中的[**通用密码搜索**](windows-local-privilege-escalation/#browsers-history)（数据库、历史记录、书签，...）？
* 在文件和注册表中进行[**通用密码搜索**](windows-local-privilege-escalation/#generic-password-search-in-files-and-registry)的[**工具**](windows-local-privilege-escalation/#tools-that-search-for-passwords)？
