...
Es gibt verschiedene Möglichkeiten, Befehle in externen Systemen auszuführen. Hier finden Sie Erklärungen dazu, wie die wichtigsten Techniken zur lateralen Bewegung in Windows funktionieren:
...
* [**Geben Sie das Cookie weiter**](https://cloud.hacktricks.xyz/pentesting-cloud/azure-security/az-lateral-movements/az-pass-the-cookie) (Cloud)
* [**Geben Sie das PRT weiter**](https://cloud.hacktricks.xyz/pentesting-cloud/azure-security/az-lateral-movements/pass-the-prt) (Cloud)
* [**Geben Sie das AzureAD-Zertifikat weiter**](https://cloud.hacktricks.xyz/pentesting-cloud/azure-security/az-lateral-movements/az-pass-the-certificate) (Cloud)
