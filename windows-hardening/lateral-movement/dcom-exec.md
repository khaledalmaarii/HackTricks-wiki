...
<figure><img src="https://github.com/carlospolop/hacktricks/blob/kr/windows-hardening/.gitbook/assets/telegram-cloud-document-1-5159108904864449420.jpg" alt=""><figcaption></figcaption></figure>
...
Empire 프로젝트는 Excel을 사용하여 원격 코드 실행 (RCE)을 수행하는 PowerShell 스크립트를 제공합니다. 아래는 Excel을 RCE에 악용하는 다양한 방법을 보여주는 [Empire의 GitHub 저장소](https://github.com/EmpireProject/Empire/blob/master/data/module\_source/lateral\_movement/Invoke-DCOM.ps1)에 있는 스크립트에서 스니펫입니다:
...
* **💬** [**Discord 그룹**](https://discord.gg/hRep4RUj7f)**이나** [**텔레그램 그룹**](https://t.me/peass)**에 가입하거나**Twitter\*\* 🐦 [**@carlospolopm**](https://twitter.com/hacktricks\_live)을 팔로우하세요.
