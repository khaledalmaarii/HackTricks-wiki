...
Hizmet ikili dosyalarının SMB üzerinden uzaktan yürütme başarısına ulaşmak için aşağıdaki adımlarda özetlenen işlem:
...
### **PsExec'in El ile Yürütme Süreci**
...
* **Hizmet oluşturma**: Windows `sc` komutu kullanılarak, Windows hizmetlerini uzaktan sorgulamaya, oluşturmaya ve silmeye olanak tanıyan "meterpreter" adında bir hizmet oluşturulur ve yüklenen ikili dosyaya işaret edilir.
* **Hizmeti başlatma**: Son adım, hizmetin başlatılmasını içerir, bu da büyük olasılıkla beklenen yanıt kodunu döndüremeyen gerçek bir hizmet ikili dosyası olmadığı için "zaman aşımı" hatası ile sonuçlanabilir. Bu hata önemsizdir çünkü asıl amaç ikili dosyanın yürütülmesidir.
