...
En supposant qu'il y a un payload exécutable (créé avec msfvenom et obfusqué à l'aide de Veil pour éviter la détection par les antivirus), nommé 'met8888.exe', représentant un payload meterpreter reverse\_http, les étapes suivantes sont prises :
