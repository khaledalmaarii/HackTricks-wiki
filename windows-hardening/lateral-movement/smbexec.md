...
- Este método é útil para executar comandos pontuais em um alvo Windows. Por exemplo, combiná-lo com o módulo `web_delivery` do Metasploit permite a execução de um payload Meterpreter reverso direcionado para o PowerShell.
