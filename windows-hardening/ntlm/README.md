...
_secpol.msc_를 실행 -> 로컬 정책 -> 보안 옵션 -> 네트워크 보안: LAN Manager 인증 수준. 6개의 수준(0부터 5까지)이 있습니다.
...
[**여기에서 어떻게 하는지 알아보세요.**](../../windows/ntlm/broken-reference/)
...
**Windows 호스트에서 자격 증명을 얻는 방법에 대한 자세한 정보는** [**이 페이지를 읽어보세요**](broken-reference)**.**
