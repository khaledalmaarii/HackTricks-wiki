...
[**Accedi qui per saperne di più su come farlo.**](../../windows/ntlm/broken-reference/)
...
**Per ulteriori informazioni su** [**come ottenere le credenziali da un host Windows, è necessario leggere questa pagina**](broken-reference)**.**
