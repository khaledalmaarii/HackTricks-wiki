...
* [Microsoft NTLM Technical Reference](https://docs.microsoft.com/en-us/openspecs/windows\_protocols/ms-nlmp/)
...
* [Microsoft NTLM Tegniese Verwysing](https://docs.microsoft.com/en-us/openspecs/windows\_protocols/ms-nlmp/)
...
[**Klik hier om te leer hoe om dit te doen.**](https://github.com/carlospolop/hacktricks/blob/af/windows/ntlm/broken-reference/README.md)
...
**Vir meer inligting oor** [**hoe om geloofsbriewe van 'n Windows-gashuis te verkry, moet jy hierdie bladsy lees**](https://github.com/carlospolop/hacktricks/blob/af/windows-hardening/ntlm/broken-reference/README.md)**.**
