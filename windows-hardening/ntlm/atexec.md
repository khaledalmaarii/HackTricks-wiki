...
Το At επιτρέπει τον προγραμματισμό εργασιών σε υπολογιστές όπου γνωρίζετε το όνομα χρήστη/(κωδικό/Hash). Έτσι, μπορείτε να το χρησιμοποιήσετε για να εκτελέσετε εντολές σε άλλους υπολογιστές και να λάβετε την έξοδο.
```
