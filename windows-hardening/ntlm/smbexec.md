...
- En créant un service distant sur la machine de l'attaquant avec binPath configuré pour exécuter la commande fournie via cmd.exe, il est possible d'exécuter la charge utile avec succès, obtenant ainsi un retour d'appel et l'exécution de la charge utile avec l'écoute Metasploit, même en cas d'erreurs de réponse du service.
