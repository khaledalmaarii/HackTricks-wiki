...
[Procdump](https://docs.microsoft.com/en-us/sysinternals/downloads/procdump) es un binario firmado por Microsoft que es parte de la suite [sysinternals](https://docs.microsoft.com/en-us/sysinternals/).
```
...
Windows utiliza _Ntdsa.dll_ para interactuar con ese archivo y es utilizado por _lsass.exe_. Luego, **parte** del archivo **NTDS.dit** podría estar ubicada **dentro de la memoria de `lsass`** (puedes encontrar los datos más recientemente accedidos probablemente debido a la mejora de rendimiento al usar una **cache**).

#### Desencriptando los hashes dentro de NTDS.dit

El hash está cifrado 3 veces:

1. Desencriptar la Clave de Cifrado de Contraseña (**PEK**) usando el **BOOTKEY** y **RC4**.
...
Descárgalo de: [ http://www.tarasco.org/security/pwdump\_7](http://www.tarasco.org/security/pwdump\_7) y simplemente **ejecuta** y las contraseñas serán extraídas.
