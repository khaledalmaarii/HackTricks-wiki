...
**Windows 8.1 et Windows Server 2012 R2** ont introduit plusieurs nouvelles fonctionnalités de sécurité, y compris le _**mode Restricted Admin pour RDP**_. Ce mode a été conçu pour renforcer la sécurité en atténuant les risques associés aux attaques de type [**pass the hash**](https://blog.ahasayen.com/pass-the-hash/).
...
Ces protections sont activées dès qu'un utilisateur, membre du groupe **Utilisateurs Protégés**, se connecte à l'appareil. Cela garantit que des mesures de sécurité critiques sont en place pour se prémunir contre diverses méthodes de compromission des informations d'identification.
