...
इस पृष्ठ में **टोकन** क्या है, इसके बारे में और अधिक जानें: [**Windows Tokens**](../authentication-credentials-uac-and-efs/#access-tokens).\
...
जांचें कि क्या आप **कुछ बाइनरी चल रहे को ओवरराइट** कर सकते हैं या यदि आपके पास बाइनरी फोल्डर की लेखन अनुमतियाँ हैं तो संभावित [**DLL हाइजैकिंग हमलों**](dll-hijacking/) का शोषण करें:
...
**जांचें कि क्या आप सेवा द्वारा निष्पादित बाइनरी को संशोधित कर सकते हैं** या क्या आपके पास उस फ़ोल्डर पर **लेखन अनुमतियाँ** हैं जहाँ बाइनरी स्थित है ([**DLL Hijacking**](dll-hijacking/))**.**\
...
यदि आप उस पथ में कोई एंट्री पाते हैं तो शायद वहाँ एक सहेजी गई SSH कुंजी हो। यह एन्क्रिप्टेड रूप में संग्रहीत है लेकिन [https://github.com/ropnop/windows\_sshagent\_extract](https://github.com/ropnop/windows\_sshagent\_extract) का उपयोग करके आसानी से डिक्रिप्ट किया जा सकता है।\
...
**आप** [**यहाँ Dll हाइजैकिंग के बारे में अधिक जान सकते हैं**](dll-hijacking/)**।**
...
[**PowerSploit-Privesc(PowerUP)**](https://github.com/PowerShellMafia/PowerSploit) **-- मिसकॉन्फिगरेशन और संवेदनशील फ़ाइलों की जांच करें (**[**यहाँ जांच करें**](https://github.com/carlospolop/hacktricks/blob/in/windows/windows-local-privilege-escalation/broken-reference/README.md)**)। खोजा गया।**\
[**JAWS**](https://github.com/411Hall/JAWS) **-- कुछ संभावित मिसकॉन्फिगरेशन की जांच करें और जानकारी एकत्र करें (**[**यहाँ जांच करें**](https://github.com/carlospolop/hacktricks/blob/in/windows/windows-local-privilege-escalation/broken-reference/README.md)**)।**\
