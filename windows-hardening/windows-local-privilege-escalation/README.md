...
```
**Überprüfung der Berechtigungen der Ordner der Prozessbinärdateien ([DLL Hijacking](dll-hijacking.md))**
```bash
...
**Überprüfen Sie, ob Sie die Binärdatei ändern können, die von einem Dienst ausgeführt wird**, oder ob Sie **Schreibberechtigungen im Ordner** haben, in dem sich die Binärdatei befindet ([**DLL Hijacking**](dll-hijacking.md))**.**\
...
**Sie können mehr über Dll-Hijacking** [**hier erfahren**](dll-hijacking.md)**.**
...
[**PowerSploit-Privesc(PowerUP)**](https://github.com/PowerShellMafia/PowerSploit) **-- Überprüfen Sie auf Konfigurationsfehler und sensible Dateien (**[**hier überprüfen**](../../windows/windows-local-privilege-escalation/broken-reference/)**). Erkannt.**\
[**JAWS**](https://github.com/411Hall/JAWS) **-- Überprüfen Sie auf mögliche Konfigurationsfehler und sammeln Sie Informationen (**[**hier überprüfen**](../../windows/windows-local-privilege-escalation/broken-reference/)**).**\
