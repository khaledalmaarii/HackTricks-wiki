...
Bir **token**'ın ne olduğu hakkında daha fazla bilgi edinin bu sayfada: [**Windows Tokens**](../authentication-credentials-uac-and-efs.md#access-tokens).\
...
**Çalışan bazı ikili dosyaları üzerine yazabilir** veya olası [**DLL Kaçırma saldırılarını**](dll-hijacking.md) sömürmek için ikili dosyanın klasörüne yazma izinlerinizin olup olmadığını kontrol edin:
```bash
...
**Hizmet tarafından yürütülen ikili dosyayı değiştirip değiştiremeyeceğinizi** veya ikili dosyanın bulunduğu klasörde **yazma izinlerinizin olup olmadığını** kontrol edin ([**DLL Hijacking**](dll-hijacking.md))**.**\
...
**İkili dosyaların izinlerini** kontrol edin (belki birini üzerine yazabilir ve ayrıcalıkları yükseltebilirsiniz) ve **dizinlerin** izinlerini kontrol edin ([DLL Kaldırma](dll-hijacking.md)).
```bash
...
[**Dll kaçırma hakkında daha fazla bilgi edinebilirsiniz**](dll-hijacking.md)**.**
