...
* D'abord, placez toutes les règles faites **spécifiquement pour cet élément** avant celles qui viennent d'ailleurs, comme un dossier parent.
* Dans ces règles spécifiques, placez celles qui disent **"non" (refuser)** avant celles qui disent **"oui" (autoriser)**.
* Pour les règles qui viennent d'ailleurs, commencez par celles de la **source la plus proche**, comme le parent, puis remontez. Encore une fois, placez **"non"** avant **"oui"**.
...
Imaginez que vous ayez un dossier nommé Coût, et que vous voulez que tout le monde y accède sauf une équipe marketing. En configurant les règles correctement, nous pouvons nous assurer que l'équipe marketing se voit explicitement refuser l'accès avant de permettre à tout le monde d'y accéder.
