...
* **RegOpenKey** कार्रवाई।
* जहां _परिणाम_ **नाम नहीं मिला** है।
* और _पथ_ **InprocServer32** से समाप्त होता है।

एक बार जब आपने तय कर लिया है कि कौन सा अस्तित्व में न होने वाला COM अनुकरण करना है, तो निम्नलिखित कमांडों को निष्पादित करें। _सावधान रहें अगर आप उस COM का अनुकरण करने का निर्णय करते हैं जो हर कुछ सेकंड में लोड होता है क्योंकि यह अत्यधिक हो सकता है।_&#x20;
```bash
