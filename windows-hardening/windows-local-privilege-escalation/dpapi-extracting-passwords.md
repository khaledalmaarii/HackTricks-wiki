...
डेटा संरक्षण एपीआई (DPAPI) प्रमुख रूप से **असममित निजी कुंजीयों का सममित एन्क्रिप्शन** के लिए विंडोज ऑपरेटिंग सिस्टम में प्रयोग किया जाता है, जो उपयोगकर्ता या सिस्टम रहस्यों को एंट्रोपी के महत्वपूर्ण स्रोत के रूप में उपयोग करता है। यह दृष्टिकोण डेवलपर्स के लिए एन्क्रिप्शन को सरल बनाता है जिससे उन्हें उपयोगकर्ता के लॉगऑन रहस्यों से उत्पन्न कुंजी का उपयोग करके डेटा को एन्क्रिप्ट करने की सुविधा प्राप्त होती है या सिस्टम एन्क्रिप्शन के लिए, सिस्टम के डोमेन प्रमाणीकरण रहस्यों का उपयोग करके, इसलिए डेवलपर्स को एन्क्रिप्शन कुंजी की सुरक्षा का प्रबंधन करने की आवश्यकता को दूर करता है।
...
```
```
mimikatz का उपयोग करके क्रेडेंशियल जानकारी प्राप्त करें `dpapi::cred`, प्रतिक्रिया में आप एन्क्रिप्टेड डेटा और guidMasterKey जैसी रोचक जानकारी पा सकते हैं।
```
```bash
...
[..]
```
आप **mimikatz मॉड्यूल** `dpapi::cred` का उपयुक्त `/masterkey` उपयोग कर सकते हैं ताकि डिक्रिप्ट कर सकें:
```
dpapi::cred /in:C:\path\to\encrypted\file /masterkey:<MASTERKEY>
```
## मास्टर कुंजी

उपयोगकर्ता के RSA कुंजी को एन्क्रिप्ट करने के लिए उपयोग की जाने वाली DPAPI कुंजियाँ `%APPDATA%\Microsoft\Protect\{SID}` निर्देशिका में संग्रहित होती हैं, जहां {SID} उपयोगकर्ता का [**सुरक्षा पहचानकर्ता**](https://en.wikipedia.org/wiki/Security_Identifier) है। **DPAPI कुंजी उन्हीं उपयोगकर्ता की निजी कुंजियों को सुरक्षित रखने वाली मास्टर कुंजी के साथ ही एक ही फ़ाइल में संग्रहित होती है**। यह आम तौर पर यादृच्छिक डेटा के 64 बाइट होती है। (ध्यान दें कि यह निर्देशिका संरक्षित है, इसलिए आप `cmd` से इसे सूचीबद्ध करने के लिए उपयोग नहीं कर सकते हैं, लेकिन आप PS से इसे सूचीबद्ध कर सकते हैं)।
```bash
...
सामान्यत: **प्रत्येक मास्टर कुंजी एक एन्क्रिप्टेड सिमेट्रिक कुंजी होती है जो अन्य सामग्री को डिक्रिप्ट कर सकती है**। इसलिए, **एन्क्रिप्टेड मास्टर कुंजी** को **निकालना** देखने लायक है ताकि बाद में जो **अन्य सामग्री** इसके साथ **एन्क्रिप्ट** की गई है, उसे **डिक्रिप्ट** किया जा सके।
