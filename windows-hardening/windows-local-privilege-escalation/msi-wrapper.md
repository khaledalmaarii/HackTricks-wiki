...
Preuzmite besplatnu verziju aplikacije sa [https://www.exemsi.com/documentation/getting-started/](https://www.exemsi.com/download/), izvršite je i omotajte "zlonamerni" binarni fajl u nju.\
Imajte na umu da možete omotati "**.bat**" ako želite **samo** da **izvršite** **komandne linije (umesto cmd.exe izaberite .bat fajl)**
...
(Molimo vas, imajte na umu da ako pokušate da zapakujete svoj binarni fajl, bićete u mogućnosti da izmenite ove vrednosti)
