...
[https://www.exemsi.com/documentation/getting-started/](https://www.exemsi.com/download/) से मुफ्त संस्करण ऐप डाउनलोड करें, इसे निषेधाजनक बाइनरी पर लपेटें।\
ध्यान दें कि आप एक "**.bat**" लपेट सकते हैं अगर आप **केवल** **कमांड लाइन्स को निष्पादित करना चाहते हैं (cmd.exe की बजाय .bat फ़ाइल का चयन करें)**
...
(कृपया ध्यान दें कि यदि आप अपना खुद का बाइनरी पैक करने का प्रयास करते हैं तो आप इन मानों को संशोधित कर सकेंगे)

यहां से बस **अगले बटन** पर क्लिक करें और आखिरी **बिल्ड बटन** पर क्लिक करें और आपका स्थापक/रैपर उत्पन्न हो जाएगा।
