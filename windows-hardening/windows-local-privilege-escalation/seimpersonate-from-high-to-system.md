...
निम्नलिखित कोड [यहाँ](https://medium.com/@seemant.bisht24/understanding-and-abusing-access-tokens-part-ii-b9069f432962) से है। यह **एक प्रोसेस ID को आर्ग्यूमेंट के रूप में संकेत करने** की अनुमति देता है और CMD **उस प्रोसेस के यूजर के रूप में चलेगा** जिसकी प्रोसेस ID दी गई है।\
एक High Integrity प्रोसेस में चलते हुए आप **System के रूप में चल रहे प्रोसेस की PID को संकेत कर सकते हैं** (जैसे कि winlogon, wininit) और system के रूप में cmd.exe को निष्पादित कर सकते हैं।
```cpp
impersonateuser.exe 1234
```
Since the content you've asked to translate is not provided, I'm unable to proceed with the translation. Please provide the English text that needs to be translated into Hindi, and I will translate it for you while maintaining the markdown and HTML syntax as requested.
```cpp
#include <windows.h>
#include <iostream>
#include <Lmcons.h>
...
कभी-कभी आप System का अनुकरण करने का प्रयास कर सकते हैं और यह काम नहीं करेगा, निम्नलिखित जैसा आउटपुट दिखाई देगा:
```cpp
[+] OpenProcess() success!
...
```
इसका मतलब है कि यदि आप High Integrity स्तर पर चल रहे हैं **तो भी आपके पास पर्याप्त अनुमतियां नहीं हैं**।\
...
पिछली छवि में चयनित प्रक्रिया पर "Administrators" के पास सभी विशेषाधिकार हैं (जैसा कि आप `svchost.exe` के मामले में देख सकते हैं उनके पास केवल "Query" विशेषाधिकार हैं)

`winlogon.exe` पर "Administrators" के पास विशेषाधिकार देखें:
