...
도구 _**sigcheck.exe**_를 사용하여 실행 파일의 _**Manifest**_를 **확인**할 수 있습니다. 또한 _Sysinternals_의 _Process Explorer_ 또는 _Process Monitor_를 사용하여 프로세스의 **무결성 수준**을 **확인**할 수 있습니다.
...
**UACME**를 살펴보면 대부분의 UAC 우회가 Dll Hijacking 취약점을 악용한다는 것을 알 수 있습니다(주로 악의적인 dll을 _C:\Windows\System32_에 작성). [Dll Hijacking 취약점을 찾는 방법을 알아보려면 여기를 읽어보세요](../windows-local-privilege-escalation/dll-hijacking.md).
