...
अधिकारिता स्तरों के बारे में अधिक जानकारी के लिए:
...
कुछ कार्यक्रम **स्वचालित रूप से** **उच्च** स्तर पर **उपयोगकर्ता समूह** से संबंधित होने पर **स्वचालित रूप से** **उच्चीकृत** होते हैं। इन बाइनरी में उनके _**Manifests**_ के अंदर _**autoElevate**_ विकल्प का मान _**True**_ होता है। बाइनरी को **Microsoft द्वारा हस्ताक्षरित** होना चाहिए।

फिर, **UAC** को **बायपास** करने के लिए (उच्च **integrity** स्तर से **उच्च** पर) कुछ हमलावर इस प्रकार की बाइनरी का उपयोग करते हैं ताकि वे **मनमाने कोड** को **निष्पादित** कर सकें क्योंकि इसे **उच्च स्तर की सुरक्षा प्रक्रिया** से निष्पादित किया जाएगा।

आप _**sigcheck.exe**_ उपकरण का उपयोग करके एक बाइनरी का _**Manifest**_ **चेक** कर सकते हैं। और आप _Process Explorer_ या _Process Monitor_ (Sysinternals के) का उपयोग करके प्रक्रियाओं के **integrity स्तर** को **देख** सकते हैं।
...
```
* यदि **`0`** है तो, UAC संकेत नहीं देगा (जैसे **अक्षम**)
...
यदि आपके पास **GUI** तक पहुँच है तो आप जब UAC प्रॉम्प्ट प्राप्त करते हैं तो बस इसे स्वीकार कर सकते हैं, आपको वास्तव में इसे बायपास करने की आवश्यकता नहीं है। इसलिए, GUI तक पहुँच प्राप्त करना UAC को बायपास करने की अनुमति देगा।
...
इसमें यह देखना शामिल है कि क्या एक **autoElevated बाइनरी** **पंजीकरण** से **बाइनरी** या **कमांड** के **नाम/पथ** को **पढ़ने** की कोशिश करती है जिसे **निष्पादित** किया जाना है (यह अधिक दिलचस्प है यदि बाइनरी इस जानकारी को **HKCU** के अंदर खोजती है)।
